...
-- ============================================================
-- File Name: my_float_converter23.vhd
-- Megafunction Name(s):
-- 			ALTFP_CONVERT
--
...
--synthesis_resources = reg 68 
 ...
 ENTITY  my_float_converter23_altbarrel_shift_hpf IS 
	 PORT 
	 ( 
		 aclr	:	IN  STD_LOGIC := '0';
 ...
 END my_float_converter23_altbarrel_shift_hpf;

 ARCHITECTURE RTL OF my_float_converter23_altbarrel_shift_hpf IS
 ...
 END RTL; --my_float_converter23_altbarrel_shift_hpf
...
--synthesis_resources = 
 ...
 ENTITY  my_float_converter23_altpriority_encoder_3e8 IS 
	 PORT 
	 ( 
 ...
 END my_float_converter23_altpriority_encoder_3e8;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_3e8 IS
 ...
 END RTL; --my_float_converter23_altpriority_encoder_3e8

--synthesis_resources = 
 LIBRARY ieee;
 USE ieee.std_logic_1164.all;

 ENTITY  my_float_converter23_altpriority_encoder_6e8 IS 
	 PORT 
	 ( 
 ...
 END my_float_converter23_altpriority_encoder_6e8;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_6e8 IS
	 ...
	 COMPONENT  my_float_converter23_altpriority_encoder_3e8
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(1 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(0 DOWNTO 0);
 ...
 BEGIN
	...
	altpriority_encoder13 :  my_float_converter23_altpriority_encoder_3e8
	  PORT MAP ( 
	...
	altpriority_encoder14 :  my_float_converter23_altpriority_encoder_3e8
	  PORT MAP ( 
 ...
 END RTL; --my_float_converter23_altpriority_encoder_6e8

--synthesis_resources = 
 LIBRARY ieee;
 USE ieee.std_logic_1164.all;

 ENTITY  my_float_converter23_altpriority_encoder_be8 IS 
	 PORT 
	 ( 
 ...
 END my_float_converter23_altpriority_encoder_be8;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_be8 IS
	 ...
	 COMPONENT  my_float_converter23_altpriority_encoder_6e8
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(3 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(1 DOWNTO 0);
 ...
 BEGIN
	...
	altpriority_encoder11 :  my_float_converter23_altpriority_encoder_6e8
	  PORT MAP ( 
	...
	END GENERATE loop27;
	altpriority_encoder12 :  my_float_converter23_altpriority_encoder_6e8
	  PORT MAP ( 
 ...
 END RTL; --my_float_converter23_altpriority_encoder_be8
...
--synthesis_resources = 
 ...
 ENTITY  my_float_converter23_altpriority_encoder_3v7 IS 
	 PORT 
	 ( 
		 data	:	IN  STD_LOGIC_VECTOR (1 DOWNTO 0);
		 q	:	OUT  STD_LOGIC_VECTOR (0 DOWNTO 0)
	 ); 
 END my_float_converter23_altpriority_encoder_3v7;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_3v7 IS

 BEGIN

	q(0) <= ( data(1));

 END RTL; --my_float_converter23_altpriority_encoder_3v7

--synthesis_resources = 
 LIBRARY ieee;
 USE ieee.std_logic_1164.all;

 ENTITY  my_float_converter23_altpriority_encoder_6v7 IS 
	 PORT 
	 ( 
		 data	:	IN  STD_LOGIC_VECTOR (3 DOWNTO 0);
		 q	:	OUT  STD_LOGIC_VECTOR (1 DOWNTO 0)
	 ); 
 END my_float_converter23_altpriority_encoder_6v7;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_6v7 IS
	 ...
	 COMPONENT  my_float_converter23_altpriority_encoder_3v7
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(1 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(0 DOWNTO 0)
 ...
 BEGIN
	...
	altpriority_encoder17 :  my_float_converter23_altpriority_encoder_3v7
	  PORT MAP ( 
		data => data(1 DOWNTO 0),
	...
	altpriority_encoder18 :  my_float_converter23_altpriority_encoder_3e8
	  PORT MAP ( 
		data => data(3 DOWNTO 2),
 ...
 END RTL; --my_float_converter23_altpriority_encoder_6v7

--synthesis_resources = 
 LIBRARY ieee;
 USE ieee.std_logic_1164.all;

 ENTITY  my_float_converter23_altpriority_encoder_bv7 IS 
	 PORT 
	 ( 
		 data	:	IN  STD_LOGIC_VECTOR (7 DOWNTO 0);
		 q	:	OUT  STD_LOGIC_VECTOR (2 DOWNTO 0)
	 ); 
 END my_float_converter23_altpriority_encoder_bv7;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_bv7 IS
	 ...
	 COMPONENT  my_float_converter23_altpriority_encoder_6v7
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(3 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(1 DOWNTO 0)
 ...
 BEGIN
	...
	altpriority_encoder15 :  my_float_converter23_altpriority_encoder_6v7
	  PORT MAP ( 
		data => data(3 DOWNTO 0),
	...
	END GENERATE loop30;
	altpriority_encoder16 :  my_float_converter23_altpriority_encoder_6e8
	  PORT MAP ( 
		data => data(7 DOWNTO 4),
 ...
 END RTL; --my_float_converter23_altpriority_encoder_bv7

--synthesis_resources = 
 LIBRARY ieee;
 USE ieee.std_logic_1164.all;

 ENTITY  my_float_converter23_altpriority_encoder_r08 IS 
	 PORT 
	 ( 
		 data	:	IN  STD_LOGIC_VECTOR (15 DOWNTO 0);
		 q	:	OUT  STD_LOGIC_VECTOR (3 DOWNTO 0)
	 ); 
 END my_float_converter23_altpriority_encoder_r08;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_r08 IS
	 ...
	 COMPONENT  my_float_converter23_altpriority_encoder_be8
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(7 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(2 DOWNTO 0);
	 ...
	 END COMPONENT;
	 COMPONENT  my_float_converter23_altpriority_encoder_bv7
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(7 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(2 DOWNTO 0)
 ...
 BEGIN
	...
	END GENERATE loop33;
	altpriority_encoder10 :  my_float_converter23_altpriority_encoder_be8
	  PORT MAP ( 
		data => data(15 DOWNTO 8),
		q => wire_altpriority_encoder10_q,
		zero => wire_altpriority_encoder10_zero
	  );
	altpriority_encoder9 :  my_float_converter23_altpriority_encoder_bv7
	  PORT MAP ( 
		data => data(7 DOWNTO 0),
		q => wire_altpriority_encoder9_q
	  );

 END RTL; --my_float_converter23_altpriority_encoder_r08
...
--synthesis_resources = 
 ...
 ENTITY  my_float_converter23_altpriority_encoder_rf8 IS 
	 PORT 
	 ( 
		 data	:	IN  STD_LOGIC_VECTOR (15 DOWNTO 0);
		 q	:	OUT  STD_LOGIC_VECTOR (3 DOWNTO 0);
 ...
 END my_float_converter23_altpriority_encoder_rf8;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_rf8 IS
 ...
 BEGIN
	...
	altpriority_encoder19 :  my_float_converter23_altpriority_encoder_be8
	  PORT MAP ( 
		data => data(7 DOWNTO 0),
	...
	END GENERATE loop36;
	altpriority_encoder20 :  my_float_converter23_altpriority_encoder_be8
	  PORT MAP ( 
		data => data(15 DOWNTO 8),
 ...
 END RTL; --my_float_converter23_altpriority_encoder_rf8

--synthesis_resources = 
 LIBRARY ieee;
 USE ieee.std_logic_1164.all;

 ENTITY  my_float_converter23_altpriority_encoder_qb6 IS 
	 PORT 
	 ( 
		 data	:	IN  STD_LOGIC_VECTOR (31 DOWNTO 0);
		 q	:	OUT  STD_LOGIC_VECTOR (4 DOWNTO 0)
	 ); 
 END my_float_converter23_altpriority_encoder_qb6;

 ARCHITECTURE RTL OF my_float_converter23_altpriority_encoder_qb6 IS
	 ...
	 COMPONENT  my_float_converter23_altpriority_encoder_r08
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(15 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(3 DOWNTO 0)
	 ...
	 END COMPONENT;
	 COMPONENT  my_float_converter23_altpriority_encoder_rf8
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(15 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(3 DOWNTO 0);
 ...
 BEGIN
	...
	altpriority_encoder7 :  my_float_converter23_altpriority_encoder_r08
	  PORT MAP ( 
	...
	END GENERATE loop39;
	altpriority_encoder8 :  my_float_converter23_altpriority_encoder_rf8
	  PORT MAP ( 
 ...
 END RTL; --my_float_converter23_altpriority_encoder_qb6
...
--synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 247 
 ...
 ENTITY  my_float_converter23_altfp_convert_20n IS 
	 PORT 
	 ( 
		 clock	:	IN  STD_LOGIC;
 ...
 END my_float_converter23_altfp_convert_20n;

 ARCHITECTURE RTL OF my_float_converter23_altfp_convert_20n IS
	 ...
	 COMPONENT  my_float_converter23_altbarrel_shift_hpf
	 PORT
	 ( 
		aclr	:	IN  STD_LOGIC := '0';
		clk_en	:	IN  STD_LOGIC := '1';
	 ...
	 END COMPONENT;
	 COMPONENT  my_float_converter23_altpriority_encoder_qb6
	 PORT
	 ( 
		data	:	IN  STD_LOGIC_VECTOR(31 DOWNTO 0);
		q	:	OUT  STD_LOGIC_VECTOR(4 DOWNTO 0)
 ...
 BEGIN
	...
	altbarrel_shift3 :  my_float_converter23_altbarrel_shift_hpf
	  PORT MAP ( 
		aclr => aclr,
		clk_en => clk_en,
		clock => clock,
	...
	altpriority_encoder2 :  my_float_converter23_altpriority_encoder_qb6
	  PORT MAP ( 
		data => prio_mag_int_a,
 ...
 END RTL; --my_float_converter23_altfp_convert_20n
--VALID FILE
...
ENTITY my_float_converter23 IS
	PORT
	(
		clock		: IN STD_LOGIC ;
		dataa		: IN STD_LOGIC_VECTOR (31 DOWNTO 0);
...
END my_float_converter23;


ARCHITECTURE RTL OF my_float_converter23 IS

	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (31 DOWNTO 0);



	COMPONENT my_float_converter23_altfp_convert_20n
	PORT (
			clock	: IN STD_LOGIC ;
			dataa	: IN STD_LOGIC_VECTOR (31 DOWNTO 0);
			result	: OUT STD_LOGIC_VECTOR (31 DOWNTO 0)
...
BEGIN
	...
	my_float_converter23_altfp_convert_20n_component : my_float_converter23_altfp_convert_20n
	PORT MAP (
		clock => clock,
		dataa => dataa,
		result => sub_wire0
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL my_float_converter23.vhd TRUE FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL my_float_converter23.qip TRUE FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL my_float_converter23.bsf FALSE TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL my_float_converter23_inst.vhd TRUE TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL my_float_converter23.inc FALSE TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL my_float_converter23.cmp TRUE TRUE
