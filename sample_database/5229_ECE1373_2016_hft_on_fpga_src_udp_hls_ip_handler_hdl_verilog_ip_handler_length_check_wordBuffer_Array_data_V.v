...
module ip_handler_length_check_wordBuffer_Array_data_V_core (
    clk,
    ce,
    din,
    addr,
...
module ip_handler_length_check_wordBuffer_Array_data_V (
    clk,
    reset,
    address0,
    ce0,
...
ip_handler_length_check_wordBuffer_Array_data_V_core #(
    .DATA_WIDTH( DataWidth ),
    .ADDR_WIDTH( AddressWidth ),
    .DEPTH( AddressRange ))
ip_handler_length_check_wordBuffer_Array_data_V_core_U(
    .clk(clk),
    .ce(we0),
    .din(d0),
    .addr(address0),
