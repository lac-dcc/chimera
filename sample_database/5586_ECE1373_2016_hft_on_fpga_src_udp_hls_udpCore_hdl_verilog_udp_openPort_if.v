...
module udp_openPort_if (
    ...
    // User signals
    output wire [15:0] openPort_V_V_dout,
    output wire        openPort_V_V_empty_n,
    input  wire        openPort_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [15:0] openPort_V_V_din;
wire [0:0]  openPort_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [15:0] s_data;
...
assign openPort_V_V_din = m_data[15:0];
assign fifo_full_n      = openPort_V_V_full_n;
