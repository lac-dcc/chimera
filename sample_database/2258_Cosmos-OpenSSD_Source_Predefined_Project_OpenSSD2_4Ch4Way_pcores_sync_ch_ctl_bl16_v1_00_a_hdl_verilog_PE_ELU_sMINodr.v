...
//////////////////////////////////////////////////////////////////////////////////
// PE_ELU_sMINodr.v for Cosmos OpenSSD
...
// Module Name: PE_ELU_sMINodr
// File Name: PE_ELU_sMINodr.v
//
...
module PE_ELU_sMINodr( // error locate update module: minimum order + 1 (semi-)
	clk,
	nRESET_KES,
	...
	assign k_2ip2_X[GF_ORDER-1:0] = (condition_2i_b)? (v_2i_Xm1_b[GF_ORDER-1:0]):(VALUE_ZERO[GF_ORDER-1:0]);
