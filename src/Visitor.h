...
public:
	...
	virtual void visit(Non_anonymous_gate_instance_or_register_variable *node) = 0;
	...
	virtual void visit(List_of_ports_or_port_declarations *node) = 0;
	
	virtual void visit(List_of_ports_or_port_declarations_trailing_comma *node) = 0;
	...
	virtual void visit(Method_property_qualifier_list_not_starting_with_virtual *node) = 0;
	...
	virtual void visit(Port_declaration_noattr *node) = 0;
	
	virtual void visit(Type_identifier_or_implicit_basic_followed_by_id_and_dimensions_opt *node) = 0;
	
	virtual void visit(Caseeq_expr *node) = 0;
	
	virtual void visit(Generate_case_items *node) = 0;
	
	virtual void visit(Data_type_or_implicit_basic_followed_by_id_and_dimensions_opt *node) = 0;
	...
	virtual void visit(Port_or_port_declaration *node) = 0;
	
	virtual void visit(List_of_ports_or_port_declarations_item_last *node) = 0;
	
	virtual void visit(Port_declaration *node) = 0;
	...
	virtual void visit(Tk_evalstringliteral *node) = 0;
	...
	virtual void visit(Non_anonymous_gate_instance_or_register_variable_list *node) = 0;
	...
	virtual void visit(Any_port_list_item_last *node) = 0;
	
	virtual void visit(Any_port_list_trailing_comma *node) = 0;
	...
	virtual void visit(Data_type_or_implicit_followed_by_id_and_dimensions_opt *node) = 0;
	
	virtual void visit(Keywordidentifier *node) = 0;
	
	virtual void visit(Type_identifier_or_implicit_followed_by_id_and_dimensions_opt *node) = 0;
...
public:
	...
	virtual void visit(Method_property_qualifier_list_not_starting_with_virtual *node);
	...
	virtual void visit(Type_identifier_or_implicit_basic_followed_by_id_and_dimensions_opt *node);
	
	virtual void visit(Caseeq_expr *node);
	
	virtual void visit(Generate_case_items *node);
	
	virtual void visit(Data_type_or_implicit_basic_followed_by_id_and_dimensions_opt *node);
	...
	virtual void visit(Non_anonymous_gate_instance_or_register_variable_list *node);
	...
	virtual void visit(Data_type_or_implicit_followed_by_id_and_dimensions_opt *node);
	
	virtual void visit(Keywordidentifier *node);
	
	virtual void visit(Type_identifier_or_implicit_followed_by_id_and_dimensions_opt *node);
