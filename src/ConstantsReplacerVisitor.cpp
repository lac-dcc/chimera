...
void ReplaceConstantsVisitor::visit(Macrogenericitem *node) {
  for (const std::unique_ptr<Node> &child : node->getChildren()) {
    child->accept(*this);
  }
}
...
void ReplaceConstantsVisitor::visit(Macroidentifier *node) {
  for (const std::unique_ptr<Node> &child : node->getChildren()) {
    child->accept(*this);
  }
}
...
void ReplaceConstantsVisitor::visit(Any_port_list_item_last_named *node) {
  for (const std::unique_ptr<Node> &child : node->getChildren()) {
    child->accept(*this);
  }
}

void ReplaceConstantsVisitor::visit(Any_port_list_item_last_positional *node) {
  for (const std::unique_ptr<Node> &child : node->getChildren()) {
    child->accept(*this);
  }
}

void ReplaceConstantsVisitor::visit(Any_port_list_trailing_comma_named *node) {
  for (const std::unique_ptr<Node> &child : node->getChildren()) {
    child->accept(*this);
  }
}
...
void ReplaceConstantsVisitor::visit(Macroiditem *node) {
  for (const std::unique_ptr<Node> &child : node->getChildren()) {
    child->accept(*this);
  }
}
