...
constraintSet TypeInferenceVisitor::visit(Interface_opt *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}

constraintSet TypeInferenceVisitor::visit(Data_type_or_implicit_basic_followed_by_id *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Coverage_spec_or_option_list_opt *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Sequence_port_list_in_parens_opt *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Goto_repetition *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Design_statement *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Clocking_item *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Cycle_range *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Lib_cell_id *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Property_formal_type_followed_by_id *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}

constraintSet TypeInferenceVisitor::visit(Modport_simple_ports_declaration_last *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Coverage_spec *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Coverage_event *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Type_identifier_or_implicit_basic_followed_by_id *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}

constraintSet TypeInferenceVisitor::visit(Assertion_variable_declaration_list *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}

constraintSet TypeInferenceVisitor::visit(Constraint_expression_no_preprocessor *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Property_port_list_in_parens_opt *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}

constraintSet TypeInferenceVisitor::visit(Modport_simple_ports_declaration_begin *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Liblist_clause *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(List_of_config_rule_statements_opt *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Cover_point *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}

constraintSet TypeInferenceVisitor::visit(Modport_item *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Method_qualifier *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
...
constraintSet TypeInferenceVisitor::visit(Constraint_block *node, 
                                          typeId type) {
  return defaultVisitor(node, type);
}
