...
constraintSet TypeInferenceVisitor::visit(Xor_expr *node, std::string &type) {
  ...
  if (children.size() == 1) {
    ...
    constraintsXorExpr.insert(constraintsBitAndExpr.begin(),
                              constraintsBitAndExpr.end());
...
constraintSet TypeInferenceVisitor::visit(Logor_expr *node, std::string &type) {
  ...
  if (children.size() == 1) {
    ...
    constraintsLogOrExpr.insert(constraintsLogAndExpr.begin(),
                                constraintsLogAndExpr.end());
    constraintsLogOrExpr.insert({t, type});
...
constraintSet TypeInferenceVisitor::visit(
    Non_anonymous_gate_instance_or_register_variable *node, std::string &type) {
}
...
constraintSet TypeInferenceVisitor::visit(Bitor_expr *node, std::string &type) {
  ...
  if (children.size() == 1) {
    ...
    constraintsBitOrExpr.insert(constraintsXorExpr.begin(),
                                constraintsXorExpr.end());
...
constraintSet TypeInferenceVisitor::visit(Logand_expr *node,
  ...
  if (children.size() == 1) {
    ...
    constraintsLogAndExpr.insert(constraintsBitOrExpr.begin(),
                                 constraintsBitOrExpr.end());
    constraintsLogAndExpr.insert({t, type});
