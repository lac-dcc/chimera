...
void Macrogenericitem::accept(Visitor &visitor) {
  visitor.visit(this);
}
...
void Macroidentifier::accept(Visitor &visitor) {
  visitor.visit(this);
}
...
void Macroiditem::accept(Visitor &visitor) {
  visitor.visit(this);
}
...
std::map<std::string, std::function<std::shared_ptr<Node>(const std::string &)>>
    classMap = {
        ...
        {"module_block",
         [](const std::string &f) -> std::shared_ptr<Node> {
           return std::make_shared<Module_block>(f);
         }},
        ...
        {"specify_block",
         [](const std::string &f) -> std::shared_ptr<Node> {
           return std::make_shared<Specify_block>(f);
         }},
        ...
        {"type_declaration",
         [](const std::string &f)
             -> std::shared_ptr<
                 Node> { return std::make_shared<Type_declaration>(f); }},
        ...
        {"always_construct",
         [](const std::string &f)
             -> std::shared_ptr<
                 Node> { return std::make_shared<Always_construct>(f); }},
        {"initial_construct",
         [](const std::string &f) -> std::shared_ptr<Node> {
        ...
        {"assertion_item",
         [](const std::string &f)
             -> std::shared_ptr<
                 Node> { return std::make_shared<Assertion_item>(f); }},
        {"final_construct",
         [](const std::string &f)
             -> std::
                 shared_ptr<Node> {
        ...
        {"macrogenericitem",
         [](const std::string &f)
             -> std::
                 shared_ptr<Node> {
                   return std::make_shared<Macrogenericitem>(f);
                 }},
        {"delay1",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
        ...
        {"macroidentifier",
         [](const std::string &f)
             -> std::
                 shared_ptr<Node> {
                   return std::make_shared<Macroidentifier>(f);
                 }},
        {"escapedidentifier",
         [](
             const std::string &f) -> std::shared_ptr<Node> {
        ...
        {"tk_decnumber",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
                                        return std::make_shared<Tk_decnumber>(
                                            f);
                                      }},
        {"tk_realtime",
         [](const std::string &f) -> std::
        ...
        {"tk_timeliteral",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
                                        return std::make_shared<Tk_timeliteral>(
                                            f);
                                      }},
        {"begin",
         [](const std::string &f) -> std::
        ...
        {"signing",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
                                        return std::make_shared<Signing>(f);
                                      }},
        ...
        {"enum_data_type",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
                                        return std::make_shared<Enum_data_type>(
                                            f);
                                      }},
        {"non_integer_type",
         [](const std::string &f)
             -> std::
                 shared_ptr<Node> {
                   return std::make_shared<Non_integer_type>(f);
                 }},
        {"struct_data_type",
         [](const std::string &f)
             -> std::
                 shared_ptr<Node> {
                   return std::make_shared<Struct_data_type>(f);
                 }},
        ...
        {"misc_directive",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
                                        return std::make_shared<Misc_directive>(
                                            f);
                                      }},
        {"data_declaration",
         [](const std::string &f)
        ...
        {"time_literal",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
                                        return std::make_shared<Time_literal>(
                                            f);
                                      }},
        {"expression_opt",
         [](const std::string &f) -> std::
        ...
        {"class_new",
         [](const std::string &f) -> std::
                                      shared_ptr<Node> {
                                        return std::make_shared<Class_new>(f);
                                      }},
        {"dynamic_array_new",
         [](
             const std::string &f) -> std::shared_ptr<Node> {
        ...
        {"macroiditem",
         [](const std::string &f)
             -> std::shared_ptr<
                 Node> { return std::make_shared<Macroiditem>(f); }},
