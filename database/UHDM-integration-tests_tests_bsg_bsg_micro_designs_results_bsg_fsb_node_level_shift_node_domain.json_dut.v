...
module bsg_fsb_node_level_shift_node_domain(en_ls_i, clk_i, reset_i, clk_o, reset_o, fsb_v_i_o, fsb_data_i_o, fsb_yumi_o_i, fsb_v_o_i, fsb_data_o_i, fsb_ready_i_o, node_v_i_o, node_data_i_o, node_ready_o_i, node_v_o_i, node_data_o_i, node_yumi_i_o);
  ...
  \$paramod\bsg_level_shift_up_down_sink\width_p=s32'00000000000000000000000000000001  clk_ls_inst (
    .v0_data_i(clk_i),
    .v1_data_o(clk_o),
    .v1_en_i(1'h1)
  );
  ...
  \$paramod\bsg_level_shift_up_down_sink\width_p=s32'00000000000000000000000000000101  f2n_data_ls_inst (
  ...
  \$paramod\bsg_level_shift_up_down_sink\width_p=s32'00000000000000000000000000000001  f2n_v_ls_inst (
    .v0_data_i(fsb_v_o_i),
  ...
  \$paramod\bsg_level_shift_up_down_sink\width_p=s32'00000000000000000000000000000001  f2n_yumi_ls_inst (
  ...
  \$paramod\bsg_level_shift_up_down_source\width_p=s32'00000000000000000000000000000101  n2f_data_ls_inst (
  ...
  \$paramod\bsg_level_shift_up_down_source\width_p=s32'00000000000000000000000000000001  n2f_ready_ls_inst (
  ...
  \$paramod\bsg_level_shift_up_down_source\width_p=s32'00000000000000000000000000000001  n2f_v_ls_inst (
  ...
  \$paramod\bsg_level_shift_up_down_sink\width_p=s32'00000000000000000000000000000001  reset_ls_inst (
    .v0_data_i(reset_i),
    .v1_data_o(reset_o),
    .v1_en_i(1'h1)
  );
