...
module \$paramod$39e60911b7e3cbbad7911f0ceeb5e375fb4baf3d\bsg_fifo_1r1w_small_unhardened (clk_i, reset_i, v_i, ready_o, data_i, v_o, data_o, yumi_i);
...
module \$paramod$5fde959275c29c70195722ee09585b4bd1df4dc7\bsg_fifo_1r1w_small (clk_i, reset_i, v_i, ready_o, data_i, v_o, data_o, yumi_i);
  ...
  \$paramod$39e60911b7e3cbbad7911f0ceeb5e375fb4baf3d\bsg_fifo_1r1w_small_unhardened  \unhardened.un.fifo  (
    .clk_i(clk_i),
    .data_i(data_i),
    .data_o(data_o),
    .ready_o(ready_o),
...
module \$paramod$effe84855276ed6112b9161f23748ef6ec479457\bsg_channel_narrow (clk_i, reset_i, data_i, deque_o, data_o, deque_i);
...
module bsg_fifo_1r1w_narrowed(clk_i, reset_i, data_i, v_i, ready_o, v_o, data_o, yumi_i);
  ...
  \$paramod$5fde959275c29c70195722ee09585b4bd1df4dc7\bsg_fifo_1r1w_small  main_fifo (
    .clk_i(clk_i),
    .data_i(data_i),
    .data_o(data),
    .ready_o(ready_o),
  ...
  \$paramod$effe84855276ed6112b9161f23748ef6ec479457\bsg_channel_narrow  output_narrower (
    .clk_i(clk_i),
    .data_i(data),
    .data_o(data_o),
    .deque_i(yumi_i),
