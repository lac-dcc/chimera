...
// Date        : Thu Jul  7 03:07:25 2022
// Host        : boba running 64-bit Ubuntu 20.04.3 LTS
// Command     : write_verilog -force -file
//               runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//lpm.futil-vanilla-synth.v
// Design      : main
...
module std_eq__parameterized1
  ...
  CARRY8 out_carry
       (.CI(\<const1> ),
        .CI_TOP(GND_2),
        .CO({CO,out_carry_n_1,out_carry_n_2,out_carry_n_3,out_carry_n_4,out_carry_n_5,out_carry_n_6,out_carry_n_7}),
