...
module top_module_tb;
    ...
    initial begin
        ...
        // Tick 9: Inputs = 1'b1, Generated = out, Reference = 1'b1
        in = 1'b1; // Set input values
        #period;
        if (!(out === 1'b1)) begin
            $display("Mismatch at index 9: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b1, out, 1'b1);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 10: Inputs = 1'b0, Generated = out, Reference = 1'b0
        in = 1'b0; // Set input values
        #period;
        if (!(out === 1'b0)) begin
            $display("Mismatch at index 10: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b0, out, 1'b0);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 11: Inputs = 1'b1, Generated = out, Reference = 1'b1
        in = 1'b1; // Set input values
        #period;
        if (!(out === 1'b1)) begin
            $display("Mismatch at index 11: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b1, out, 1'b1);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 12: Inputs = 1'b1, Generated = out, Reference = 1'b1
        in = 1'b1; // Set input values
        #period;
        if (!(out === 1'b1)) begin
            $display("Mismatch at index 12: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b1, out, 1'b1);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 13: Inputs = 1'b0, Generated = out, Reference = 1'b0
        in = 1'b0; // Set input values
        #period;
        if (!(out === 1'b0)) begin
            $display("Mismatch at index 13: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b0, out, 1'b0);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 14: Inputs = 1'b1, Generated = out, Reference = 1'b1
        in = 1'b1; // Set input values
        #period;
        if (!(out === 1'b1)) begin
            $display("Mismatch at index 14: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b1, out, 1'b1);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 15: Inputs = 1'b0, Generated = out, Reference = 1'b0
        in = 1'b0; // Set input values
        #period;
        if (!(out === 1'b0)) begin
            $display("Mismatch at index 15: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b0, out, 1'b0);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 16: Inputs = 1'b1, Generated = out, Reference = 1'b1
        in = 1'b1; // Set input values
        #period;
        if (!(out === 1'b1)) begin
            $display("Mismatch at index 16: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b1, out, 1'b1);
            mismatch_count = mismatch_count + 1;
        end
        ...
        // Tick 18: Inputs = 1'b1, Generated = out, Reference = 1'b1
        in = 1'b1; // Set input values
        #period;
        if (!(out === 1'b1)) begin
            $display("Mismatch at index 18: Inputs = [%b], Generated = [%b], Reference = [%b]", 1'b1, out, 1'b1);
            mismatch_count = mismatch_count + 1;
        end
