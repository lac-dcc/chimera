...
// nv_ram_rwsp_256x257: synthesizable model core
...
module nv_ram_rwsp_256x257_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
output [256:0] mbist_Do_r0_int_net;
...
wire [256:0] Data_reg_r0;
// Data out bus for read port r0 for Output Mux
wire [256:0] r0_OutputMuxDataOut;
...
wire shiftDR_en;
reg [256:0] pre_muxed_Di_w0;
wire [256:0] pre_muxed_Di_w0_A, pre_muxed_Di_w0_B;
wire pre_muxed_Di_w0_S;
assign pre_muxed_Di_w0_S = !debug_mode_sync;
assign pre_muxed_Di_w0_A = Data_reg_r0[256:0];
assign pre_muxed_Di_w0_B = {mbist_Di_w0[0], {56{mbist_Di_w0}}, {72{mbist_Di_w0}}};
always @(pre_muxed_Di_w0_S or pre_muxed_Di_w0_A or pre_muxed_Di_w0_B)
    case(pre_muxed_Di_w0_S) // synopsys infer_mux
      1'b0 : pre_muxed_Di_w0 = pre_muxed_Di_w0_A;
      1'b1 : pre_muxed_Di_w0 = pre_muxed_Di_w0_B;
      default : pre_muxed_Di_w0 = {257{`tick_x_or_0}};
    endcase
reg [256:0] muxed_Di_w0;
wire [256:0] muxed_Di_w0_A, muxed_Di_w0_B;
assign muxed_Di_w0_A = {di[256:144], di[143:0]};
...
always @(muxed_Di_w0_S or muxed_Di_w0_A or muxed_Di_w0_B)
    case(muxed_Di_w0_S) // synopsys infer_mux
      ...
      default : muxed_Di_w0 = {257{`tick_x_or_0}};
    endcase
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_144 : Piece RAMPDP_256X113_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 255 Addressrange: [7:0]
// Data Bit range: [256:144] (113 bits)
// Enables: 1 Enable range:
// Declare some wires for doing chip select logic
// verilint 498 off - Incompatible width
...
// Write Data in bus
wire [256:144] Wdata_0_144;
assign Wdata_0_144 = muxed_Di_w0[256:144];
assign we_0_144 = we;
// Read Address bus
wire [7:0] ra_0_144;
assign ra_0_144 = muxed_Ra_r0[7:0];
// Read DataOut bus
wire [256:144] dout_0_144;
assign re_0_144 = re;
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell RAMPDP_256X113_GL_M2_D2_0_144 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
// Declare the ramOutData which connects to the ram directly
wire [256:144] ramDataOut_0_144;
assign dout_0_144[256:144] = ramDataOut_0_144[256:144];
RAMPDP_256X113_GL_M2_D2 ram_Inst_256X113_0_144 (
...
reg [256:0] ram_r0_OutputMuxDataOut;
...
//For bitEnd 256, only one piece RAMPDP_256X113_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_144[256:144] or muxed_Di_w0[256:144] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[256:144] = (ram_bypass) ? muxed_Di_w0[256:144]: dout_0_144;
end
assign r0_OutputMuxDataOut[256:144] = ram_r0_OutputMuxDataOut[256:144];
// verilint 17 on - Range (rather than full vector) in the sensitivity list
...
wire captureDR_r0 = dft_capdr_r | ((((ore)) & !mbist_en_r & !debug_mode_sync) || ( debug_mode_sync ? (1'b1& (access_en_r_1p_0_0 | access_en_r_1p_0_144)) : ((mbist_en_r & (mbist_ce_r0_0_0_1p | mbist_ce_r0_0_144_1p) & !1'b0))));
////MSB 256 LSB 0  and total rambit is 257 and  dsize is 257
wire Data_reg_SO_r0;
// verilint 110 off - Incompatible width
// verilint 630 off - Port connected to a NULL expression
// These are used for registering Ra in case of Latch arrays as well (i.e.
// used in functional path as well)
wire [256:0]data_regq;
assign Data_reg_r0[256:0] = data_regq[256:0] ;
// verilint 110 on - Incompatible width
// verilint 630 on - Port connected to a NULL expression
assign dout = Data_reg_r0;
assign mbist_Do_r0_int_net = Data_reg_r0[257-1:0];
...
ScanShareSel_JTAG_reg_ext_cg #(8, 0, 0) testInst_Ra_reg_r0 (
     .clk(gated_clk_jtag_Wa_reg_w0), .sel(debug_mode),
            ...
            .scanin(we_reg_SO_w0_0_144), .scanout(Ra_reg_SO_r0) );
...
wire [256:0] Data_reg_r0_D = r0_OutputMuxDataOut[256:0];
wire [256:0] Data_reg_r0_Q;
assign data_regq[256:0] = Data_reg_r0_Q;
wire so_Data_reg_r0_256_1;
ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_256_1 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(Data_reg_r0_D[256:1]), .Q(Data_reg_r0_Q[256:1]),
            .scanin(re_reg_SO_r0_0_144), .scanout(so_Data_reg_r0_256_1) );
ScanShareSel_JTAG_reg_ext_cg #(1, 0, 0) testInst_Data_reg_r0_0_0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(Data_reg_r0_D[0:0]), .Q(Data_reg_r0_Q[0:0]),
            .scanin(so_Data_reg_r0_256_1), .scanout(Data_reg_SO_r0) );
`ifdef ASSERT_ON
`ifndef SYNTHESIS
reg sim_reset_;
