...
// jttrojan_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
parameter SCR2_OFFSET = (`SCR2_START-`JTFRAME_BA2_START)>>1;
parameter SCR_OFFSET = (`SCR_START -`JTFRAME_BA3_START)>>1;
...
`endif
    // Audio channels
    .psg0     ( psg0      ),.psg1     ( psg1      ),.fm0     ( fm0      ),.fm1     ( fm1      ),.pcm     ( pcm      ),
