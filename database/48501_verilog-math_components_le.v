...
module le(clk, le_a, le_b, le_z);
  ...
  assign s_0 = s_1 & s_502;
  assign s_1 = s_2 & s_495;
  ...
  assign s_468 = 1'd0;
  assign s_469 = ~s_470;
  assign s_470 = s_483?s_471:s_475;
  dq #(1, 7) dq_s_471 (clk, s_471, s_472);
  assign s_472 = s_79?s_473:s_474;
  assign s_473 = s_44?s_86:s_87;
  assign s_474 = s_44?s_87:s_86;
  dq #(1, 5) dq_s_475 (clk, s_475, s_476);
  assign s_476 = s_480?s_477:s_479;
  dq #(1, 2) dq_s_477 (clk, s_477, s_478);
  assign s_478 = s_86 & s_87;
  dq #(1, 2) dq_s_479 (clk, s_479, s_472);
  assign s_480 = s_481 == s_482;
  dq #(28, 1) dq_s_481 (clk, s_481, s_16);
  assign s_482 = 1'd0;
  assign s_483 = s_484 | s_494;
  assign s_484 = s_485 | s_493;
  assign s_485 = $signed(s_486) > $signed(s_492);
  dq #(9, 1) dq_s_486 (clk, s_486, s_487);
  assign s_487 = s_488 + s_467;
  dq #(9, 1) dq_s_488 (clk, s_488, s_489);
  dq #(9, 1) dq_s_489 (clk, s_489, s_490);
  assign s_490 = s_491 - s_89;
  dq #(9, 3) dq_s_491 (clk, s_491, s_442);
  assign s_492 = 8'd127;
  dq #(1, 7) dq_s_493 (clk, s_493, s_53);
  dq #(1, 7) dq_s_494 (clk, s_494, s_59);
  dq #(1, 7) dq_s_495 (clk, s_495, s_496);
  assign s_496 = ~s_497;
  assign s_497 = s_498 & s_500;
  assign s_498 = s_38 == s_499;
  assign s_499 = 8'd128;
  assign s_500 = s_43 != s_501;
  assign s_501 = 23'd0;
  dq #(1, 7) dq_s_502 (clk, s_502, s_503);
  assign s_503 = ~s_504;
  assign s_504 = s_505 & s_507;
  assign s_505 = s_27 == s_506;
  assign s_506 = 8'd128;
  assign s_507 = s_32 != s_508;
  assign s_508 = 23'd0;
  assign le_z = s_0;
endmodule
