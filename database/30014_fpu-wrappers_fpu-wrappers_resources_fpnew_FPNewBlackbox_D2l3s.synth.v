...
module \$paramod$1775a1231a3632f3463ae0a388411b4e9fd9841b\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  ...
  \$paramod$7ede5cd832440aabd48fe9bd619ce45c46b78607\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[1].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$22c5b8dda4dace880e585864d469dec11ec4a854\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module \$paramod$4dffaaa76975fa9a810a1a53bbd409e4982e6ede\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:335$535.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:335$536.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:355$533.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:355$534.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:335$535.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:335$536.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:355$533.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:355$534.inp  = 2'hx;
endmodule
...
module \$paramod$62b97f2c24fbd0ec64efd8c0255d5867594e9cd9\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:153$623.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:153$624.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$607.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$608.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$617.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$618.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$619.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$620.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$621.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$622.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$607.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$608.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$608.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$607.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$607.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$608.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:153$623.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:153$624.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$607.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$608.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$617.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$618.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$619.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$620.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$621.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l3s.preprocessed.v:173$622.inp  = 3'hx;
endmodule

module \$paramod$7ede5cd832440aabd48fe9bd619ce45c46b78607\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o, reg_ena_i
);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  ...
  \$paramod$fce05954694d695077c4a45aabe8b18f28c4afd2\fpnew_fma_FC83A_5615B  \gen_num_lanes[1].active_lane.lane_instance.i_fma  (
    .aux_i(vectorial_op_i),
...
module \$paramod$cb5426c5fcfc144621ccc8762ee1f839d80d99e8\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
);
  wire _00_;
  wire _01_;
  wire _02_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8198$214.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8198$55.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$111.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$146.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$181.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$230.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$246.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$262.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$278.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$76.$result ;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1696  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1696 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1696 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1696 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1696 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1696 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1696 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1696 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1696 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1696 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1696 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1696 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1696 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1696 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1696 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1696 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1696 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$181.$result  = \$auto$proc_rom.cc:150:do_switch$1696 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1700  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1700 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1700 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1700 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1700 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1700 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1700 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1700 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1700 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1700 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1700 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1700 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1700 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1700 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1700 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1700 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1700 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$146.$result  = \$auto$proc_rom.cc:150:do_switch$1700 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$111.$result  = \$auto$proc_rom.cc:150:do_switch$1704 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$76.$result  = \$auto$proc_rom.cc:150:do_switch$1708 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8198$55.$result  = \$auto$proc_rom.cc:150:do_switch$1712 [op_i];
  ...
  assign _12_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$76.$result ;
  assign _13_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$111.$result  == 2'h1;
  assign _14_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$146.$result  == 2'h2;
  assign _15_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$181.$result  == 2'h3;
  assign simd_mask = simd_mask_i | 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _63_ = opgrp_in_ready;
  assign _16_ = _63_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8198$55.$result  +: 1];
  ...
  \$paramod$1775a1231a3632f3463ae0a388411b4e9fd9841b\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f0f545aa296b6cdec0472ac0a3e0b76c0b9a2aff\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$fcf69505f380ed0fba376ce2eaf6a5b21ffe632a\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$22c5b8dda4dace880e585864d469dec11ec4a854\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8198$214.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$230.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$246.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$262.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_D2l3s.preprocessed.v:8247$278.op  = 4'hx;
...
module \$paramod$f0f545aa296b6cdec0472ac0a3e0b76c0b9a2aff\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
, busy_o, reg_ena_i);
  ...
  assign _045_ = ! rounded_abs[62:52];
  assign _046_ = ! pre_round_abs[62:52];
  assign _047_ = rounded_abs[62:52] == 11'h001;
  ...
  assign _063_ = _067_ && _072_;
  assign _064_ = _065_ && _073_;
  assign _065_ = _046_ && _047_;
  ...
  assign _072_ = _043_ || _044_;
  assign _073_ = _074_ || _063_;
  assign uf_after_round = _045_ || _064_;
...
module \$paramod$fcf69505f380ed0fba376ce2eaf6a5b21ffe632a\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$cb5426c5fcfc144621ccc8762ee1f839d80d99e8\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
