...
module echo_server_application_m_axis_tx_metadata_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [15:0] txMetaData_V_V_din,
    output wire        txMetaData_V_V_full_n,
    input  wire        txMetaData_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
...
wire [0:0]  txMetaData_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [15:0] s_data;
...
//------------------------Instantiation------------------
// rs
echo_server_application_m_axis_tx_metadata_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// txMetaData_V_V_fifo
echo_server_application_m_axis_tx_metadata_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) txMetaData_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( txMetaData_V_V_empty_n ),
    .full_n     ( txMetaData_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( txMetaData_V_V_write ),
    .dout       ( txMetaData_V_V_dout ),
    .din        ( txMetaData_V_V_din )
);
...
assign s_data  = {txMetaData_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = txMetaData_V_V_empty_n;
...
module echo_server_application_m_axis_tx_metadata_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module echo_server_application_m_axis_tx_metadata_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
