...
// ----- Blif Benchmark input a is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[8] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[8] = a[0];

// ----- Blif Benchmark input b is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[7] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[7] = b[0];

// ----- Blif Benchmark input clk is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[34] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[34] = clk[0];

// ----- Blif Benchmark output out_c is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[9] -----
	assign out_c_fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[9];

// ----- Blif Benchmark output out_d is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[6] -----
	assign out_d_fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[6];
