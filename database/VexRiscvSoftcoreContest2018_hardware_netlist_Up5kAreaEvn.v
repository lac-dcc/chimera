...
module VexRiscv (
  ...
  assign _zz_142_ = _zz_86_[0 : 0];
  assign _zz_143_ = _zz_86_[4 : 4];
  assign _zz_144_ = _zz_86_[5 : 5];
  assign _zz_145_ = _zz_86_[12 : 12];
  ...
  assign _zz_174_ = (32'b00000000000000000000000001011000);
  assign _zz_175_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000010100)) == (32'b00000000000000000000000000000100));
  assign _zz_176_ = ((decode_INSTRUCTION & _zz_183_) == (32'b00000000000000000000000000000100));
  assign _zz_177_ = _zz_90_;
  assign _zz_178_ = {(_zz_184_ == _zz_185_),{_zz_186_,{_zz_187_,_zz_188_}}};
  assign _zz_179_ = (4'b0000);
  assign _zz_180_ = ({_zz_189_,_zz_89_} != (2'b00));
  assign _zz_181_ = ({_zz_190_,_zz_191_} != (3'b000));
  assign _zz_182_ = {(_zz_192_ != _zz_193_),{_zz_194_,{_zz_195_,_zz_196_}}};
  assign _zz_183_ = (32'b00000000000000000000000001000100);
  assign _zz_184_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_185_ = (32'b00000000000000000000000000000000);
  assign _zz_186_ = ((decode_INSTRUCTION & _zz_197_) == (32'b00000000000000000000000000000000));
  assign _zz_187_ = (_zz_198_ == _zz_199_);
  assign _zz_188_ = (_zz_200_ == _zz_201_);
  assign _zz_189_ = ((decode_INSTRUCTION & _zz_202_) == (32'b00000000000000000001000000000000));
  assign _zz_190_ = _zz_89_;
  assign _zz_191_ = {_zz_203_,_zz_204_};
  assign _zz_192_ = (_zz_205_ == _zz_206_);
  assign _zz_193_ = (1'b0);
  assign _zz_194_ = ({_zz_207_,_zz_208_} != (2'b00));
  assign _zz_195_ = (_zz_209_ != _zz_210_);
  assign _zz_196_ = {_zz_211_,{_zz_212_,_zz_213_}};
  assign _zz_197_ = (32'b00000000000000000000000000011000);
  assign _zz_198_ = (decode_INSTRUCTION & (32'b00000000000000000110000000000100));
  assign _zz_199_ = (32'b00000000000000000010000000000000);
  assign _zz_200_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000100));
  assign _zz_201_ = (32'b00000000000000000001000000000000);
  assign _zz_202_ = (32'b00000000000000000001000000000000);
  assign _zz_203_ = ((decode_INSTRUCTION & (32'b00000000000000000011000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_204_ = ((decode_INSTRUCTION & (32'b00000000000000000011000000000000)) == (32'b00000000000000000010000000000000));
  assign _zz_205_ = (decode_INSTRUCTION & (32'b00000000000000000111000001010100));
  assign _zz_206_ = (32'b00000000000000000101000000010000);
  assign _zz_207_ = ((decode_INSTRUCTION & _zz_214_) == (32'b01000000000000000001000000010000));
  assign _zz_208_ = ((decode_INSTRUCTION & _zz_215_) == (32'b00000000000000000001000000010000));
  assign _zz_209_ = {_zz_88_,(_zz_216_ == _zz_217_)};
  assign _zz_210_ = (2'b00);
  assign _zz_211_ = ((_zz_218_ == _zz_219_) != (1'b0));
  assign _zz_212_ = (_zz_87_ != (1'b0));
  assign _zz_213_ = {(_zz_220_ != _zz_221_),{_zz_222_,{_zz_223_,_zz_224_}}};
  assign _zz_214_ = (32'b01000000000000000011000001010100);
  assign _zz_215_ = (32'b00000000000000000111000001010100);
  assign _zz_216_ = (decode_INSTRUCTION & (32'b00000000000000000001000000010100));
  assign _zz_217_ = (32'b00000000000000000000000000000100);
  assign _zz_218_ = (decode_INSTRUCTION & (32'b00000000000000000000000001011000));
  assign _zz_219_ = (32'b00000000000000000000000001000000);
  assign _zz_220_ = {((decode_INSTRUCTION & _zz_225_) == (32'b00000000000000000010000000000000)),((decode_INSTRUCTION & _zz_226_) == (32'b00000000000000000001000000000000))};
  assign _zz_221_ = (2'b00);
  assign _zz_222_ = (((decode_INSTRUCTION & _zz_227_) == (32'b00000000000000000000000000000000)) != (1'b0));
  assign _zz_223_ = ({_zz_228_,{_zz_229_,_zz_230_}} != (3'b000));
  assign _zz_224_ = {(_zz_231_ != (1'b0)),{(_zz_232_ != _zz_233_),{_zz_234_,{_zz_235_,_zz_236_}}}};
  ...
  assign _zz_228_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001100100)) == (32'b00000000000000000000000000100100));
  assign _zz_229_ = ((decode_INSTRUCTION & _zz_237_) == (32'b00000000000000000100000000010000));
  assign _zz_230_ = ((decode_INSTRUCTION & _zz_238_) == (32'b00000000000000000001000000010000));
  assign _zz_231_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_232_ = ((decode_INSTRUCTION & _zz_239_) == (32'b00000000000000000000000000010000));
  assign _zz_233_ = (1'b0);
  assign _zz_234_ = ({_zz_89_,_zz_240_} != (2'b00));
  assign _zz_235_ = ({_zz_241_,_zz_242_} != (2'b00));
  assign _zz_236_ = {(_zz_243_ != _zz_244_),{_zz_245_,{_zz_246_,_zz_247_}}};
  assign _zz_237_ = (32'b00000000000000000100000000010100);
  assign _zz_238_ = (32'b00000000000000000011000000010100);
  assign _zz_239_ = (32'b00000000000000000000000000010000);
  assign _zz_240_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001110000)) == (32'b00000000000000000000000000100000));
  assign _zz_241_ = _zz_89_;
  assign _zz_242_ = ((decode_INSTRUCTION & _zz_248_) == (32'b00000000000000000000000000000000));
  assign _zz_243_ = {(_zz_249_ == _zz_250_),(_zz_251_ == _zz_252_)};
  assign _zz_244_ = (2'b00);
  assign _zz_245_ = ({_zz_88_,{_zz_253_,_zz_254_}} != (6'b000000));
  assign _zz_246_ = ({_zz_255_,_zz_256_} != (2'b00));
  assign _zz_247_ = {(_zz_257_ != _zz_258_),{_zz_259_,_zz_260_}};
  assign _zz_248_ = (32'b00000000000000000000000000100000);
  assign _zz_249_ = (decode_INSTRUCTION & (32'b00000000000000000001000001010000));
  assign _zz_250_ = (32'b00000000000000000001000001010000);
  assign _zz_251_ = (decode_INSTRUCTION & (32'b00000000000000000010000001010000));
  assign _zz_252_ = (32'b00000000000000000010000001010000);
  assign _zz_253_ = ((decode_INSTRUCTION & _zz_261_) == (32'b00000000000000000001000000010000));
  assign _zz_254_ = {(_zz_262_ == _zz_263_),{_zz_264_,{_zz_265_,_zz_266_}}};
  assign _zz_255_ = ((decode_INSTRUCTION & _zz_267_) == (32'b00000000000000000000000000100000));
  assign _zz_256_ = ((decode_INSTRUCTION & _zz_268_) == (32'b00000000000000000000000000100000));
  assign _zz_257_ = ((decode_INSTRUCTION & _zz_269_) == (32'b00000000000000000000000001010000));
  assign _zz_258_ = (1'b0);
  assign _zz_259_ = ({_zz_270_,_zz_271_} != (2'b00));
  assign _zz_260_ = ({_zz_272_,{_zz_273_,_zz_274_}} != (3'b000));
  ...
  assign _zz_264_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000100)) == (32'b00000000000000000000000000000100));
  assign _zz_265_ = _zz_87_;
  assign _zz_266_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000101000)) == (32'b00000000000000000000000000000000));
  assign _zz_267_ = (32'b00000000000000000000000000110100);
  assign _zz_268_ = (32'b00000000000000000000000001100100);
  assign _zz_269_ = (32'b00010000000000000011000001010000);
  assign _zz_270_ = ((decode_INSTRUCTION & (32'b00010000000100000011000001010000)) == (32'b00000000000100000000000001010000));
  assign _zz_271_ = ((decode_INSTRUCTION & (32'b00010000010000000011000001010000)) == (32'b00010000000000000000000001010000));
  assign _zz_272_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000001000000));
  assign _zz_273_ = ((decode_INSTRUCTION & (32'b01000000000000000000000000110000)) == (32'b01000000000000000000000000110000));
  assign _zz_274_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010100)) == (32'b00000000000000000010000000010000));
  initial begin
  ...
  assign decode_MEMORY_ENABLE = _zz_42_;
  ...
  assign _zz_86_ = {(((decode_INSTRUCTION & _zz_174_) == (32'b00000000000000000000000000000000)) != (1'b0)),{({_zz_175_,_zz_90_} != (2'b00)),{({_zz_176_,_zz_177_} != (2'b00)),{(_zz_178_ != _zz_179_),{_zz_180_,{_zz_181_,_zz_182_}}}}}};
  assign _zz_53_ = _zz_142_[0];
  assign _zz_91_ = _zz_86_[2 : 1];
  assign _zz_52_ = _zz_91_;
  assign _zz_51_ = _zz_143_[0];
  assign _zz_50_ = _zz_144_[0];
  assign _zz_92_ = _zz_86_[7 : 6];
  assign _zz_49_ = _zz_92_;
  assign _zz_93_ = _zz_86_[10 : 9];
  assign _zz_48_ = _zz_93_;
  assign _zz_47_ = _zz_145_[0];
  assign _zz_94_ = _zz_86_[15 : 14];
  assign _zz_46_ = _zz_94_;
  assign _zz_95_ = _zz_86_[17 : 16];
  assign _zz_45_ = _zz_95_;
  assign _zz_96_ = _zz_86_[19 : 18];
  assign _zz_44_ = _zz_96_;
