...
module VexRiscvLitexSmpCluster_Cc1_Iw32Is4096Iy1_Dw32Ds4096Dy1_ITs4DTs4_Ood_Wm (
  ...
  wire       [0:0]    peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_payload_fragment_context;
  ...
  reg        [0:0]    peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_rData_fragment_context;
  ...
  wire       [0:0]    peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_m2sPipe_payload_fragment_context;
  ...
  reg        [0:0]    peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_m2sPipe_rData_fragment_source;
  ...
  reg        [0:0]    peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_m2sPipe_rData_fragment_context;
  wire                _zz_439;
  reg                 _zz_440;
  reg                 _zz_441;
  reg        [0:0]    _zz_442;
  ...
  assign _zz_457 = (debugCd_logic_holdingLogic_resetCounter != 12'hfff);
  assign _zz_458 = (systemCd_logic_holdingLogic_resetCounter != 6'h3f);
  assign _zz_459 = (plic_logic_bridge_coherencyStall_value != 1'b0);
  assign _zz_460 = (dBus_Bridge_bus_cmd_ready && (! dBus_Bridge_bus_cmd_s2mPipe_ready));
  assign _zz_461 = (! cores_0_cpu_iBus_cmd_halfPipe_regs_valid);
  assign _zz_462 = (dBusCoherent_bmb_cmd_ready && (! dBusCoherent_bmb_cmd_s2mPipe_ready));
  assign _zz_463 = (! iArbiter_bmb_cmd_halfPipe_regs_valid);
  assign _zz_464 = (dBusNonCoherent_bmb_cmd_ready && (! dBusNonCoherent_bmb_cmd_s2mPipe_ready));
  assign _zz_465 = (_zz_456 && (! peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_ready));
  assign _zz_466 = (debugBridge_logic_debugger_io_mem_cmd_payload_address >>> 2);
  assign _zz_467 = ({3'd0,_zz_32} <<< debugBridge_logic_debugger_io_mem_cmd_payload_address[1 : 0]);
  assign _zz_468 = (_zz_134 ? cores_0_cpu_externalInterrupt_plic_target_requests_0_id : cores_0_cpu_externalInterrupt_plic_target_requests_1_id);
  assign _zz_469 = (_zz_137 ? cores_0_cpu_externalInterrupt_plic_target_requests_2_id : cores_0_cpu_externalInterrupt_plic_target_requests_3_id);
  assign _zz_470 = (_zz_140 ? cores_0_cpu_externalInterrupt_plic_target_requests_4_id : cores_0_cpu_externalInterrupt_plic_target_requests_5_id);
  assign _zz_471 = (_zz_143 ? cores_0_cpu_externalInterrupt_plic_target_requests_6_id : cores_0_cpu_externalInterrupt_plic_target_requests_7_id);
  assign _zz_472 = (_zz_146 ? cores_0_cpu_externalInterrupt_plic_target_requests_8_id : cores_0_cpu_externalInterrupt_plic_target_requests_9_id);
  assign _zz_473 = (_zz_149 ? cores_0_cpu_externalInterrupt_plic_target_requests_10_id : cores_0_cpu_externalInterrupt_plic_target_requests_11_id);
  assign _zz_474 = (_zz_152 ? cores_0_cpu_externalInterrupt_plic_target_requests_12_id : cores_0_cpu_externalInterrupt_plic_target_requests_13_id);
  assign _zz_475 = (_zz_155 ? cores_0_cpu_externalInterrupt_plic_target_requests_14_id : cores_0_cpu_externalInterrupt_plic_target_requests_15_id);
  assign _zz_476 = (_zz_158 ? cores_0_cpu_externalInterrupt_plic_target_requests_16_id : cores_0_cpu_externalInterrupt_plic_target_requests_17_id);
  assign _zz_477 = (_zz_161 ? cores_0_cpu_externalInterrupt_plic_target_requests_18_id : cores_0_cpu_externalInterrupt_plic_target_requests_19_id);
  assign _zz_478 = (_zz_164 ? cores_0_cpu_externalInterrupt_plic_target_requests_20_id : cores_0_cpu_externalInterrupt_plic_target_requests_21_id);
  assign _zz_479 = (_zz_167 ? cores_0_cpu_externalInterrupt_plic_target_requests_22_id : cores_0_cpu_externalInterrupt_plic_target_requests_23_id);
  assign _zz_480 = (_zz_170 ? cores_0_cpu_externalInterrupt_plic_target_requests_24_id : cores_0_cpu_externalInterrupt_plic_target_requests_25_id);
  assign _zz_481 = (_zz_173 ? cores_0_cpu_externalInterrupt_plic_target_requests_26_id : cores_0_cpu_externalInterrupt_plic_target_requests_27_id);
  assign _zz_482 = (_zz_176 ? cores_0_cpu_externalInterrupt_plic_target_requests_28_id : cores_0_cpu_externalInterrupt_plic_target_requests_29_id);
  assign _zz_483 = (_zz_179 ? cores_0_cpu_externalInterrupt_plic_target_requests_30_id : cores_0_cpu_externalInterrupt_plic_target_requests_31_id);
  assign _zz_484 = (_zz_225 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_0_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_1_id);
  assign _zz_485 = (_zz_228 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_2_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_3_id);
  assign _zz_486 = (_zz_231 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_4_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_5_id);
  assign _zz_487 = (_zz_234 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_6_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_7_id);
  assign _zz_488 = (_zz_237 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_8_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_9_id);
  assign _zz_489 = (_zz_240 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_10_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_11_id);
  assign _zz_490 = (_zz_243 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_12_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_13_id);
  assign _zz_491 = (_zz_246 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_14_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_15_id);
  assign _zz_492 = (_zz_249 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_16_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_17_id);
  assign _zz_493 = (_zz_252 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_18_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_19_id);
  assign _zz_494 = (_zz_255 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_20_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_21_id);
  assign _zz_495 = (_zz_258 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_22_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_23_id);
  assign _zz_496 = (_zz_261 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_24_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_25_id);
  assign _zz_497 = (_zz_264 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_26_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_27_id);
  assign _zz_498 = (_zz_267 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_28_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_29_id);
  assign _zz_499 = (_zz_270 ? cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_30_id : cores_0_cpu_externalSupervisorInterrupt_plic_target_requests_31_id);
  ...
  BmbToWishbone peripheralBridge_logic (
    ...
    .io_input_cmd_payload_fragment_context    (peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_m2sPipe_payload_fragment_context        ), //i
  ...
  assign debugBridge_logic_mmMaster_cmd_payload_fragment_address = {_zz_466,2'b00};
  ...
  assign _zz_425 = ((1'b1 && (! _zz_426)) || iArbiter_bmb_rsp_ready);
  assign _zz_426 = _zz_427;
  assign iArbiter_bmb_rsp_valid = _zz_426;
  assign iArbiter_bmb_rsp_payload_last = _zz_428;
  assign iArbiter_bmb_rsp_payload_fragment_opcode = _zz_429;
  assign iArbiter_bmb_rsp_payload_fragment_data = _zz_430;
  ...
  assign _zz_431 = ((1'b1 && (! _zz_432)) || dBusNonCoherent_bmb_rsp_ready);
  assign _zz_432 = _zz_433;
  assign dBusNonCoherent_bmb_rsp_valid = _zz_432;
  assign dBusNonCoherent_bmb_rsp_payload_last = _zz_434;
  assign dBusNonCoherent_bmb_rsp_payload_fragment_opcode = _zz_435;
  assign dBusNonCoherent_bmb_rsp_payload_fragment_data = _zz_436;
  assign dBusNonCoherent_bmb_rsp_payload_fragment_context = _zz_437;
  ...
  assign peripheralBridge_bmb_slaveModel_arbiterGen_logic_sorted_0_decoder_rsp_ready = _zz_431;
  ...
  assign _zz_456 = (! peripheralBridge_bmb_arbiter_io_output_cmd_s2mPipe_rValid);
  ...
  always @ (posedge debugCd_external_clk) begin
    if(systemCd_logic_outputReset) begin
      ...
      if(_zz_425)begin
        _zz_427 <= iArbiter_bmb_decoder_io_input_rsp_valid;
      end
      ...
      if(_zz_431)begin
        _zz_433 <= peripheralBridge_bmb_slaveModel_arbiterGen_logic_sorted_0_decoder_rsp_valid;
      end
  ...
  always @ (posedge debugCd_external_clk) begin
    ...
    cores_0_cpu_externalInterrupt_plic_target_bestRequest_id <= (_zz_224 ? (_zz_218 ? (_zz_206 ? (_zz_182 ? _zz_468 : _zz_469) : (_zz_185 ? _zz_470 : _zz_471)) : (_zz_209 ? (_zz_188 ? _zz_472 : _zz_473) : (_zz_191 ? _zz_474 : _zz_475))) : (_zz_221 ? (_zz_212 ? (_zz_194 ? _zz_476 : _zz_477) : (_zz_197 ? _zz_478 : _zz_479)) : (_zz_215 ? (_zz_200 ? _zz_480 : _zz_481) : (_zz_203 ? _zz_482 : _zz_483))));
    ...
    cores_0_cpu_externalSupervisorInterrupt_plic_target_bestRequest_id <= (_zz_315 ? (_zz_309 ? (_zz_297 ? (_zz_273 ? _zz_484 : _zz_485) : (_zz_276 ? _zz_486 : _zz_487)) : (_zz_300 ? (_zz_279 ? _zz_488 : _zz_489) : (_zz_282 ? _zz_490 : _zz_491))) : (_zz_312 ? (_zz_303 ? (_zz_285 ? _zz_492 : _zz_493) : (_zz_288 ? _zz_494 : _zz_495)) : (_zz_306 ? (_zz_291 ? _zz_496 : _zz_497) : (_zz_294 ? _zz_498 : _zz_499))));
    ...
    if(_zz_425)begin
      _zz_428 <= iArbiter_bmb_decoder_io_input_rsp_payload_last;
      _zz_429 <= iArbiter_bmb_decoder_io_input_rsp_payload_fragment_opcode;
      _zz_430 <= iArbiter_bmb_decoder_io_input_rsp_payload_fragment_data;
    end
    if(_zz_464)begin
    ...
    if(_zz_431)begin
      _zz_434 <= peripheralBridge_bmb_slaveModel_arbiterGen_logic_sorted_0_decoder_rsp_payload_last;
      _zz_435 <= peripheralBridge_bmb_slaveModel_arbiterGen_logic_sorted_0_decoder_rsp_payload_fragment_opcode;
      _zz_436 <= peripheralBridge_bmb_slaveModel_arbiterGen_logic_sorted_0_decoder_rsp_payload_fragment_data;
      _zz_437 <= peripheralBridge_bmb_slaveModel_arbiterGen_logic_sorted_0_decoder_rsp_payload_fragment_context;
    end
    if(_zz_465)begin
