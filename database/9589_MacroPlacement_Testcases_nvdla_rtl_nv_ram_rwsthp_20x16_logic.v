...
// nv_ram_rwsthp_20x16: synthesizable model core
...
module nv_ram_rwsthp_20x16_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMDP_20X16_GL_M1_E2 (RamCell)
...
// ----------------- begin Ram Cell RAMDP_20X16_GL_M1_E2 -------------
// Write Port Stuff -----
...
RAMDP_20X16_GL_M1_E2 ram_Inst_20X16 (
...
//For bitEnd 15, only one piece RAMDP_20X16_GL_M1_E2 in the column.
...
wire [15:0] functional_byp_muxed_r0_OutputMuxDataOut = (byp_sel & !debug_mode_sync & !mbist_en_r) ? dbyp : wthru_di;
wire [15:0] muxed_r0_OutputMuxDataOut;
...
ScanShareSel_JTAG_reg_ext_cg #(16, 0, 0) testInst_Data_reg_r0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(muxed_r0_OutputMuxDataOut[15:0]), .Q(data_regq[15:0]),
