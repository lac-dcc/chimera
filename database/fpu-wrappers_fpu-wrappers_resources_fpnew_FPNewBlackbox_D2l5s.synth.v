...
module \$paramod$2bcca55405449b4c3d8a8d2fbe7916b2f8b62dce\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
, busy_o, reg_ena_i);
  ...
  assign _049_ = rounded_abs[62:52] == 11'h001;
  assign _050_ = ! rnd_mode_i;
  assign _051_ = rnd_mode_i == 3'h4;
  assign _052_ = ! rounded_abs[62:52];
  assign _053_ = ! pre_round_abs[62:52];
  ...
  assign uf_after_round = _052_ || _071_;
...
module \$paramod$4dffaaa76975fa9a810a1a53bbd409e4982e6ede\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:335$535.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:335$536.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:355$533.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:355$534.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:335$535.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:335$536.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:355$533.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:355$534.inp  = 2'hx;
endmodule
...
module \$paramod$62b97f2c24fbd0ec64efd8c0255d5867594e9cd9\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:153$623.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:153$624.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$607.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$608.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$617.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$618.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$619.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$620.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$621.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$622.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$607.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$608.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$608.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$607.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$607.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$608.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:153$623.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:153$624.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$607.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$608.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$617.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$618.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$619.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$620.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$621.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_D2l5s.preprocessed.v:173$622.inp  = 3'hx;
endmodule

module \$paramod$9e191ce216debc757330a3313214d27bfc3b53ea\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
);
  wire _00_;
  wire _01_;
  wire _02_;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1784  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1784 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1784 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1784 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1784 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1784 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1784 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1784 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1784 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1784 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1784 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1784 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1784 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1784 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1784 [13] = 2'h3;
  ...
  initial begin
    ...
    \$auto$proc_rom.cc:150:do_switch$1788 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1788 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1788 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1788 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1788 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1788 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1788 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1788 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1788 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1788 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1788 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1788 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1788 [13] = 2'h3;
  ...
  initial begin
    ...
    \$auto$proc_rom.cc:150:do_switch$1792 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1792 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1792 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1792 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1792 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1792 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1792 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1792 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1792 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1792 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1792 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1792 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1792 [13] = 2'h3;
  ...
  initial begin
    ...
    \$auto$proc_rom.cc:150:do_switch$1796 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1796 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1796 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1796 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1796 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1796 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1796 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1796 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1796 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1796 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1796 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1796 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1796 [13] = 2'h3;
  ...
  initial begin
    ...
    \$auto$proc_rom.cc:150:do_switch$1800 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1800 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1800 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1800 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1800 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1800 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1800 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1800 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1800 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1800 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1800 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1800 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1800 [13] = 2'h3;
  ...
  \$paramod$9e8c4302fdfcc24736694111746d365d57f516fb\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f827863c339ebb1fb1fb291811b0ebef667f9801\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$2bcca55405449b4c3d8a8d2fbe7916b2f8b62dce\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$bfa99ffc75fd4e83b425603d651bc35c376fad90\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
...
module \$paramod$9e8c4302fdfcc24736694111746d365d57f516fb\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [135:0] arbiter_output;
  ...
  \$paramod$f27807803b5f4ab39c1874e360369a6b0b534515\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[1].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$bfa99ffc75fd4e83b425603d651bc35c376fad90\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module \$paramod$f27807803b5f4ab39c1874e360369a6b0b534515\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o, reg_ena_i
);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  ...
  \$paramod$3c84444d350ef0a80fa24c7eeb3fa4f9857a30c8\fpnew_fma_FC83A_5615B  \gen_num_lanes[1].active_lane.lane_instance.i_fma  (
    .aux_i(vectorial_op_i),
...
module \$paramod$f827863c339ebb1fb1fb291811b0ebef667f9801\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [135:0] arbiter_output;
  output busy_o;
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$9e191ce216debc757330a3313214d27bfc3b53ea\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
