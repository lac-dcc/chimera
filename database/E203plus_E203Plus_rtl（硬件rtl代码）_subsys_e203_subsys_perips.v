...
module e203_subsys_perips(
  ...
  .O13_BASE_ADDR       (32'h1005_0000),       
  .O13_BASE_REGION_LSB (14),
...
axi_ethernetlite_0 u_ethernetlite_0(
  .s_axi_aclk(clk),
  .s_axi_aresetn(rst_n), 
  .ip2intc_irpt(ip2intc_irpt), 
  .s_axi_awaddr(expl_axi_awaddr[12:0]),
  .s_axi_awlen({4'd0,expl_axi_awlen}),
  .s_axi_awsize(expl_axi_awsize),
  .s_axi_awburst(expl_axi_awburst),
  .s_axi_awcache(expl_axi_awcache),
  ...
  .s_axi_araddr(expl_axi_araddr[12:0]), 
  .s_axi_arlen({4'd0,expl_axi_arlen}), 
  .s_axi_arsize(expl_axi_arsize),
  .s_axi_arburst(expl_axi_arburst), 
  .s_axi_arcache(expl_axi_arcache), 
