...
module \$paramod$1dece989e55ee86c607da7401711d9c3522b6a2c\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o, reg_ena_i
);
  output busy_o;
  wire busy_o;
  input clk_i;
...
module \$paramod$1ec311d8bbb78d5b213c030ce705238a3ade6dbb\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:153$603.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:153$604.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$587.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$588.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$597.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$598.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$599.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$600.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$601.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$602.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$587.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$588.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$588.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$587.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:153$603.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:153$604.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$587.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$588.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$597.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$598.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$599.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$600.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$601.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:173$602.inp  = 3'hx;
endmodule

module \$paramod$36e009c14ce2abd199a26df33b6226e72b3ebe6e\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$4b918de69dcd218cd5910703264e623352cb07ac\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:335$515.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:335$516.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:355$513.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:355$514.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:335$515.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:335$516.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:355$513.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S1l2s.preprocessed.v:355$514.inp  = 2'hx;
endmodule

module \$paramod$6934f46ae92414b46e30257481816e496b3800e9\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module \$paramod$7ed1e8458b219305a583a00b6bfe30df88a0b057\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
);
  wire _00_;
  wire _01_;
  wire _02_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8198$212.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8198$55.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$109.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$144.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$179.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$228.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$244.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$260.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$276.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$74.$result ;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1375  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1375 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1375 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1375 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1375 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1375 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1375 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1375 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1375 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1375 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1375 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1375 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1375 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1375 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1375 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1375 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1375 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$179.$result  = \$auto$proc_rom.cc:150:do_switch$1375 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1379  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1379 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1379 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1379 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1379 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1379 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1379 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1379 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1379 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1379 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1379 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1379 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1379 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1379 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1379 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1379 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1379 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$144.$result  = \$auto$proc_rom.cc:150:do_switch$1379 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1383  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1383 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1383 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1383 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1383 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1383 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1383 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1383 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1383 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1383 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1383 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1383 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1383 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1383 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1383 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1383 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1383 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$109.$result  = \$auto$proc_rom.cc:150:do_switch$1383 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$74.$result  = \$auto$proc_rom.cc:150:do_switch$1387 [op_i];
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8198$55.$result  = \$auto$proc_rom.cc:150:do_switch$1391 [op_i];
  ...
  assign _06_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$74.$result ;
  assign _07_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$109.$result  == 2'h1;
  assign _08_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$144.$result  == 2'h2;
  assign _09_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$179.$result  == 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _44_ = opgrp_in_ready;
  assign _10_ = _44_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8198$55.$result  +: 1];
  ...
  \$paramod$ed21915ca89b207a8ff94c2c383f36215265c38d\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$36e009c14ce2abd199a26df33b6226e72b3ebe6e\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$6934f46ae92414b46e30257481816e496b3800e9\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$d47e1ec7728dface6e8d57a8a65f246aa4a4eb02\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8198$212.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$228.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$244.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$260.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l2s.preprocessed.v:8247$276.op  = 4'hx;
...
module \$paramod$d47e1ec7728dface6e8d57a8a65f246aa4a4eb02\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module \$paramod$ed21915ca89b207a8ff94c2c383f36215265c38d\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [39:0] arbiter_output;
  ...
  \$paramod$1dece989e55ee86c607da7401711d9c3522b6a2c\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$7ed1e8458b219305a583a00b6bfe30df88a0b057\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
