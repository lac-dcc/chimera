...
//4'b1000 - 4'b1001 are reserved
`define ALU_NE  4'b1010
`define ALU_LT  4'b1011
`define ALU_LE  4'b1100
`define ALU_GT  4'b1101
`define ALU_GE  4'b1110
...
//DM Operations
`define DM_align_word 2'b00
`define DM_align_half 2'b01
`define DM_align_byte 2'b10
