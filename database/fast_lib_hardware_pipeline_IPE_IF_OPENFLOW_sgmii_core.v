...
module sgmii_core (
	...
	defparam
		...
		altera_tse_pcs_pma_gige_inst.DEVICE_FAMILY = "STRATIXIV",
		...
		altera_tse_pcs_pma_gige_inst.STARTING_CHANNEL_NUMBER = 4;
endmodule
...
// Retrieval info: <MEGACORE title="Triple Speed Ethernet MegaCore Function"  version="12.0"  build="178"  iptb_version="1.3.0 Build 178"  format_version="120" >
...
// Retrieval info:      <PRIVATE name = "variation_name" value="sgmii_core"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "project_name" value="system"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_name" value="sgmii_core"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "variation_name" value="sgmii_core"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "instance_name" value="sgmii_core"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_name" value="sgmii_core"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="sgmii_core.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "output_name" value="sgmii_core"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "variation_name" value="sgmii_core"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "top_level_name" value="sgmii_core"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="sgmii_core_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
