...
module dhcp_client_m_axis_open_port_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [15:0] openPort_V_V_din,
    output wire        openPort_V_V_full_n,
    input  wire        openPort_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
wire [0:0]  fifo_empty_n;
wire [15:0] openPort_V_V_dout;
wire [0:0]  openPort_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [15:0] s_data;
...
//------------------------Instantiation------------------
// rs
dhcp_client_m_axis_open_port_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// openPort_V_V_fifo
dhcp_client_m_axis_open_port_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) openPort_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( openPort_V_V_empty_n ),
    .full_n     ( openPort_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( openPort_V_V_write ),
    .dout       ( openPort_V_V_dout ),
    .din        ( openPort_V_V_din )
);
...
assign s_data  = {openPort_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = openPort_V_V_empty_n;
...
module dhcp_client_m_axis_open_port_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module dhcp_client_m_axis_open_port_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
