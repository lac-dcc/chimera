...
// nv_ram_rws_128x60: synthesizable model core
...
module nv_ram_rws_128x60_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
output [59:0] mbist_Do_r0_int_net;
...
wire [59:0] Data_reg_r0;
// Data out bus for read port r0 for Output Mux
wire [59:0] r0_OutputMuxDataOut;
...
wire shiftDR_en;
reg [59:0] pre_muxed_Di_w0;
wire [59:0] pre_muxed_Di_w0_A, pre_muxed_Di_w0_B;
wire pre_muxed_Di_w0_S;
assign pre_muxed_Di_w0_S = !debug_mode_sync;
assign pre_muxed_Di_w0_A = Data_reg_r0[59:0];
assign pre_muxed_Di_w0_B = {{30{mbist_Di_w0}}};
always @(pre_muxed_Di_w0_S or pre_muxed_Di_w0_A or pre_muxed_Di_w0_B)
    case(pre_muxed_Di_w0_S) // synopsys infer_mux
      1'b0 : pre_muxed_Di_w0 = pre_muxed_Di_w0_A;
      1'b1 : pre_muxed_Di_w0 = pre_muxed_Di_w0_B;
      default : pre_muxed_Di_w0 = {60{`tick_x_or_0}};
    endcase
reg [59:0] muxed_Di_w0;
wire [59:0] muxed_Di_w0_A, muxed_Di_w0_B;
assign muxed_Di_w0_A = {di[59:0]};
...
always @(muxed_Di_w0_S or muxed_Di_w0_A or muxed_Di_w0_B)
    case(muxed_Di_w0_S) // synopsys infer_mux
      ...
      default : muxed_Di_w0 = {60{`tick_x_or_0}};
    endcase
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMPDP_128X60_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 127 Addressrange: [6:0]
// Data Bit range: [59:0] (60 bits)
...
// ----------------- begin Ram Cell RAMPDP_128X60_GL_M1_D2 -------------
// Write Port Stuff -----
...
wire [59:0] ramDataOut;
assign dout_0_0[59:0] = ramDataOut[59:0];
RAMPDP_128X60_GL_M1_D2 ram_Inst_128X60 (
                                          .CLK (gated_clk_core)
                                        , .WADR_6 (wa_0_0[6])
                                        , .WADR_5 (wa_0_0[5])
                                        , .WADR_4 (wa_0_0[4])
...
reg [59:0] ram_r0_OutputMuxDataOut;
//For bitEnd 59, only one piece RAMPDP_128X60_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_0[59:0] or Data_reg_r0[59:0] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[59:0] = (ram_bypass) ? Data_reg_r0[59:0]: dout_0_0;
end
assign r0_OutputMuxDataOut[59:0] = ram_r0_OutputMuxDataOut[59:0];
// verilint 17 on - Range (rather than full vector) in the sensitivity list
// --------------------- Output Mbist Interface logic -------------
// new mux in front of the data register
reg [60-1:0] muxed_Data_r0;
wire [60-1:0] muxed_Data_A, muxed_Data_B;
wire muxed_Data_S;
...
always @(muxed_Data_S or muxed_Data_A or muxed_Data_B)
  case(muxed_Data_S) // synopsys infer_mux
    ...
    default : muxed_Data_r0 = {60{`tick_x_or_0}};
  endcase
reg mbist_ce_r0_1p;
...
////MSB 59 LSB 0  and total rambit is 60 and  dsize is 60
wire Data_reg_SO_r0;
// verilint 110 off - Incompatible width
// verilint 630 off - Port connected to a NULL expression
// These are used for registering Ra in case of Latch arrays as well (i.e.
// used in functional path as well)
wire [59:0]data_regq;
assign Data_reg_r0[59:0] = data_regq[59:0] ;
// verilint 110 on - Incompatible width
// verilint 630 on - Port connected to a NULL expression
assign dout = r0_OutputMuxDataOut;
assign mbist_Do_r0_int_net = Data_reg_r0[60-1:0];
...
ScanShareSel_JTAG_reg_ext_cg #(60, 0, 0) testInst_Data_reg_r0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(muxed_Data_r0[59:0]), .Q(data_regq[59:0]),
