...
localparam [8*'h43-1:0] CONF_DESCR = {
...
task automatic test_usb
  (
   ...
   begin
      ...
      test = "GET_STATUS on inteface 1";
      test_setup_in(address, 8'h81, STD_REQ_GET_STATUS, 16'h0000, 16'h0001, 16'h0002,
                    {8'h00, 8'h00}, 'h02, PID_ACK, NO_ZLP);

      test = "GET_STATUS stall on not-existent inteface";
      test_setup_in(address, 8'h81, STD_REQ_GET_STATUS, 16'h0000, 16'h0002, 16'h0002,
                    {8'h00, 8'h00}, 'h02, PID_STALL, NO_ZLP);

      test = "GET_STATUS on OUT endpoint 1";
      test_setup_in(address, 8'h82, STD_REQ_GET_STATUS, 16'h0000, 16'h0001, 16'h0002,
                    {8'h00, 8'h00}, 'h02, PID_ACK, NO_ZLP);

      test = "GET_STATUS stall on not-existent endpoint";
      test_setup_in(address, 8'h82, STD_REQ_GET_STATUS, 16'h0000, 16'h0083, 16'h0002,
                    {8'h00, 8'h00}, 'h02, PID_STALL, NO_ZLP);
      ...
      test = "CLEAR_FEATURE on IN endpoint 1";
      test_setup_out(address, 8'h02, STD_REQ_CLEAR_FEATURE, 16'h0000, 16'h0081, 16'h0000,
                     8'd0, 'd0, PID_ACK);

      test = "CLEAR_FEATURE stall on not-existent endpoint";
      test_setup_out(address, 8'h02, STD_REQ_CLEAR_FEATURE, 16'h0000, 16'h0002, 16'h0000,
                     8'd0, 'd0, PID_STALL);
