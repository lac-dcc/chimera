...
module edb_top (
    ...
    output vio0_on,
    output vio0_off,
    output [8:0] vio0_hres,
    output [9:0] vio0_vres,
    output [8:0] vio0_hpix,
    output vio0_en,
    output vio0_mode,
    output vio0_we,
    output vio0_re,
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 1 ),
        .NUM_PROBE_OUT          ( 13 ),
        .UUID           ( 128'h2167cbd3d9c9417d9a53109617738661 ),
        .PROBE_IN0_WIDTH        ( 4 ),
        .PROBE_OUT0_WIDTH       ( 1 ),
        .PROBE_OUT1_WIDTH       ( 1 ),
        .PROBE_OUT2_WIDTH       ( 9 ),
        ...
        .probe_out0         ( vio0_on ),
        .probe_out1         ( vio0_off ),
        .probe_out2         ( vio0_hres ),
        .probe_out3         ( vio0_vres ),
        .probe_out4         ( vio0_hpix ),
        .probe_out5         ( vio0_en ),
        .probe_out6         ( vio0_mode ),
        .probe_out7         ( vio0_we ),
        .probe_out8         ( vio0_re ),
        .probe_out9         ( vio0_rgb ),
        .probe_out10            ( vio0_next ),
        .probe_out11            ( vio0_back ),
        .probe_out12            ( vio0_interrupt ),
        .probe_out13            (  ),
        .probe_out14            (  ),
        .probe_out15            (  ),
        .probe_out16            (  ),
    ...
    edb_la_top #(
        ...
        .TRIGOUT_EN         ( 0 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hbc039df01aca4bb199b3be027446ac33 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
