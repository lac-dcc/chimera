...
// ----- Blif Benchmark input clk is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[35] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[35] = clk[0];

// ----- Blif Benchmark input rst is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[92] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[92] = rst[0];

// ----- Blif Benchmark output out_q_0_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[78] -----
	assign out_q_0__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[78];

// ----- Blif Benchmark output out_q_1_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[93] -----
	assign out_q_1__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[93];

// ----- Blif Benchmark output out_q_2_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[75] -----
	assign out_q_2__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[75];

// ----- Blif Benchmark output out_q_3_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[90] -----
	assign out_q_3__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[90];

// ----- Blif Benchmark output out_q_4_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[91] -----
	assign out_q_4__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[91];

// ----- Blif Benchmark output out_q_5_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[94] -----
	assign out_q_5__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[94];

// ----- Blif Benchmark output out_q_6_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[77] -----
	assign out_q_6__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[77];

// ----- Blif Benchmark output out_q_7_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[64] -----
	assign out_q_7__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[64];
...
// ----- Reference Benchmark Instanication -------
	counter REF_DUT(
		.clk(clk),
		.rst(rst),
		.q({out_q_7__benchmark, out_q_6__benchmark,out_q_5__benchmark,out_q_4__benchmark,out_q_3__benchmark,out_q_2__benchmark,out_q_1__benchmark,out_q_0__benchmark})
    );
