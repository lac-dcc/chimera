...
localparam width1 = 1 << (($clog2(width)/2) + ($clog2(width)%2));
localparam select_width1 = $clog2(width1);
 
// 'width0' is the the width of the second stage arbiter,
// which is the number of arbiters in the first stage.
localparam width0 = width/width1;
localparam select_width0 = $clog2(width0);
