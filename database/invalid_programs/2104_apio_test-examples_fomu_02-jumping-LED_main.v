...
module main #(
 ...
 localparam p1 = v98ea37;
 localparam p5 = v0f02ae;
 localparam p8 = v315560;
 localparam p17 = v4b43d0;
 wire w0;
 wire [0:2] w2;
 wire [0:7] w3;
 wire [0:7] w4;
...
//-- start
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- start: Start signal: It goes from 1 to 0 when the system clock starts. 1 cycle pulse witch
//---------------------------------------------------
//---- Top entity
module v56885a #(
 parameter v187a47 = 1
