...
// Debug Module's data0 register is mapped into the core's CSR space; as a
// special case (the DM is co-designed) the wdata comes directly from the
// unbypassed regfile output, reducing logic depth on core -> DM path.
