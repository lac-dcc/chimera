...
// ----- Blif Benchmark input bin_0_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[39] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[39] = bin_0_[0];

// ----- Blif Benchmark input bin_1_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[48] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[48] = bin_1_[0];

// ----- Blif Benchmark input bin_2_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[51] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[51] = bin_2_[0];

// ----- Blif Benchmark input bin_3_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[49] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[49] = bin_3_[0];

// ----- Blif Benchmark input bin_4_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[60] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[60] = bin_4_[0];

// ----- Blif Benchmark input bin_5_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[63] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[63] = bin_5_[0];

// ----- Blif Benchmark input bin_6_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[53] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[53] = bin_6_[0];

// ----- Blif Benchmark input bin_7_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_IN[69] -----
	assign gfpga_pad_EMBEDDED_IO_HD_SOC_IN[69] = bin_7_[0];

// ----- Blif Benchmark output out_bcd_0_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[38] -----
	assign out_bcd_0__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[38];

// ----- Blif Benchmark output out_bcd_1_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[47] -----
	assign out_bcd_1__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[47];

// ----- Blif Benchmark output out_bcd_2_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[45] -----
	assign out_bcd_2__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[45];

// ----- Blif Benchmark output out_bcd_3_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[44] -----
	assign out_bcd_3__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[44];

// ----- Blif Benchmark output out_bcd_4_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[46] -----
	assign out_bcd_4__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[46];

// ----- Blif Benchmark output out_bcd_5_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[67] -----
	assign out_bcd_5__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[67];

// ----- Blif Benchmark output out_bcd_6_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[89] -----
	assign out_bcd_6__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[89];

// ----- Blif Benchmark output out_bcd_7_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[62] -----
	assign out_bcd_7__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[62];

// ----- Blif Benchmark output out_bcd_8_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[64] -----
	assign out_bcd_8__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[64];

// ----- Blif Benchmark output out_bcd_9_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[66] -----
	assign out_bcd_9__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[66];

// ----- Blif Benchmark output out_bcd_10_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[13] -----
	assign out_bcd_10__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[13];

// ----- Blif Benchmark output out_bcd_11_ is mapped to FPGA IOPAD gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[78] -----
	assign out_bcd_11__fpga[0] = gfpga_pad_EMBEDDED_IO_HD_SOC_OUT[78];
...
// ----- Reference Benchmark Instanication -------
	bin2bcd REF_DUT(
		.bin({bin_7_,bin_6_,bin_5_,bin_4_,bin_3_,bin_2_,bin_1_,bin_0_}),
		.bcd({out_bcd_11__benchmark,out_bcd_10__benchmark,out_bcd_9__benchmark,out_bcd_8__benchmark,out_bcd_7__benchmark,out_bcd_6__benchmark,out_bcd_5__benchmark,out_bcd_4__benchmark,out_bcd_3__benchmark,out_bcd_2__benchmark,out_bcd_1__benchmark,out_bcd_0__benchmark})
    );
