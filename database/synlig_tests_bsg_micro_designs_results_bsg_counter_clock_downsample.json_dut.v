...
module \$paramod$f6686a8eb3af9dbeeb5b0f41742d50d4c7b332ad\bsg_strobe (clk_i, reset_r_i, init_val_r_i, strobe_r_o);
...
module bsg_counter_clock_downsample(clk_i, reset_i, val_i, clk_r_o);
  ...
  always @(posedge clk_i)
    ...
    else if (strobe_r) clk_r_o <= _0_;
  (* module_not_derived = 32'd1 *)
  
  \$paramod$f6686a8eb3af9dbeeb5b0f41742d50d4c7b332ad\bsg_strobe  strobe (
    .clk_i(clk_i),
    .init_val_r_i(val_i),
    .reset_r_i(reset_i),
    .strobe_r_o(strobe_r)
