...
// jtkiwi_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
parameter BRAM_OFFSET = `BRAM_OFFSET;
...
wire [ 7:0] sub_data;
wire        sub_cs, sub_ok;
wire [16:0] audiocpu_addr;
wire [ 7:0] audiocpu_data;
wire        audiocpu_cs, audiocpu_ok;
wire [15:0] pcm_addr;
wire [ 7:0] pcm_data;
wire        pcm_cs, pcm_ok;
wire [20:2] scr_addr;
...
`endif
    // Audio channels
    .fm     ( fm      ),.psg     ( psg      ),.pcm     ( pcm      ),
    
    .snd_en         ( snd_en        ),
    .dummy12_cen    ( dummy12_cen    ), 
    .cen6    ( cen6    ), 
    .cen3    ( cen3    ), 
    .cen1p5    ( cen1p5    ), 
...
`endif
    ...
    .slot0_addr  ( audiocpu_addr  ),
    .slot0_dout  ( audiocpu_data  ),
    .slot0_cs    ( audiocpu_cs    ),
    .slot0_ok    ( audiocpu_ok    ),
...
jtframe_gated_cen #(.W(4),.NUM(1),.DEN(4),.MFREQ(48000)) u_cen0_clk(
    .rst    ( rst          ),
    .clk    ( clk ),
    .busy   ( (main_cs & ~main_ok) | (sub_cs & ~sub_ok)    ),
    .cen    ( { cen1p5, cen3, cen6, dummy12_cen } ),
    .fave   (              ),
    .fworst (              )
); /* verilator tracing_off */
