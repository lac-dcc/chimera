...
//-- UINT8-2bits
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- UINT8-2bits:  Extend a 2-bits unsigned integer to 8-bits 
//---------------------------------------------------
//---- Top entity
module v2ae6c6 (
 input [5:0] v164ff1,
...
//-- Bus8-Join-6-2
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- Bus8-Join-6-2: Join the two buses into an 8-bits Bus
//---------------------------------------------------
...
//-- 6-bits-gen-constant
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- Generic: 6-bits generic constant (0-63)
//---------------------------------------------------
...
module v7caf1c #(
 ...
 localparam p6 = v17ea21;
 localparam p7 = v803182;
 localparam p8 = v803182;
 localparam p9 = v17ea21;
 wire [0:1] w0;
 wire [0:1] w1;
 wire w2;
 wire w3;
...
//-- Buttonx2
//-- - - - - - - - - - - - - - - - - - - - - - - - --
//-- Configurable buttons (pull-up on/off. Not on/off)
//---------------------------------------------------
//---- Top entity
module vfc9dac (
 input [1:0] v8b19dd,
