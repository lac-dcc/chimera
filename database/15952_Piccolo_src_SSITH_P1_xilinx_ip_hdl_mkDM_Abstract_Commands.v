...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [31 : 0] virt_rg_abstractcs__h524, virt_rg_command__h588;
  wire [15 : 0] regno__h1893;
  wire [12 : 0] x__h1075;
  wire rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d35,
       rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d46,
       rg_abstractcs_cmderr_0_EQ_0_4_AND_write_dm_add_ETC___d105,
       rg_abstractcs_cmderr_0_EQ_0_4_AND_write_dm_add_ETC___d137,
       ...
       write_dm_addr_EQ_0x16_7_AND_rg_abstractcs_busy_ETC___d79,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d112,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d121,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d130,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d184;
  ...
  always@(av_read_dm_addr or
	  rg_data0 or virt_rg_abstractcs__h524 or virt_rg_command__h588)
  begin
    case (av_read_dm_addr)
      7'h16: av_read = virt_rg_abstractcs__h524;
      7'h17: av_read = virt_rg_command__h588;
  ...
  FIFO2 #(.width(32'd45), .guarded(32'd1)) f_hart0_csr_reqs(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO2 #(.width(32'd33), .guarded(32'd1)) f_hart0_csr_rsps(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO2 #(.width(32'd38), .guarded(32'd1)) f_hart0_gpr_reqs(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO2 #(.width(32'd33), .guarded(32'd1)) f_hart0_gpr_rsps(.RST(RST_N),
							    .CLK(CLK),
  ...
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_1 =
	     { 1'd1, x__h1075[4:0], rg_data0 } ;
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_2 =
	     { 1'd0, x__h1075[4:0], 32'hAAAAAAAA } ;
  ...
  // remaining internal signals
  assign regno__h1893 = { 3'd0, rg_command_access_reg_regno } ;
  ...
  assign rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d46 =
	     ...
	     !rg_command_access_reg_regno_ULT_0x1000___d31 &&
	     rg_command_access_reg_regno_ULE_0x101F___d33 ;
  assign rg_abstractcs_cmderr_0_EQ_0_4_AND_write_dm_add_ETC___d105 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     write_dm_word[24] ;
  assign rg_abstractcs_cmderr_0_EQ_0_4_AND_write_dm_add_ETC___d137 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
  ...
  assign virt_rg_abstractcs__h524 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd1 } ;
  assign virt_rg_command__h588 =
	     { 15'd17, rg_command_access_reg_write, regno__h1893 } ;
  assign write_dm_addr_EQ_0x16_7_AND_rg_abstractcs_busy_ETC___d79 =
	     write_dm_addr == 7'h16 &&
	     (rg_abstractcs_busy || write_dm_word[10:8] != 3'd0) ||
	     write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd0 &&
	     write_dm_addr != 7'h04 ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d112 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd2 &&
	     write_dm_word[18] ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d121 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd2 &&
	     !write_dm_word[18] &&
	     write_dm_word[17] ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d130 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd2 &&
	     !write_dm_word[18] &&
	     !write_dm_word[17] ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d184 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] != 3'd2 &&
  ...
  assign x__h1075 = rg_command_access_reg_regno - 13'h1000 ;
  ...
  begin
    ...
    v__h3295 = v__h3301 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 &&
	  rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr != 7'h17 &&
	  write_dm_addr != 7'h04)
	$write("%0d: DM_Abstract_Commands.write: [", v__h3295);
    if (RST_N != `BSV_RESET_VALUE)
