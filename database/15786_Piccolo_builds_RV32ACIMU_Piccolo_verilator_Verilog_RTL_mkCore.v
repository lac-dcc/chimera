...
module mkCore(CLK,
  ...
  wire plic_RDY_server_reset_request_put_AND_cpu_RDY__ETC___d8;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h4206);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h4422 = v__h4428 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h4422);
  end
  // synopsys translate_on
endmodule  // mkCore
