...
//input and output port declaration
	...
	cyclonev_pll_reconfig_encrypted cyclonev_pll_reconfig_encrypted_inst
	(
		.addr(addr),
        .atpgmode ( atpgmode ),
		.byteen(byteen),
...
module cyclonev_serdes_dpa (
		...
		input  [ 0:0 ] ioout,
		input  [ 6:0 ] txdata,
		input  [ 0:0 ] txdpaclkin,
		input  [ 0:0 ] serialfbk,
		input  [ 0:0 ] postdpaserialdatain,
		input  [ 0:0 ] serialdatain,
		
		output [ 0:0 ] txlocalfclk,
		output [ 0:0 ] txlocallden,
		output [ 0:0 ] lvdsout,
		output [ 0:0 ] rxlocalfclk,
		output [ 0:0 ] rxlocallden,
		output [ 0:0 ] divfwdclk,
		output [ 0:0 ] ulvdsin,
		output [ 0:0 ] lock,
		output [ 0:0 ] bslipmax,
		output [ 9:0 ] rxdata,
		output [ 0:0 ] observableout,
		output [ 0:0 ] dpaclkout,
		output [ 0:0 ] serialfdbkout,
		output [ 0:0 ] postdpaserialdataout,
		output [ 0:0 ] serialdataout	
);

		parameter align_to_rising_edge_only = "false";
		parameter bypass_dpa_logic = "false";
		parameter dpa_clock_output_phase_shift = 0;
		parameter dpa_debug = "false";
		parameter dpa_initial_phase_value = 0;
		parameter dpa_test_select_mode = "bslipmax";
		parameter enable_divfwdclk_test_mode = "false";
		parameter enable_dpa = "true";
		parameter enable_dpa_align_to_rising_edge_only = "false";
		parameter enable_dpa_initial_phase_selection = "false";
		parameter enable_dpa_rx_data_wrap_back = "false";
		parameter enable_dpaclk_to_lvdsout = "false";
		parameter enable_post_cdr_serial_loopback = "false";
		parameter enable_serial_fdbk_loopback = "false";
		parameter enable_serial_input_loopback = "false";
		...
		parameter rx_data_width = 4;
		parameter rx_fclk_delay_engineering_bits = 0;
		parameter rx_input_path_delay_engineering_bits = 0;
		parameter rx_loaden_delay_engineering_bits = 0;
		parameter serdes_dpa_mode = "receiver";
		parameter tx_data_width = 10;
		parameter tx_fclk_delay_engineering_bits = 0;
		parameter tx_loaden_delay_engineering_bits = 0;
		parameter tx_output_path_delay_engineering_bits = 0;
		parameter use_falling_clock_edge = "false";
		parameter x_on_bitslip = "true";
		
	cyclonev_serdes_dpa_encrypted inst(
			.txfclk(txfclk),
			.txloaden(txloaden),
			.ulvdsout(ulvdsout),
			.rxfclk(rxfclk),
		...
		defparam inst.bypass_dpa_logic = bypass_dpa_logic;
		...
		defparam inst.dpa_test_select_mode = dpa_test_select_mode;
		defparam inst.enable_divfwdclk_test_mode = enable_divfwdclk_test_mode;
		...
		defparam inst.enable_dpa_rx_data_wrap_back = enable_dpa_rx_data_wrap_back;
		defparam inst.enable_dpaclk_to_lvdsout = enable_dpaclk_to_lvdsout;
		defparam inst.enable_post_cdr_serial_loopback = enable_post_cdr_serial_loopback;
		defparam inst.enable_serial_fdbk_loopback = enable_serial_fdbk_loopback;
		defparam inst.enable_serial_input_loopback = enable_serial_input_loopback;
		...
		defparam inst.rx_data_width = rx_data_width;
		defparam inst.rx_fclk_delay_engineering_bits = rx_fclk_delay_engineering_bits;
		defparam inst.rx_input_path_delay_engineering_bits = rx_input_path_delay_engineering_bits;
		defparam inst.rx_loaden_delay_engineering_bits = rx_loaden_delay_engineering_bits;
		defparam inst.serdes_dpa_mode = serdes_dpa_mode;
		defparam inst.tx_data_width = tx_data_width;
		defparam inst.tx_fclk_delay_engineering_bits = tx_fclk_delay_engineering_bits;
		defparam inst.tx_loaden_delay_engineering_bits = tx_loaden_delay_engineering_bits;
...
parameter hphy_ac_rom_init_file = "ac_ROM.hex";
parameter hphy_inst_rom_init_file = "inst_ROM.hex";
...
parameter hphy_calib_vfifo_offset = 0;
parameter hphy_calib_lfifo_offset = 0;
...
defparam inst.hphy_ac_rom_init_file = hphy_ac_rom_init_file;
defparam inst.hphy_inst_rom_init_file = hphy_inst_rom_init_file;
defparam inst.hphy_calib_vfifo_offset = hphy_calib_vfifo_offset;
defparam inst.hphy_calib_lfifo_offset = hphy_calib_lfifo_offset;
