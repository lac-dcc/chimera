...
// jtrastan_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
parameter RAM_OFFSET = 22'h10_0000;
parameter VRAM_OFFSET = 22'h11_0000;
...
wire [15:2] scr0ram_addr;
wire [31:0] scr0ram_data;
wire        scr0ram_cs, scr0ram_ok;
wire [15:2] scr1ram_addr;
wire [31:0] scr1ram_data;
wire        scr1ram_cs, scr1ram_ok;
wire [15:0] snd_addr;
wire [ 7:0] snd_data;
wire        snd_cs, snd_ok;
wire [15:0] pcm_addr;
wire [ 7:0] pcm_data;
wire        pcm_cs, pcm_ok;
wire [19:2] scr0rom_addr;
wire [31:0] scr0rom_data;
wire        scr0rom_cs, scr0rom_ok;
wire [19:2] scr1rom_addr;
wire [31:0] scr1rom_data;
wire        scr1rom_cs, scr1rom_ok;
wire [19:2] orom_addr;
wire [31:0] orom_data;
wire        orom_cs, orom_ok;
wire        prom_we, header;
...
`endif
    ...
    .slot0_addr  ( { scr0rom_addr, 1'b0 } ),
    .slot0_dout  ( scr0rom_data  ),
    .slot0_cs    ( scr0rom_cs    ),
    .slot0_ok    ( scr0rom_ok    ),
    
    .slot1_addr  ( { scr1rom_addr, 1'b0 } ),
...
assign game_led = 0;
wire ncs;
jtframe_frac_cen #(.WC(16)) u_cen192(
    .clk    ( clk       ),
    .n      ( 86 ),
    .m      ( 23915 ),
