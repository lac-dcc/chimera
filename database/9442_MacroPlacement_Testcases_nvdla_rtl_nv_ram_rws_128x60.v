...
// This wrapper consists of : 1 Ram cells: RAMPDP_128X60_GL_M1_D2 ;
...
nv_ram_rws_128x60_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rws_128x60 (
...
// synopsys dc_tcl_script_end
`ifndef SYNTHESIS
task arrangement (output integer arrangment_string[59:0]);
  begin
...
reg [59:0] shadow_mem [127:0];
`ifdef NV_RAM_EXPAND_ARRAY
wire [59:0] shadow_mem_row0 = shadow_mem[0];
wire [59:0] shadow_mem_row1 = shadow_mem[1];
wire [59:0] shadow_mem_row2 = shadow_mem[2];
wire [59:0] shadow_mem_row3 = shadow_mem[3];
wire [59:0] shadow_mem_row4 = shadow_mem[4];
wire [59:0] shadow_mem_row5 = shadow_mem[5];
wire [59:0] shadow_mem_row6 = shadow_mem[6];
wire [59:0] shadow_mem_row7 = shadow_mem[7];
wire [59:0] shadow_mem_row8 = shadow_mem[8];
wire [59:0] shadow_mem_row9 = shadow_mem[9];
wire [59:0] shadow_mem_row10 = shadow_mem[10];
wire [59:0] shadow_mem_row11 = shadow_mem[11];
wire [59:0] shadow_mem_row12 = shadow_mem[12];
wire [59:0] shadow_mem_row13 = shadow_mem[13];
wire [59:0] shadow_mem_row14 = shadow_mem[14];
wire [59:0] shadow_mem_row15 = shadow_mem[15];
wire [59:0] shadow_mem_row16 = shadow_mem[16];
wire [59:0] shadow_mem_row17 = shadow_mem[17];
wire [59:0] shadow_mem_row18 = shadow_mem[18];
wire [59:0] shadow_mem_row19 = shadow_mem[19];
wire [59:0] shadow_mem_row20 = shadow_mem[20];
wire [59:0] shadow_mem_row21 = shadow_mem[21];
wire [59:0] shadow_mem_row22 = shadow_mem[22];
wire [59:0] shadow_mem_row23 = shadow_mem[23];
wire [59:0] shadow_mem_row24 = shadow_mem[24];
wire [59:0] shadow_mem_row25 = shadow_mem[25];
wire [59:0] shadow_mem_row26 = shadow_mem[26];
wire [59:0] shadow_mem_row27 = shadow_mem[27];
wire [59:0] shadow_mem_row28 = shadow_mem[28];
wire [59:0] shadow_mem_row29 = shadow_mem[29];
wire [59:0] shadow_mem_row30 = shadow_mem[30];
wire [59:0] shadow_mem_row31 = shadow_mem[31];
wire [59:0] shadow_mem_row32 = shadow_mem[32];
wire [59:0] shadow_mem_row33 = shadow_mem[33];
wire [59:0] shadow_mem_row34 = shadow_mem[34];
wire [59:0] shadow_mem_row35 = shadow_mem[35];
wire [59:0] shadow_mem_row36 = shadow_mem[36];
wire [59:0] shadow_mem_row37 = shadow_mem[37];
wire [59:0] shadow_mem_row38 = shadow_mem[38];
wire [59:0] shadow_mem_row39 = shadow_mem[39];
wire [59:0] shadow_mem_row40 = shadow_mem[40];
wire [59:0] shadow_mem_row41 = shadow_mem[41];
wire [59:0] shadow_mem_row42 = shadow_mem[42];
wire [59:0] shadow_mem_row43 = shadow_mem[43];
wire [59:0] shadow_mem_row44 = shadow_mem[44];
wire [59:0] shadow_mem_row45 = shadow_mem[45];
wire [59:0] shadow_mem_row46 = shadow_mem[46];
wire [59:0] shadow_mem_row47 = shadow_mem[47];
wire [59:0] shadow_mem_row48 = shadow_mem[48];
wire [59:0] shadow_mem_row49 = shadow_mem[49];
wire [59:0] shadow_mem_row50 = shadow_mem[50];
wire [59:0] shadow_mem_row51 = shadow_mem[51];
wire [59:0] shadow_mem_row52 = shadow_mem[52];
wire [59:0] shadow_mem_row53 = shadow_mem[53];
wire [59:0] shadow_mem_row54 = shadow_mem[54];
wire [59:0] shadow_mem_row55 = shadow_mem[55];
wire [59:0] shadow_mem_row56 = shadow_mem[56];
wire [59:0] shadow_mem_row57 = shadow_mem[57];
wire [59:0] shadow_mem_row58 = shadow_mem[58];
wire [59:0] shadow_mem_row59 = shadow_mem[59];
wire [59:0] shadow_mem_row60 = shadow_mem[60];
wire [59:0] shadow_mem_row61 = shadow_mem[61];
wire [59:0] shadow_mem_row62 = shadow_mem[62];
wire [59:0] shadow_mem_row63 = shadow_mem[63];
wire [59:0] shadow_mem_row64 = shadow_mem[64];
wire [59:0] shadow_mem_row65 = shadow_mem[65];
wire [59:0] shadow_mem_row66 = shadow_mem[66];
wire [59:0] shadow_mem_row67 = shadow_mem[67];
wire [59:0] shadow_mem_row68 = shadow_mem[68];
wire [59:0] shadow_mem_row69 = shadow_mem[69];
wire [59:0] shadow_mem_row70 = shadow_mem[70];
wire [59:0] shadow_mem_row71 = shadow_mem[71];
wire [59:0] shadow_mem_row72 = shadow_mem[72];
wire [59:0] shadow_mem_row73 = shadow_mem[73];
wire [59:0] shadow_mem_row74 = shadow_mem[74];
wire [59:0] shadow_mem_row75 = shadow_mem[75];
wire [59:0] shadow_mem_row76 = shadow_mem[76];
wire [59:0] shadow_mem_row77 = shadow_mem[77];
wire [59:0] shadow_mem_row78 = shadow_mem[78];
wire [59:0] shadow_mem_row79 = shadow_mem[79];
wire [59:0] shadow_mem_row80 = shadow_mem[80];
wire [59:0] shadow_mem_row81 = shadow_mem[81];
wire [59:0] shadow_mem_row82 = shadow_mem[82];
wire [59:0] shadow_mem_row83 = shadow_mem[83];
wire [59:0] shadow_mem_row84 = shadow_mem[84];
wire [59:0] shadow_mem_row85 = shadow_mem[85];
wire [59:0] shadow_mem_row86 = shadow_mem[86];
wire [59:0] shadow_mem_row87 = shadow_mem[87];
wire [59:0] shadow_mem_row88 = shadow_mem[88];
wire [59:0] shadow_mem_row89 = shadow_mem[89];
wire [59:0] shadow_mem_row90 = shadow_mem[90];
wire [59:0] shadow_mem_row91 = shadow_mem[91];
wire [59:0] shadow_mem_row92 = shadow_mem[92];
wire [59:0] shadow_mem_row93 = shadow_mem[93];
wire [59:0] shadow_mem_row94 = shadow_mem[94];
wire [59:0] shadow_mem_row95 = shadow_mem[95];
wire [59:0] shadow_mem_row96 = shadow_mem[96];
wire [59:0] shadow_mem_row97 = shadow_mem[97];
wire [59:0] shadow_mem_row98 = shadow_mem[98];
wire [59:0] shadow_mem_row99 = shadow_mem[99];
wire [59:0] shadow_mem_row100 = shadow_mem[100];
wire [59:0] shadow_mem_row101 = shadow_mem[101];
wire [59:0] shadow_mem_row102 = shadow_mem[102];
wire [59:0] shadow_mem_row103 = shadow_mem[103];
wire [59:0] shadow_mem_row104 = shadow_mem[104];
wire [59:0] shadow_mem_row105 = shadow_mem[105];
wire [59:0] shadow_mem_row106 = shadow_mem[106];
wire [59:0] shadow_mem_row107 = shadow_mem[107];
wire [59:0] shadow_mem_row108 = shadow_mem[108];
wire [59:0] shadow_mem_row109 = shadow_mem[109];
wire [59:0] shadow_mem_row110 = shadow_mem[110];
wire [59:0] shadow_mem_row111 = shadow_mem[111];
wire [59:0] shadow_mem_row112 = shadow_mem[112];
wire [59:0] shadow_mem_row113 = shadow_mem[113];
wire [59:0] shadow_mem_row114 = shadow_mem[114];
wire [59:0] shadow_mem_row115 = shadow_mem[115];
wire [59:0] shadow_mem_row116 = shadow_mem[116];
wire [59:0] shadow_mem_row117 = shadow_mem[117];
wire [59:0] shadow_mem_row118 = shadow_mem[118];
wire [59:0] shadow_mem_row119 = shadow_mem[119];
wire [59:0] shadow_mem_row120 = shadow_mem[120];
wire [59:0] shadow_mem_row121 = shadow_mem[121];
wire [59:0] shadow_mem_row122 = shadow_mem[122];
wire [59:0] shadow_mem_row123 = shadow_mem[123];
wire [59:0] shadow_mem_row124 = shadow_mem[124];
wire [59:0] shadow_mem_row125 = shadow_mem[125];
wire [59:0] shadow_mem_row126 = shadow_mem[126];
wire [59:0] shadow_mem_row127 = shadow_mem[127];
`endif
task init_mem_val;
  input [6:0] row;
  input [59:0] data;
...
integer row;
begin
// initializing RAMPDP_128X60_GL_M1_D2
for (row = 0; row < 128; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rws_128x60.ram_Inst_128X60.mem_write(row - 0, shadow_mem[row][59:0]);
shadow_written = 'b0;
end
endtask
`endif
...
`ifndef MEM_REG_NAME
 `define MEM_REG_NAME MX.mem
`endif
function [59:0] probe_mem_val;
input [6:0] row;
reg [59:0] data;
begin
// probing RAMPDP_128X60_GL_M1_D2
 if (row >= 0 && row < 128) data[59:0] = r_nv_ram_rws_128x60.ram_Inst_128X60.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
...
integer bitnum;
begin
  random_num = rflip.rollpli(0, 7680);
  row = random_num / 60;
  bitnum = random_num % 60;
