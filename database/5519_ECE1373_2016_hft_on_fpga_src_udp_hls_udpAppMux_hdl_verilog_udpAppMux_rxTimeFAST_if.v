...
module udpAppMux_rxTimeFAST_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
    ...
    // User signals
    output wire [63:0] rxTimeFAST_V_V_dout,
    output wire        rxTimeFAST_V_V_empty_n,
    input  wire        rxTimeFAST_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [63:0] rxTimeFAST_V_V_din;
wire [0:0]  rxTimeFAST_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [63:0] s_data;
...
//------------------------Instantiation------------------
// rs
udpAppMux_rxTimeFAST_reg_slice #(
    .N       ( 64 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// rxTimeFAST_V_V_fifo
udpAppMux_rxTimeFAST_fifo #(
    .DATA_BITS  ( 64 ),
    .DEPTH_BITS ( 4 )
) rxTimeFAST_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( rxTimeFAST_V_V_empty_n ),
    .full_n     ( rxTimeFAST_V_V_full_n ),
    .read       ( rxTimeFAST_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( rxTimeFAST_V_V_dout ),
    .din        ( rxTimeFAST_V_V_din )
);
...
assign s_data  = {TDATA[63:0]};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_write         = fifo_full_n & m_valid;
assign rxTimeFAST_V_V_din = m_data[63:0];
assign fifo_full_n        = rxTimeFAST_V_V_full_n;
...
module udpAppMux_rxTimeFAST_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module udpAppMux_rxTimeFAST_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
