...
module crc_check (
	...
	crc_check_altcrc	crc_check_altcrc_inst(
		.clk(clk),
		.data(data),
		.datavalid(datavalid),
		.empty(empty),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="crc_check_altcrc" >
...
// Retrieval info:      <PRIVATE name = "filename" value="crc_check_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "filename" value="crc_check.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: crc_check.v, crc_check_altcrc.v;
// IPFS_FILES: crc_check.vo;
// =========================================================
