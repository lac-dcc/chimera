...
module ad9238_sample(
	...
	output reg[7:0]                adc_data_narrow,
	output reg[7:0]                adc_data_narrow_d0
);
...
reg [11:0]  adc_data_reve;
reg [12:0] adc_data_offset;
...
begin
	if(rst == 1'b1)
		...
		adc_data_narrow <= adc_data_offset[11:4];   //数据宽度转换到8bit（为了跟其它8位的AD模块程序兼容）
end
