...
// Deactivate the following LEDA rules for cycloneiiils_io_atom.v
...
wire bdataout;                          
cycloneiiils_routing_wire wire_delay (    
.datain(bdataout),                      
.dataout(dataout)                       
);                                      
...
// Deactivate the following LEDA rules for cycloneiiils_pseudo_diff_atom.v
// G_521_3B: Use uppercase letters for all parameter names
// leda G_521_3_B off
