...
//synthesis_resources = arriaii_ddio_in 8 arriaii_ddio_oe 2 arriaii_ddio_out 10 arriaii_dqs_delay_chain 1 arriaii_dqs_enable 1 arriaii_dqs_enable_ctrl 1 reg 9 
...
module  ddr2_phy_alt_mem_phy_dq_dqs
	( 
	bidir_dq_areset,
...
`endif
	...
	arriaii_ddio_oe   dqs_0_oe_ddio_oe_inst
	( 
	.clk(dqs_output_reg_clk),
	.dataout(wire_dqs_0_oe_ddio_oe_inst_dataout),
	.oe((~ dqs_oe_in[0]))
	`ifndef FORMAL_VERIFICATION
	// synopsys translate_off
	`endif
	...
	defparam
		dqs_0_oe_ddio_oe_inst.async_mode = "none",
		dqs_0_oe_ddio_oe_inst.sync_mode = "none",
		dqs_0_oe_ddio_oe_inst.lpm_type = "arriaii_ddio_oe";
	arriaii_ddio_oe   dqsn_0_oe_ddio_oe_inst
	( 
	.clk(dqs_output_reg_clk),
	.dataout(wire_dqsn_0_oe_ddio_oe_inst_dataout),
	.oe((~ dqsn_oe_in[0]))
	`ifndef FORMAL_VERIFICATION
	// synopsys translate_off
	`endif
	...
	defparam
		dqsn_0_oe_ddio_oe_inst.async_mode = "none",
		dqsn_0_oe_ddio_oe_inst.sync_mode = "none",
		dqsn_0_oe_ddio_oe_inst.lpm_type = "arriaii_ddio_oe";
	...
	defparam
		dqs_0_delay_chain_inst.delay_buffer_mode = "low",
		dqs_0_delay_chain_inst.dqs_ctrl_latches_enable = "false",
		dqs_0_delay_chain_inst.dqs_input_frequency = "200.0 MHz",
