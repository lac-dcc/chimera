...
module udpAppMux_txTimeFAST_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [63:0] txTimeFAST_V_V_din,
    output wire        txTimeFAST_V_V_full_n,
    input  wire        txTimeFAST_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
wire [0:0]  fifo_empty_n;
wire [63:0] txTimeFAST_V_V_dout;
wire [0:0]  txTimeFAST_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [63:0] s_data;
...
//------------------------Instantiation------------------
// rs
udpAppMux_txTimeFAST_reg_slice #(
    .N       ( 64 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// txTimeFAST_V_V_fifo
udpAppMux_txTimeFAST_fifo #(
    .DATA_BITS  ( 64 ),
    .DEPTH_BITS ( 4 )
) txTimeFAST_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( txTimeFAST_V_V_empty_n ),
    .full_n     ( txTimeFAST_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( txTimeFAST_V_V_write ),
    .dout       ( txTimeFAST_V_V_dout ),
    .din        ( txTimeFAST_V_V_din )
);
...
assign s_data  = {txTimeFAST_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = txTimeFAST_V_V_empty_n;
...
module udpAppMux_txTimeFAST_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module udpAppMux_txTimeFAST_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
