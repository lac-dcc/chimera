...
module udp_portRelease_if (
    ...
    // User signals
    output wire [15:0] portRelease_V_V_dout,
    output wire        portRelease_V_V_empty_n,
    input  wire        portRelease_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [15:0] portRelease_V_V_din;
wire [0:0]  portRelease_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [15:0] s_data;
...
// portRelease_V_V_fifo
udp_portRelease_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) portRelease_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( portRelease_V_V_empty_n ),
    .full_n     ( portRelease_V_V_full_n ),
    .read       ( portRelease_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( portRelease_V_V_dout ),
    .din        ( portRelease_V_V_din )
);
...
assign portRelease_V_V_din = m_data[15:0];
assign fifo_full_n         = portRelease_V_V_full_n;
...
module udp_portRelease_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
