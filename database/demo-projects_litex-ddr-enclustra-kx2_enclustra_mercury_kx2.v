...
//
// Filename   : enclustra_mercury_kx2.v
// Device     : xc7k160tffg676-2
// LiteX sha1 : c3e93620
// Date       : 2023-03-30 08:52:48
//------------------------------------------------------------------------------
...
assign ddram0_ba = main_k7ddrphy_pads_ba;
...
always @(posedge sys_clk) begin
    ...
    if ((main_basesoc_sdram_sequencer_counter == 7'd68)) begin
        main_basesoc_sdram_cmd_payload_a <= 1'd0;
        main_basesoc_sdram_cmd_payload_ba <= 1'd0;
        main_basesoc_sdram_cmd_payload_cas <= 1'd0;
        main_basesoc_sdram_cmd_payload_ras <= 1'd0;
...
//------------------------------------------------------------------------------
// Memory rom: 8433-words x 32-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
reg [31:0] rom[0:8432];
initial begin
	$readmemh("enclustra_mercury_kx2_rom.init", rom);
end
reg [31:0] rom_dat0;
always @(posedge sys_clk) begin
...
initial begin
	$readmemh("enclustra_mercury_kx2_sram.init", sram);
end
reg [10:0] sram_adr0;
always @(posedge sys_clk) begin
...
reg [7:0] mem[0:36];
initial begin
	$readmemh("enclustra_mercury_kx2_mem.init", mem);
end
reg [5:0] mem_adr0;
always @(posedge sys_clk) begin
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-03-30 08:52:48.
//------------------------------------------------------------------------------
