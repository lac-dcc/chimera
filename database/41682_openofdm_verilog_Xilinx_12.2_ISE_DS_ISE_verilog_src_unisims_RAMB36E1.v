...
// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/blanc/RAMB36E1.v,v 1.17.24.4.6.1 2010/06/14 22:48:43 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
module RAMB36E1 (CASCADEOUTA, CASCADEOUTB, DBITERR, DOADO, DOBDO, DOPADOP, DOPBDOP, ECCPARITY, RDADDRECC, SBITERR, 
    ...
    specify
        ...
        (CLKARDCLK => DOADO[16]) = (100, 100);
        (CLKARDCLK => DOADO[17]) = (100, 100);
        (CLKARDCLK => DOADO[18]) = (100, 100);
        (CLKARDCLK => DOADO[19]) = (100, 100);
        (CLKARDCLK => DOADO[20]) = (100, 100);
        (CLKARDCLK => DOADO[21]) = (100, 100);
        (CLKARDCLK => DOADO[22]) = (100, 100);
        (CLKARDCLK => DOADO[23]) = (100, 100);
        (CLKARDCLK => DOADO[24]) = (100, 100);
        (CLKARDCLK => DOADO[25]) = (100, 100);
        (CLKARDCLK => DOADO[26]) = (100, 100);
        (CLKARDCLK => DOADO[27]) = (100, 100);
        (CLKARDCLK => DOADO[28]) = (100, 100);
        (CLKARDCLK => DOADO[29]) = (100, 100);
        (CLKARDCLK => DOADO[30]) = (100, 100);
        (CLKARDCLK => DOADO[31]) = (100, 100);
        (CLKARDCLK => DOPADOP[0]) = (100, 100);
        (CLKARDCLK => DOPADOP[1]) = (100, 100);
        (CLKARDCLK => DOPADOP[2]) = (100, 100);
        (CLKARDCLK => DOPADOP[3]) = (100, 100);
        (CLKARDCLK => RDADDRECC[0]) = (100, 100);
        (CLKARDCLK => RDADDRECC[1]) = (100, 100);
        (CLKARDCLK => RDADDRECC[2]) = (100, 100);
        (CLKARDCLK => RDADDRECC[3]) = (100, 100);
        (CLKARDCLK => RDADDRECC[4]) = (100, 100);
        (CLKARDCLK => RDADDRECC[5]) = (100, 100);
        (CLKARDCLK => RDADDRECC[6]) = (100, 100);
        (CLKARDCLK => RDADDRECC[7]) = (100, 100);
        (CLKARDCLK => RDADDRECC[8]) = (100, 100);
        ...
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[16]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[17]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[18]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[19]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[20]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[21]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[22]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[23]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[24]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[25]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[26]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[27]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[28]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[29]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[30]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOBDO[31]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOPBDOP[0]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOPBDOP[1]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOPBDOP[2]) = (100, 100);
        if (RAM_MODE == "SDP") (CLKARDCLK => DOPBDOP[3]) = (100, 100);
        ...
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[16]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[17]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[18]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[19]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[20]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[21]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[22]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[23]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[24]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[25]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[26]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[27]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[28]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[29]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[30]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOBDO[31]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOPBDOP[0]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOPBDOP[1]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOPBDOP[2]) = (100, 100);
        if (RAM_MODE == "TDP") (CLKBWRCLK => DOPBDOP[3]) = (100, 100);
       
	(CLKBWRCLK => ECCPARITY[0]) = (100, 100);
        (CLKBWRCLK => ECCPARITY[1]) = (100, 100);
        (CLKBWRCLK => ECCPARITY[2]) = (100, 100);
        (CLKBWRCLK => ECCPARITY[3]) = (100, 100);
        (CLKBWRCLK => ECCPARITY[4]) = (100, 100);
        (CLKBWRCLK => ECCPARITY[5]) = (100, 100);
        (CLKBWRCLK => ECCPARITY[6]) = (100, 100);
        (CLKBWRCLK => ECCPARITY[7]) = (100, 100);
