...
//
// On Thu Feb 24 19:15:27 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkPageDMA(aclk,
  ...
  wire [511 : 0] x3__h10991, x_data__h12456, x_wget__h10777;
  wire [63 : 0] IF_c2h_nextCmdFifo_notEmpty__47_OR_c2h_nextWri_ETC___d454,
		IF_h2c_nextCmdFifo_notEmpty__00_OR_h2c_nextWri_ETC___d507,
		v__h18469,
		v__h18963,
		v__h19273,
		v__h19399,
		...
		x_addr__h11878,
		x_addr__h5641;
  wire [51 : 0] pfn__h11929, x_dstPfn__h5234;
  wire [31 : 0] x_addr__h12307, x_addr__h5127;
  wire [19 : 0] pfn__h5178, x_dstPfn__h11984;
  wire [12 : 0] IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d649,
		c2h_pageCnt_09_PLUS_1___d118,
		h2c_pageCnt_09_PLUS_1___d318;
  wire [9 : 0] x__h11060, x__h11149;
  wire [7 : 0] IF_axiCtrl_writeSlave_in_rv_BIT_4_THEN_axiCtrl_ETC__q1,
	       IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d642;
  wire [1 : 0] v__h18478, v__h19408;
  wire NOT_c2h_nextCmdFifo_notEmpty__47_65_AND_NOT_c2_ETC___d471,
       NOT_h2c_dataFifo_rRdPtr_read__75_EQ_h2c_dataFi_ETC___d341,
       NOT_h2c_nextCmdFifo_notEmpty__00_18_AND_NOT_h2_ETC___d524,
       _dor1c2h_activeWriteFifo$EN_deq,
       _dor1c2h_nextRspFifo$EN_enq,
       _dor1h2c_activeWriteFifo$EN_deq,
       _dor1h2c_nextRspFifo$EN_enq,
       c2h_pageCnt_09_PLUS_1_18_EQ_c2h_nextCmdFifo_fi_ETC___d120,
       h2c_pageCnt_09_PLUS_1_18_EQ_h2c_nextCmdFifo_fi_ETC___d320;

  // value method intr_c2h
  assign intr_c2h =
	     c2hIntrEnReg && c2hStatus &&
	     NOT_c2h_nextCmdFifo_notEmpty__47_65_AND_NOT_c2_ETC___d471 ;
  ...
  assign MUX_c2hStatus$write_1__SEL_1 =
	     WILL_FIRE_RL_axiCtrl_1_axiWriteSpecial_3 &&
	     IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d642[7] ;
  ...
  assign MUX_h2c_axiWr_in_data$enq_1__VAL_1 =
	     { x_data__h12456, 64'hFFFFFFFFFFFFFFFF, h2c_dataCnt == 7'd63 } ;
  ...
  assign h2c_dataFifo_rCache$D_IN =
	     { 1'd1, h2c_dataFifo_rWrPtr, x3__h10991 } ;
  assign h2c_dataFifo_rCache$EN = h2c_dataFifo_pwEnqueue$whas ;

  // register h2c_dataFifo_rRdPtr
  assign h2c_dataFifo_rRdPtr$D_IN = x__h11149 ;
  assign h2c_dataFifo_rRdPtr$EN = WILL_FIRE_RL_h2c_forwardData ;

  // register h2c_dataFifo_rWrPtr
  assign h2c_dataFifo_rWrPtr$D_IN = x__h11060 ;
  ...
  // submodule c2h_axiRd_in
  assign c2h_axiRd_in$D_IN = { x_addr__h5127, 29'd133758976 } ;
  ...
  // submodule c2h_axiWr_in_addr
  assign c2h_axiWr_in_addr$D_IN = { x_addr__h5641, 29'd133758976 } ;
  ...
  assign c2h_nextCmdFifo$D_IN =
	     { c2hSrcAddrReg[31:12],
	       c2hDstAddrReg[63:12],
	       IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d649,
	       1'd0 } ;
  ...
  assign c2h_nextWriteFifo$D_IN =
	     { x_dstPfn__h5234, c2h_nextCmdFifo$D_OUT[0] } ;
  ...
  // submodule h2c_axiRd_in
  assign h2c_axiRd_in$D_IN = { x_addr__h11878, 29'd133758976 } ;
  ...
  // submodule h2c_axiWr_in_addr
  assign h2c_axiWr_in_addr$D_IN = { x_addr__h12307, 29'd133758976 } ;
  ...
  assign h2c_dataFifo_memory$DIA = x3__h10991 ;
  ...
  assign h2c_nextCmdFifo$D_IN =
	     { h2cSrcAddrReg[63:12],
	       h2cDstAddrReg[31:12],
	       IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d649,
	       IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d642[6] } ;
  ...
  assign h2c_nextWriteFifo$D_IN =
	     { x_dstPfn__h11984, h2c_nextCmdFifo$D_OUT[0] } ;
  ...
  assign IF_axiCtrl_writeSlave_in_rv_BIT_4_THEN_axiCtrl_ETC__q1 =
	     axiCtrl_writeSlave_in_rv[4] ?
	       axiCtrl_writeSlave_in_rv[26:19] :
	       8'd0 ;
  assign IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d642 =
	     axiCtrl_writeSlave_in_rv[10] ?
	       axiCtrl_writeSlave_in_rv[74:67] :
	       8'd0 ;
  assign IF_axiCtrl_writeSlave_in_rv_port0__read__60_BI_ETC___d649 =
	     { IF_axiCtrl_writeSlave_in_rv_BIT_4_THEN_axiCtrl_ETC__q1[4:0],
	       axiCtrl_writeSlave_in_rv[3] ?
		 axiCtrl_writeSlave_in_rv[18:11] :
		 8'd0 } ;
  assign IF_c2h_nextCmdFifo_notEmpty__47_OR_c2h_nextWri_ETC___d454 =
	     (c2h_nextCmdFifo$EMPTY_N || c2h_nextWriteFifo$EMPTY_N ||
	      c2h_activeWriteFifo$EMPTY_N ||
	      c2h_nextRspFifo$EMPTY_N) ?
	       64'd1 :
	       64'd0 ;
  assign IF_h2c_nextCmdFifo_notEmpty__00_OR_h2c_nextWri_ETC___d507 =
	     (h2c_nextCmdFifo$EMPTY_N || h2c_nextWriteFifo$EMPTY_N ||
	      h2c_activeWriteFifo$EMPTY_N ||
	      h2c_nextRspFifo$EMPTY_N) ?
	       64'd1 :
	       64'd0 ;
  assign NOT_c2h_nextCmdFifo_notEmpty__47_65_AND_NOT_c2_ETC___d471 =
	     !c2h_nextCmdFifo$EMPTY_N && !c2h_nextWriteFifo$EMPTY_N &&
	     !c2h_activeWriteFifo$EMPTY_N &&
	     !c2h_nextRspFifo$EMPTY_N ;
  assign NOT_h2c_dataFifo_rRdPtr_read__75_EQ_h2c_dataFi_ETC___d341 =
	     h2c_dataFifo_rRdPtr != h2c_dataFifo_rWrPtr ;
  assign NOT_h2c_nextCmdFifo_notEmpty__00_18_AND_NOT_h2_ETC___d524 =
	     !h2c_nextCmdFifo$EMPTY_N && !h2c_nextWriteFifo$EMPTY_N &&
	     !h2c_activeWriteFifo$EMPTY_N &&
	     !h2c_nextRspFifo$EMPTY_N ;
  ...
  assign _dor1h2c_nextRspFifo$EN_enq =
	     WILL_FIRE_RL_h2c_genZeroData || WILL_FIRE_RL_h2c_forwardData ;
  assign c2h_pageCnt_09_PLUS_1_18_EQ_c2h_nextCmdFifo_fi_ETC___d120 =
	     c2h_pageCnt_09_PLUS_1___d118 == c2h_nextCmdFifo$D_OUT[13:1] ;
  assign c2h_pageCnt_09_PLUS_1___d118 = c2h_pageCnt + 13'd1 ;
  assign h2c_pageCnt_09_PLUS_1_18_EQ_h2c_nextCmdFifo_fi_ETC___d320 =
	     h2c_pageCnt_09_PLUS_1___d318 == h2c_nextCmdFifo$D_OUT[13:1] ;
  assign h2c_pageCnt_09_PLUS_1___d318 = h2c_pageCnt + 13'd1 ;
  assign pfn__h11929 = h2c_nextCmdFifo$D_OUT[85:34] + { 39'd0, h2c_pageCnt } ;
  assign pfn__h5178 = c2h_nextCmdFifo$D_OUT[85:66] + { 7'd0, c2h_pageCnt } ;
  assign v__h18469 =
	     { IF_c2h_nextCmdFifo_notEmpty__47_OR_c2h_nextWri_ETC___d454[63:8],
	       !c2h_nextCmdFifo$FULL_N,
	       IF_c2h_nextCmdFifo_notEmpty__47_OR_c2h_nextWri_ETC___d454[6:5],
	       c2hIntrEnReg,
	       v__h18478,
	       c2hStatus &&
	       NOT_c2h_nextCmdFifo_notEmpty__47_65_AND_NOT_c2_ETC___d471,
	       IF_c2h_nextCmdFifo_notEmpty__47_OR_c2h_nextWri_ETC___d454[0] } ;
  assign v__h18478 = { c2h_writeError, c2h_readError } ;
  assign v__h18963 = { 32'd0, c2hSrcAddrReg } ;
  assign v__h19273 = { 56'd0, c2h_nextCmdCnt } ;
  assign v__h19399 =
	     { IF_h2c_nextCmdFifo_notEmpty__00_OR_h2c_nextWri_ETC___d507[63:8],
	       !h2c_nextCmdFifo$FULL_N,
	       IF_h2c_nextCmdFifo_notEmpty__00_OR_h2c_nextWri_ETC___d507[6:5],
	       h2cIntrEnReg,
	       v__h19408,
	       h2cStatus &&
	       NOT_h2c_nextCmdFifo_notEmpty__00_18_AND_NOT_h2_ETC___d524,
	       IF_h2c_nextCmdFifo_notEmpty__00_OR_h2c_nextWri_ETC___d507[0] } ;
  assign v__h19408 = { h2c_writeError, h2c_readError } ;
  assign v__h20000 = { 32'd0, h2cDstAddrReg } ;
  assign v__h20155 = { 56'd0, h2c_nextCmdCnt } ;
  assign x3__h10991 = h2c_dataFifo_pwEnqueue$whas ? x_wget__h10777 : 512'd0 ;
  assign x__h11060 = h2c_dataFifo_rWrPtr + 10'd1 ;
  assign x__h11149 = h2c_dataFifo_rRdPtr + 10'd1 ;
  assign x_addr__h11878 = { pfn__h11929, 12'd0 } ;
  assign x_addr__h12307 = { h2c_nextWriteFifo$D_OUT[20:1], 12'd0 } ;
  assign x_addr__h5127 = { pfn__h5178, 12'd0 } ;
  assign x_addr__h5641 = { c2h_nextWriteFifo$D_OUT[52:1], 12'd0 } ;
  assign x_data__h12456 =
	     (h2c_dataFifo_rCache[522] &&
	      h2c_dataFifo_rCache[521:512] == h2c_dataFifo_rRdPtr) ?
	       h2c_dataFifo_rCache[511:0] :
	       h2c_dataFifo_memory$DOB ;
  assign x_dstPfn__h11984 =
	     h2c_nextCmdFifo$D_OUT[33:14] + { 7'd0, h2c_pageCnt } ;
  assign x_dstPfn__h5234 =
	     c2h_nextCmdFifo$D_OUT[65:14] + { 39'd0, c2h_pageCnt } ;
  assign x_wget__h10777 =
	     (h2c_axiRd_out$D_OUT[2:1] == 2'd0) ?
