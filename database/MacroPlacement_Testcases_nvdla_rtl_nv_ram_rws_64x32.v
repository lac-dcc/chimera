...
// This wrapper consists of : 1 Ram cells: RAMDP_64X32_GL_M1_E2 ;
...
nv_ram_rws_64x32_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rws_64x32 (
...
integer row;
begin
// initializing RAMDP_64X32_GL_M1_E2
for (row = 0; row < 64; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rws_64x32.ram_Inst_64X32.mem_write(row - 0, shadow_mem[row][31:0]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [31:0] data;
begin
// probing RAMDP_64X32_GL_M1_E2
 if (row >= 0 && row < 64) data[31:0] = r_nv_ram_rws_64x32.ram_Inst_64X32.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
