...
// nv_ram_rwsp_64x129: synthesizable model core
...
module nv_ram_rwsp_64x129_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
output [129:0] mbist_Do_r0_int_net;
...
wire [129:0] Data_reg_r0;
// Data out bus for read port r0 for Output Mux
wire [129:0] r0_OutputMuxDataOut;
...
wire shiftDR_en;
reg [129:0] pre_muxed_Di_w0;
wire [129:0] pre_muxed_Di_w0_A, pre_muxed_Di_w0_B;
wire pre_muxed_Di_w0_S;
assign pre_muxed_Di_w0_S = !debug_mode_sync;
assign pre_muxed_Di_w0_A = Data_reg_r0[129:0];
assign pre_muxed_Di_w0_B = {{65{mbist_Di_w0}}};
always @(pre_muxed_Di_w0_S or pre_muxed_Di_w0_A or pre_muxed_Di_w0_B)
    case(pre_muxed_Di_w0_S) // synopsys infer_mux
      1'b0 : pre_muxed_Di_w0 = pre_muxed_Di_w0_A;
      1'b1 : pre_muxed_Di_w0 = pre_muxed_Di_w0_B;
      default : pre_muxed_Di_w0 = {130{`tick_x_or_0}};
    endcase
reg [129:0] muxed_Di_w0;
wire [129:0] muxed_Di_w0_A, muxed_Di_w0_B;
assign muxed_Di_w0_A = {{1{1'b0}},di[128:0]};
...
always @(muxed_Di_w0_S or muxed_Di_w0_A or muxed_Di_w0_B)
    case(muxed_Di_w0_S) // synopsys infer_mux
      ...
      default : muxed_Di_w0 = {130{`tick_x_or_0}};
    endcase
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMPDP_64X130_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 63 Addressrange: [5:0]
// Data Bit range: [128:0] (130 bits)
...
// Write Data in bus
wire [129:0] Wdata;
assign Wdata = muxed_Di_w0[129:0];
assign we_0_0 = we;
// Read Address bus
wire [5:0] ra_0_0;
...
// ----------------- begin Ram Cell RAMPDP_64X130_GL_M1_D2 -------------
// Write Port Stuff -----
...
wire [129:0] ramDataOut;
assign dout_0_0[129:0] = ramDataOut[129:0];
// verilint 210 off - Too few module ports
// verilint 287 off - Unconnected port
RAMPDP_64X130_GL_M1_D2 ram_Inst_64X130 (
                                          .CLK (gated_clk_core)
                                        , .WADR_5 (wa_0_0[5])
                                        , .WADR_4 (wa_0_0[4])
                                        , .WADR_3 (wa_0_0[3])
...
reg [129:0] ram_r0_OutputMuxDataOut;
//For bitEnd 128, only one piece RAMPDP_64X130_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_0[129:0] or muxed_Di_w0[129:0] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[129:0] = (ram_bypass) ? muxed_Di_w0[129:0]: dout_0_0;
end
assign r0_OutputMuxDataOut[129:0] = ram_r0_OutputMuxDataOut[129:0];
...
////MSB 129 LSB 0  and total rambit is 130 and  dsize is 130
wire Data_reg_SO_r0;
// verilint 110 off - Incompatible width
// verilint 630 off - Port connected to a NULL expression
// These are used for registering Ra in case of Latch arrays as well (i.e.
// used in functional path as well)
wire [129:0]data_regq;
assign Data_reg_r0[129:0] = data_regq[129:0] ;
// verilint 110 on - Incompatible width
// verilint 630 on - Port connected to a NULL expression
assign dout = Data_reg_r0[128:0];
assign mbist_Do_r0_int_net = Data_reg_r0[130-1:0];
...
ScanShareSel_JTAG_reg_ext_cg #(130, 0, 0) testInst_Data_reg_r0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(r0_OutputMuxDataOut[129:0]), .Q(data_regq[129:0]),
