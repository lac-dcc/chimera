...
module udpCapitalize_lbTxLengthOut_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
//------------------------Instantiation------------------
// rs
udpCapitalize_lbTxLengthOut_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
udpCapitalize_lbTxLengthOut_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) lbTxLengthOut_V_V_fifo (
    .clk        ( ACLK ),
...
module udpCapitalize_lbTxLengthOut_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module udpCapitalize_lbTxLengthOut_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
