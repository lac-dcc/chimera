...
// This wrapper consists of : 1 Ram cells: RAMPDP_60X84_GL_M1_D2 ;
...
nv_ram_rwsthp_60x84_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rwsthp_60x84 (
...
// synopsys dc_tcl_script_end
`ifndef SYNTHESIS
task arrangement (output integer arrangment_string[83:0]);
  begin
...
reg [83:0] shadow_mem [59:0];
`ifdef NV_RAM_EXPAND_ARRAY
wire [83:0] shadow_mem_row0 = shadow_mem[0];
wire [83:0] shadow_mem_row1 = shadow_mem[1];
wire [83:0] shadow_mem_row2 = shadow_mem[2];
wire [83:0] shadow_mem_row3 = shadow_mem[3];
wire [83:0] shadow_mem_row4 = shadow_mem[4];
wire [83:0] shadow_mem_row5 = shadow_mem[5];
wire [83:0] shadow_mem_row6 = shadow_mem[6];
wire [83:0] shadow_mem_row7 = shadow_mem[7];
wire [83:0] shadow_mem_row8 = shadow_mem[8];
wire [83:0] shadow_mem_row9 = shadow_mem[9];
wire [83:0] shadow_mem_row10 = shadow_mem[10];
wire [83:0] shadow_mem_row11 = shadow_mem[11];
wire [83:0] shadow_mem_row12 = shadow_mem[12];
wire [83:0] shadow_mem_row13 = shadow_mem[13];
wire [83:0] shadow_mem_row14 = shadow_mem[14];
wire [83:0] shadow_mem_row15 = shadow_mem[15];
wire [83:0] shadow_mem_row16 = shadow_mem[16];
wire [83:0] shadow_mem_row17 = shadow_mem[17];
wire [83:0] shadow_mem_row18 = shadow_mem[18];
wire [83:0] shadow_mem_row19 = shadow_mem[19];
wire [83:0] shadow_mem_row20 = shadow_mem[20];
wire [83:0] shadow_mem_row21 = shadow_mem[21];
wire [83:0] shadow_mem_row22 = shadow_mem[22];
wire [83:0] shadow_mem_row23 = shadow_mem[23];
wire [83:0] shadow_mem_row24 = shadow_mem[24];
wire [83:0] shadow_mem_row25 = shadow_mem[25];
wire [83:0] shadow_mem_row26 = shadow_mem[26];
wire [83:0] shadow_mem_row27 = shadow_mem[27];
wire [83:0] shadow_mem_row28 = shadow_mem[28];
wire [83:0] shadow_mem_row29 = shadow_mem[29];
wire [83:0] shadow_mem_row30 = shadow_mem[30];
wire [83:0] shadow_mem_row31 = shadow_mem[31];
wire [83:0] shadow_mem_row32 = shadow_mem[32];
wire [83:0] shadow_mem_row33 = shadow_mem[33];
wire [83:0] shadow_mem_row34 = shadow_mem[34];
wire [83:0] shadow_mem_row35 = shadow_mem[35];
wire [83:0] shadow_mem_row36 = shadow_mem[36];
wire [83:0] shadow_mem_row37 = shadow_mem[37];
wire [83:0] shadow_mem_row38 = shadow_mem[38];
wire [83:0] shadow_mem_row39 = shadow_mem[39];
wire [83:0] shadow_mem_row40 = shadow_mem[40];
wire [83:0] shadow_mem_row41 = shadow_mem[41];
wire [83:0] shadow_mem_row42 = shadow_mem[42];
wire [83:0] shadow_mem_row43 = shadow_mem[43];
wire [83:0] shadow_mem_row44 = shadow_mem[44];
wire [83:0] shadow_mem_row45 = shadow_mem[45];
wire [83:0] shadow_mem_row46 = shadow_mem[46];
wire [83:0] shadow_mem_row47 = shadow_mem[47];
wire [83:0] shadow_mem_row48 = shadow_mem[48];
wire [83:0] shadow_mem_row49 = shadow_mem[49];
wire [83:0] shadow_mem_row50 = shadow_mem[50];
wire [83:0] shadow_mem_row51 = shadow_mem[51];
wire [83:0] shadow_mem_row52 = shadow_mem[52];
wire [83:0] shadow_mem_row53 = shadow_mem[53];
wire [83:0] shadow_mem_row54 = shadow_mem[54];
wire [83:0] shadow_mem_row55 = shadow_mem[55];
wire [83:0] shadow_mem_row56 = shadow_mem[56];
wire [83:0] shadow_mem_row57 = shadow_mem[57];
wire [83:0] shadow_mem_row58 = shadow_mem[58];
wire [83:0] shadow_mem_row59 = shadow_mem[59];
`endif
task init_mem_val;
  input [5:0] row;
  input [83:0] data;
...
integer row;
begin
// initializing RAMPDP_60X84_GL_M1_D2
for (row = 0; row < 60; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rwsthp_60x84.ram_Inst_60X84.mem_write(row - 0, shadow_mem[row][83:0]);
shadow_written = 'b0;
end
endtask
`endif
...
`ifndef MEM_REG_NAME
 `define MEM_REG_NAME MX.mem
`endif
function [83:0] probe_mem_val;
input [5:0] row;
reg [83:0] data;
begin
// probing RAMPDP_60X84_GL_M1_D2
 if (row >= 0 && row < 60) data[83:0] = r_nv_ram_rwsthp_60x84.ram_Inst_60X84.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
...
integer bitnum;
begin
  random_num = rflip.rollpli(0, 5040);
  row = random_num / 84;
  bitnum = random_num % 84;
