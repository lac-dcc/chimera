...
// This wrapper consists of : 2 Ram cells: RAMPDP_256X144_GL_M2_D2 RAMPDP_256X112_GL_M2_D2 ;
...
nv_ram_rws_256x256_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rws_256x256 (
...
for (row = 0; row < 256; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rws_256x256.ram_Inst_256X144_0_0.mem_write(row - 0, shadow_mem[row][143:0]);
// initializing RAMPDP_256X112_GL_M2_D2
for (row = 0; row < 256; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rws_256x256.ram_Inst_256X112_0_144.mem_write(row - 0, shadow_mem[row][255:144]);
shadow_written = 'b0;
end
endtask
`endif
...
// probing RAMPDP_256X144_GL_M2_D2
 if (row >= 0 && row < 256) data[143:0] = r_nv_ram_rws_256x256.ram_Inst_256X144_0_0.mem_read(row - 0);
// probing RAMPDP_256X112_GL_M2_D2
 if (row >= 0 && row < 256) data[255:144] = r_nv_ram_rws_256x256.ram_Inst_256X112_0_144.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
