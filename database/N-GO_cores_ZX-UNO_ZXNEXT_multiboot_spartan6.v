...
module seq_multiboot_spartan6 (
  ...
  initial begin  // secuencia para carga a 1x. Se ha eliminado el comando 3301 con el parámetro 3100, que vendría después de la carga de la dirección SPI
    ...
    icap_command[ 4] = {1'b0, 1'b0, 16'h0000};  // en este ciclo hay que poner la dirección SPI baja
    icap_command[ 5] = {1'b0, 1'b0, 16'h3281};
    icap_command[ 6] = {1'b0, 1'b0, 16'h0300};  // en este ciclo hay que poner la dirección SPI alta
