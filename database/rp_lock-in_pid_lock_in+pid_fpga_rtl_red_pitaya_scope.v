...
module red_pitaya_scope #(
  parameter RSZ = 14  // RAM size 2^RSZ
   ...
   input      [ 32-1: 0] osc_ctrl_i      ,  // oscilloscope control from lock module
...
wire [ 14-1: 0] adc_a_filt_out_m ;
wire [ 14-1: 0] adc_a_filt_out ;

wire [ 14-1: 0] adc_b_filt_in  ;
wire [ 14-1: 0] adc_b_filt_out_m ;
...
red_pitaya_dfilt1 i_dfilt1_cha (
  ...
  .adc_dat_o   ( adc_a_filt_out_m),  // ADC data
   // configuration
...
assign adc_a_filt_out = osc_ctrl_i[0] ? adc_a_i : adc_a_filt_out_m ;
...
red_pitaya_dfilt1 i_dfilt1_chb (
  ...
  .adc_dat_o   ( adc_b_filt_out_m),  // ADC data
   // configuration
...
assign adc_b_filt_out = osc_ctrl_i[1] ? adc_b_i : adc_b_filt_out_m ;
