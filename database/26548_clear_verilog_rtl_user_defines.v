...
`define USER_CONFIG_GPIO_0_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL
`define USER_CONFIG_GPIO_1_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL
`define USER_CONFIG_GPIO_2_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL
`define USER_CONFIG_GPIO_3_INIT  `GPIO_MODE_MGMT_STD_INPUT_PULLUP
`define USER_CONFIG_GPIO_4_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL
