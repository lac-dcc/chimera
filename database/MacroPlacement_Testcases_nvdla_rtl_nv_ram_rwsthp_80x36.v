...
// This wrapper consists of : 1 Ram cells: RAMPDP_80X36_GL_M1_D2 ;
...
nv_ram_rwsthp_80x36_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rwsthp_80x36 (
...
// synopsys dc_tcl_script_end
`ifndef SYNTHESIS
task arrangement (output integer arrangment_string[35:0]);
  begin
...
reg [35:0] shadow_mem [79:0];
`ifdef NV_RAM_EXPAND_ARRAY
wire [35:0] shadow_mem_row0 = shadow_mem[0];
wire [35:0] shadow_mem_row1 = shadow_mem[1];
wire [35:0] shadow_mem_row2 = shadow_mem[2];
wire [35:0] shadow_mem_row3 = shadow_mem[3];
wire [35:0] shadow_mem_row4 = shadow_mem[4];
wire [35:0] shadow_mem_row5 = shadow_mem[5];
wire [35:0] shadow_mem_row6 = shadow_mem[6];
wire [35:0] shadow_mem_row7 = shadow_mem[7];
wire [35:0] shadow_mem_row8 = shadow_mem[8];
wire [35:0] shadow_mem_row9 = shadow_mem[9];
wire [35:0] shadow_mem_row10 = shadow_mem[10];
wire [35:0] shadow_mem_row11 = shadow_mem[11];
wire [35:0] shadow_mem_row12 = shadow_mem[12];
wire [35:0] shadow_mem_row13 = shadow_mem[13];
wire [35:0] shadow_mem_row14 = shadow_mem[14];
wire [35:0] shadow_mem_row15 = shadow_mem[15];
wire [35:0] shadow_mem_row16 = shadow_mem[16];
wire [35:0] shadow_mem_row17 = shadow_mem[17];
wire [35:0] shadow_mem_row18 = shadow_mem[18];
wire [35:0] shadow_mem_row19 = shadow_mem[19];
wire [35:0] shadow_mem_row20 = shadow_mem[20];
wire [35:0] shadow_mem_row21 = shadow_mem[21];
wire [35:0] shadow_mem_row22 = shadow_mem[22];
wire [35:0] shadow_mem_row23 = shadow_mem[23];
wire [35:0] shadow_mem_row24 = shadow_mem[24];
wire [35:0] shadow_mem_row25 = shadow_mem[25];
wire [35:0] shadow_mem_row26 = shadow_mem[26];
wire [35:0] shadow_mem_row27 = shadow_mem[27];
wire [35:0] shadow_mem_row28 = shadow_mem[28];
wire [35:0] shadow_mem_row29 = shadow_mem[29];
wire [35:0] shadow_mem_row30 = shadow_mem[30];
wire [35:0] shadow_mem_row31 = shadow_mem[31];
wire [35:0] shadow_mem_row32 = shadow_mem[32];
wire [35:0] shadow_mem_row33 = shadow_mem[33];
wire [35:0] shadow_mem_row34 = shadow_mem[34];
wire [35:0] shadow_mem_row35 = shadow_mem[35];
wire [35:0] shadow_mem_row36 = shadow_mem[36];
wire [35:0] shadow_mem_row37 = shadow_mem[37];
wire [35:0] shadow_mem_row38 = shadow_mem[38];
wire [35:0] shadow_mem_row39 = shadow_mem[39];
wire [35:0] shadow_mem_row40 = shadow_mem[40];
wire [35:0] shadow_mem_row41 = shadow_mem[41];
wire [35:0] shadow_mem_row42 = shadow_mem[42];
wire [35:0] shadow_mem_row43 = shadow_mem[43];
wire [35:0] shadow_mem_row44 = shadow_mem[44];
wire [35:0] shadow_mem_row45 = shadow_mem[45];
wire [35:0] shadow_mem_row46 = shadow_mem[46];
wire [35:0] shadow_mem_row47 = shadow_mem[47];
wire [35:0] shadow_mem_row48 = shadow_mem[48];
wire [35:0] shadow_mem_row49 = shadow_mem[49];
wire [35:0] shadow_mem_row50 = shadow_mem[50];
wire [35:0] shadow_mem_row51 = shadow_mem[51];
wire [35:0] shadow_mem_row52 = shadow_mem[52];
wire [35:0] shadow_mem_row53 = shadow_mem[53];
wire [35:0] shadow_mem_row54 = shadow_mem[54];
wire [35:0] shadow_mem_row55 = shadow_mem[55];
wire [35:0] shadow_mem_row56 = shadow_mem[56];
wire [35:0] shadow_mem_row57 = shadow_mem[57];
wire [35:0] shadow_mem_row58 = shadow_mem[58];
wire [35:0] shadow_mem_row59 = shadow_mem[59];
wire [35:0] shadow_mem_row60 = shadow_mem[60];
wire [35:0] shadow_mem_row61 = shadow_mem[61];
wire [35:0] shadow_mem_row62 = shadow_mem[62];
wire [35:0] shadow_mem_row63 = shadow_mem[63];
wire [35:0] shadow_mem_row64 = shadow_mem[64];
wire [35:0] shadow_mem_row65 = shadow_mem[65];
wire [35:0] shadow_mem_row66 = shadow_mem[66];
wire [35:0] shadow_mem_row67 = shadow_mem[67];
wire [35:0] shadow_mem_row68 = shadow_mem[68];
wire [35:0] shadow_mem_row69 = shadow_mem[69];
wire [35:0] shadow_mem_row70 = shadow_mem[70];
wire [35:0] shadow_mem_row71 = shadow_mem[71];
wire [35:0] shadow_mem_row72 = shadow_mem[72];
wire [35:0] shadow_mem_row73 = shadow_mem[73];
wire [35:0] shadow_mem_row74 = shadow_mem[74];
wire [35:0] shadow_mem_row75 = shadow_mem[75];
wire [35:0] shadow_mem_row76 = shadow_mem[76];
wire [35:0] shadow_mem_row77 = shadow_mem[77];
wire [35:0] shadow_mem_row78 = shadow_mem[78];
wire [35:0] shadow_mem_row79 = shadow_mem[79];
`endif
task init_mem_val;
  input [6:0] row;
  input [35:0] data;
...
integer row;
begin
// initializing RAMPDP_80X36_GL_M1_D2
for (row = 0; row < 80; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rwsthp_80x36.ram_Inst_80X36.mem_write(row - 0, shadow_mem[row][35:0]);
shadow_written = 'b0;
end
endtask
`endif
...
`ifndef MEM_REG_NAME
 `define MEM_REG_NAME MX.mem
`endif
function [35:0] probe_mem_val;
input [6:0] row;
reg [35:0] data;
begin
// probing RAMPDP_80X36_GL_M1_D2
 if (row >= 0 && row < 80) data[35:0] = r_nv_ram_rwsthp_80x36.ram_Inst_80X36.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
...
integer bitnum;
begin
  random_num = rflip.rollpli(0, 2880);
  row = random_num / 36;
  bitnum = random_num % 36;
