...
// jt1943_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
parameter CHAR_OFFSET = `CHAR_START>>1;
parameter MAP2_OFFSET = (`MAP2_START-`MAP1_START)>>1;
parameter SCR2_OFFSET = (`SCR2_START-`SCR1_START)>>1;
...
jtframe_bram_rom #(
    .AW(15),.DW(8),
    .OFFSET(`SND_START>>1),.SIMFILE("snd.bin")
) u_brom_snd(
    .clk    ( clk       ),
    // Read port
    .addr   ( snd_addr ),
...
`ifdef VERILATOR_KEEP_CEN /* verilator tracing_on */ `else /* verilator tracing_off */ `endif
jtframe_gated_cen #(.W(1),.NUM(1),.DEN(6),.MFREQ(48000)) u_cen1_clk(
    .rst    ( rst          ),
    .clk    ( clk ),
    .busy   ( 1'b0    ),
    .cen    ( { cen8 } ),
