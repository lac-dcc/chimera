...
// *******************************************************************************************************
// **                                                                                                   **
// **   M11AA080.v - 11AA080 8K-BIT UNI/O(R) BUS SERIAL EEPROM (VCC = +1.8V TO +5.5V)                   **
// **                                                                                                   **
// *******************************************************************************************************
// **                                                                                                   **
...
// *******************************************************************************************************
   ...
   always @(CheckTiming_tE) begin
      if (BitPeriod < tE_MIN) begin
         $display ("    ERROR! M11AA080: measured bit period < 10 usec (time: %0d ns)", $stime);
      end
      if (BitPeriod > tE_MAX) begin
         $display ("    ERROR! M11AA080: measured bit period > 100 usec (time: %0d ns)", $stime);
      end
   end
