...
// nv_ram_rwsp_128x257: synthesizable model core
...
module nv_ram_rwsp_128x257_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
output [257:0] mbist_Do_r0_int_net;
...
wire [257:0] Data_reg_r0;
// Data out bus for read port r0 for Output Mux
wire [257:0] r0_OutputMuxDataOut;
...
wire shiftDR_en;
reg [257:0] pre_muxed_Di_w0;
wire [257:0] pre_muxed_Di_w0_A, pre_muxed_Di_w0_B;
wire pre_muxed_Di_w0_S;
assign pre_muxed_Di_w0_S = !debug_mode_sync;
assign pre_muxed_Di_w0_A = Data_reg_r0[257:0];
assign pre_muxed_Di_w0_B = {{129{mbist_Di_w0}}};
always @(pre_muxed_Di_w0_S or pre_muxed_Di_w0_A or pre_muxed_Di_w0_B)
    case(pre_muxed_Di_w0_S) // synopsys infer_mux
      1'b0 : pre_muxed_Di_w0 = pre_muxed_Di_w0_A;
      1'b1 : pre_muxed_Di_w0 = pre_muxed_Di_w0_B;
      default : pre_muxed_Di_w0 = {258{`tick_x_or_0}};
    endcase
reg [257:0] muxed_Di_w0;
wire [257:0] muxed_Di_w0_A, muxed_Di_w0_B;
assign muxed_Di_w0_A = {{1{1'b0}},di[256:0]};
...
always @(muxed_Di_w0_S or muxed_Di_w0_A or muxed_Di_w0_B)
    case(muxed_Di_w0_S) // synopsys infer_mux
      ...
      default : muxed_Di_w0 = {258{`tick_x_or_0}};
    endcase
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMPDP_128X258_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 127 Addressrange: [6:0]
// Data Bit range: [256:0] (258 bits)
...
// Write Data in bus
wire [257:0] Wdata;
assign Wdata = muxed_Di_w0[257:0];
assign we_0_0 = we;
// Read Address bus
wire [6:0] ra_0_0;
...
// ----------------- begin Ram Cell RAMPDP_128X258_GL_M1_D2 -------------
// Write Port Stuff -----
...
wire [257:0] ramDataOut;
assign dout_0_0[257:0] = ramDataOut[257:0];
// verilint 210 off - Too few module ports
// verilint 287 off - Unconnected port
RAMPDP_128X258_GL_M1_D2 ram_Inst_128X258 (
                                            .CLK (gated_clk_core)
                                          , .WADR_6 (wa_0_0[6])
                                          , .WADR_5 (wa_0_0[5])
                                          , .WADR_4 (wa_0_0[4])
...
reg [257:0] ram_r0_OutputMuxDataOut;
//For bitEnd 256, only one piece RAMPDP_128X258_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_0[257:0] or muxed_Di_w0[257:0] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[257:0] = (ram_bypass) ? muxed_Di_w0[257:0]: dout_0_0;
end
assign r0_OutputMuxDataOut[257:0] = ram_r0_OutputMuxDataOut[257:0];
...
////MSB 257 LSB 0  and total rambit is 258 and  dsize is 258
wire Data_reg_SO_r0;
// verilint 110 off - Incompatible width
// verilint 630 off - Port connected to a NULL expression
// These are used for registering Ra in case of Latch arrays as well (i.e.
// used in functional path as well)
wire [257:0]data_regq;
assign Data_reg_r0[257:0] = data_regq[257:0] ;
// verilint 110 on - Incompatible width
// verilint 630 on - Port connected to a NULL expression
assign dout = Data_reg_r0[256:0];
assign mbist_Do_r0_int_net = Data_reg_r0[258-1:0];
...
wire [257:0] Data_reg_r0_D = r0_OutputMuxDataOut[257:0];
wire [257:0] Data_reg_r0_Q;
assign data_regq[257:0] = Data_reg_r0_Q;
...
ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0_257_2 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            ...
            .scanin(re_reg_SO_r0), .scanout(so_Data_reg_r0_257_2) );
