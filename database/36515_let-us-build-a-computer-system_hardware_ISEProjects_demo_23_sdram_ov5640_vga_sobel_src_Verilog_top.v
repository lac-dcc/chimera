...
assign vga_out_r  = ycbcr_de == 1'b1 ? sobel_out[7:3] : 5'd0;
assign vga_out_g  = ycbcr_de == 1'b1 ? sobel_out[7:2] : 6'd0;
assign vga_out_b  = ycbcr_de == 1'b1 ? sobel_out[7:3] : 5'd0;
...
(
	.sys_clkin                   (clk_bufg                 ),
	.sys_clkout1                 (cmos_xclk                ),
	.sys_clkout2                 (ext_mem_clk              ),
	.sys_clkout3                 (mem_ref_clk              ),	
	.reset                       (~rst_n                   ),
	.locked                      (                         )
);
//generate video pixel clock
video_pll video_pll_m0(
	.video_clkin                 (clk_bufg                 ),
