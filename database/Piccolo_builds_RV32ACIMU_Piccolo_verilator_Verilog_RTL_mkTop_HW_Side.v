...
module mkTop_HW_Side(CLK,
  ...
  // submodule soc_top
  assign soc_top$put_from_console_put = v__h974 ;
  ...
  assign soc_top$set_watch_tohost_tohost_addr = tohost_addr__h596 ;
  ...
  begin
    ...
    v__h774 = v__h780 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_terminate)
	$imported_c_end_timing({ 32'd0, v__h774 });
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0)
	begin
	  tohost_addr__h596 = $imported_c_get_symbol_val("tohost");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0)
    ...
    v__h655 = v__h661 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0) $imported_c_start_timing({ 32'd0, v__h655 });
    if (RST_N != `BSV_RESET_VALUE)
	...
	begin
	  v__h974 = $imported_c_trygetchar(8'hAA);
	  #0;
	end
  end
  // synopsys translate_on
