...
// nv_ram_rwsthp_20x8: synthesizable model core
...
module nv_ram_rwsthp_20x8_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMDP_20X8_GL_M1_E2 (RamCell)
...
// ----------------- begin Ram Cell RAMDP_20X8_GL_M1_E2 -------------
// Write Port Stuff -----
...
RAMDP_20X8_GL_M1_E2 ram_Inst_20X8 (
...
//For bitEnd 7, only one piece RAMDP_20X8_GL_M1_E2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_0[7:0] or muxed_Di_w0[7:0] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[7:0] = (ram_bypass) ? muxed_Di_w0[7:0]: dout_0_0;
end
assign r0_OutputMuxDataOut[7:0] = ram_r0_OutputMuxDataOut[7:0];
// verilint 17 on - Range (rather than full vector) in the sensitivity list
// --------------------- Output Mbist Interface logic -------------
wire [7:0] functional_byp_muxed_r0_OutputMuxDataOut = (byp_sel & !debug_mode_sync & !mbist_en_r) ? dbyp : wthru_di;
wire [7:0] muxed_r0_OutputMuxDataOut;
...
ScanShareSel_JTAG_reg_ext_cg #(8, 0, 0) testInst_Data_reg_r0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(muxed_r0_OutputMuxDataOut[7:0]), .Q(data_regq[7:0]),
