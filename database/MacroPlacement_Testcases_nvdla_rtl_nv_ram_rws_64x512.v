...
// This wrapper consists of : 2 Ram cells: RAMPDP_64X288_GL_M1_D2 RAMPDP_64X224_GL_M1_D2 ;
...
nv_ram_rws_64x512_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rws_64x512 (
...
for (row = 0; row < 64; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rws_64x512.ram_Inst_64X288_0_0.mem_write(row - 0, shadow_mem[row][287:0]);
// initializing RAMPDP_64X224_GL_M1_D2
for (row = 0; row < 64; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rws_64x512.ram_Inst_64X224_0_288.mem_write(row - 0, shadow_mem[row][511:288]);
shadow_written = 'b0;
end
endtask
`endif
...
// probing RAMPDP_64X288_GL_M1_D2
 if (row >= 0 && row < 64) data[287:0] = r_nv_ram_rws_64x512.ram_Inst_64X288_0_0.mem_read(row - 0);
// probing RAMPDP_64X224_GL_M1_D2
 if (row >= 0 && row < 64) data[511:288] = r_nv_ram_rws_64x512.ram_Inst_64X224_0_288.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
