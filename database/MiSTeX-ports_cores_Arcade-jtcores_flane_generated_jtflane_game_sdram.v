...
// jtflane_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
parameter GFX_OFFSET = `GFX_START >>1;
parameter PCM0_OFFSET = `PCM0_START>>1;
parameter PCM1_OFFSET = `PCM1_START>>1;
...
jtframe_rom_6slots #(
    ...
    .SLOT1_DW( 8), 
    // pcmb
    .SLOT2_OFFSET(PCM0_OFFSET[21:0]),
    .SLOT2_AW(17),
    .SLOT2_DW( 8), 
    // pcmc
    .SLOT3_OFFSET(PCM1_OFFSET[21:0]),
    .SLOT3_AW(19),
    .SLOT3_DW( 8), 
    // pcmd
    .SLOT4_OFFSET(PCM1_OFFSET[21:0]),
    .SLOT4_AW(19),
    .SLOT4_DW( 8), 
    // main
    .SLOT5_AW(17),
...
`endif
    ...
    .slot5_addr  ( main_addr  ),
    .slot5_dout  ( main_data  ),
    .slot5_cs    ( main_cs    ),
    .slot5_ok    ( main_ok    ),
...
// 12000000 = 24000000*1/2 Hz from clk24
`ifdef VERILATOR_KEEP_CEN /* verilator tracing_on */ `else /* verilator tracing_off */ `endif
jtframe_gated_cen #(.W(4),.NUM(1),.DEN(2),.MFREQ(24000)) u_cen0_clk24(
    .rst    ( rst          ),
    .clk    ( clk24 ),
    .busy   ( 1'b0    ),
...
jtframe_rcmix #(
    ...
    .ch4    ( 16'd0 ),
    .ch5    ( 16'd0 ),
    .p0     ( 16'h0092), // 17233 Hz, 0 Hz 
    .p1     ( 16'h0092), // 17233 Hz, 0 Hz 
    .p2     ( 16'h0), 
    .p3     ( 16'h0), 
    .p4     ( 16'h0), 
    .p5     ( 16'h0), 
