...
// nv_ram_rws_128x32: synthesizable model core
...
module nv_ram_rws_128x32_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMPDP_128X32_GL_M2_D2 (RamCell)
...
// ----------------- begin Ram Cell RAMPDP_128X32_GL_M2_D2 -------------
// Write Port Stuff -----
...
RAMPDP_128X32_GL_M2_D2 ram_Inst_128X32 (
                                          .CLK (gated_clk_core)
                                        , .WADR_6 (wa_0_0[6])
                                        , .WADR_5 (wa_0_0[5])
                                        , .WADR_4 (wa_0_0[4])
...
//For bitEnd 31, only one piece RAMPDP_128X32_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_0[31:0] or Data_reg_r0[31:0] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[31:0] = (ram_bypass) ? Data_reg_r0[31:0]: dout_0_0;
end
assign r0_OutputMuxDataOut[31:0] = ram_r0_OutputMuxDataOut[31:0];
// verilint 17 on - Range (rather than full vector) in the sensitivity list
// --------------------- Output Mbist Interface logic -------------
// new mux in front of the data register
reg [32-1:0] muxed_Data_r0;
wire [32-1:0] muxed_Data_A, muxed_Data_B;
wire muxed_Data_S;
...
always @(muxed_Data_S or muxed_Data_A or muxed_Data_B)
  case(muxed_Data_S) // synopsys infer_mux
    ...
    default : muxed_Data_r0 = {32{`tick_x_or_0}};
  endcase
reg mbist_ce_r0_1p;
...
ScanShareSel_JTAG_reg_ext_cg #(32, 0, 0) testInst_Data_reg_r0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(muxed_Data_r0[31:0]), .Q(data_regq[31:0]),
