...
`endif
	...
	wire [26:0] sub_wire0;
	wire [107:0] sub_wire1;
	wire [26:0] shiftout = sub_wire0[26:0];
	wire [107:81] sub_wire7 = sub_wire1[107:81];
	wire [80:54] sub_wire6 = sub_wire1[80:54];
	wire [80:54] sub_wire5 = sub_wire6[80:54];
	wire [53:27] sub_wire4 = sub_wire1[53:27];
	wire [53:27] sub_wire3 = sub_wire4[53:27];
	wire [26:0] sub_wire2 = sub_wire1[26:0];
	wire [26:0] taps0x = sub_wire2[26:0];
	wire [26:0] taps1x = sub_wire3[53:27];
	wire [26:0] taps2x = sub_wire5[80:54];
	wire [26:0] taps3x = sub_wire7[107:81];
	...
	defparam
		...
		ALTSHIFT_TAPS_component.tap_distance = 960,
		ALTSHIFT_TAPS_component.width = 27;
