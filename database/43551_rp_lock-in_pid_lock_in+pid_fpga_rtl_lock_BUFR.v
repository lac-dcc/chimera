...
module BUFR (O, CE, CLR, I);
	...
	endcase // case(BUFR_DIVIDE)
           ...
           "VIRTEX5" : ;
            default : begin 
                          $display("Attribute Syntax Error : The attribute SIM_DEVICE on BUFR instance %m is set to %s.  Legal values for this attribute are VIRTEX4 or VIRTEX5.", SIM_DEVICE);
                 $finish;
            end
        endcase 
    end // initial begin
    ...
    assign ce_en = (SIM_DEVICE == "VIRTEX5") ? ce_in :  ce_enable4;
