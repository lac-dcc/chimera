...
// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/unisims/RAMB16_S2_S9.v,v 1.10 2007/02/22 01:58:06 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
//		6'b101010 : begin data_collision_b_a <= 2'b00; display_wa_rb; end
	...
	if (ena_int == 1'b1) begin
		...
		if (wea_int == 1'b1) begin
			...
			doa_out <= #100 mem[addra_int[12:2]][addra_int[1:0] * 2 +: 2];
	    ...
	    // memory
	    if (wea_int == 1'b1) begin
		mem[addra_int[12:2]][addra_int[1:0] * 2 +: 2] <= dia_int;
	    end
