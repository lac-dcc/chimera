...
// This wrapper consists of : 1 Ram cells: RAMPDP_64X130_GL_M1_D2 ;
...
nv_ram_rwsp_64x129_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rwsp_64x129 (
...
wire [128:0] shadow_mem_row32 = shadow_mem[32];
wire [128:0] shadow_mem_row33 = shadow_mem[33];
wire [128:0] shadow_mem_row34 = shadow_mem[34];
wire [128:0] shadow_mem_row35 = shadow_mem[35];
wire [128:0] shadow_mem_row36 = shadow_mem[36];
wire [128:0] shadow_mem_row37 = shadow_mem[37];
wire [128:0] shadow_mem_row38 = shadow_mem[38];
wire [128:0] shadow_mem_row39 = shadow_mem[39];
wire [128:0] shadow_mem_row40 = shadow_mem[40];
wire [128:0] shadow_mem_row41 = shadow_mem[41];
wire [128:0] shadow_mem_row42 = shadow_mem[42];
wire [128:0] shadow_mem_row43 = shadow_mem[43];
wire [128:0] shadow_mem_row44 = shadow_mem[44];
wire [128:0] shadow_mem_row45 = shadow_mem[45];
wire [128:0] shadow_mem_row46 = shadow_mem[46];
wire [128:0] shadow_mem_row47 = shadow_mem[47];
wire [128:0] shadow_mem_row48 = shadow_mem[48];
wire [128:0] shadow_mem_row49 = shadow_mem[49];
wire [128:0] shadow_mem_row50 = shadow_mem[50];
wire [128:0] shadow_mem_row51 = shadow_mem[51];
wire [128:0] shadow_mem_row52 = shadow_mem[52];
wire [128:0] shadow_mem_row53 = shadow_mem[53];
wire [128:0] shadow_mem_row54 = shadow_mem[54];
wire [128:0] shadow_mem_row55 = shadow_mem[55];
wire [128:0] shadow_mem_row56 = shadow_mem[56];
wire [128:0] shadow_mem_row57 = shadow_mem[57];
wire [128:0] shadow_mem_row58 = shadow_mem[58];
wire [128:0] shadow_mem_row59 = shadow_mem[59];
wire [128:0] shadow_mem_row60 = shadow_mem[60];
wire [128:0] shadow_mem_row61 = shadow_mem[61];
wire [128:0] shadow_mem_row62 = shadow_mem[62];
wire [128:0] shadow_mem_row63 = shadow_mem[63];
`endif
task init_mem_val;
  input [5:0] row;
  input [128:0] data;
...
integer row;
begin
// initializing RAMPDP_64X130_GL_M1_D2
for (row = 0; row < 64; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rwsp_64x129.ram_Inst_64X130.mem_write(row - 0, shadow_mem[row][128:0]);
shadow_written = 'b0;
end
endtask
`endif
...
reg [128:0] data;
begin
// probing RAMPDP_64X130_GL_M1_D2
 if (row >= 0 && row < 64) data[128:0] = r_nv_ram_rwsp_64x129.ram_Inst_64X130.mem_read(row - 0);
    probe_mem_val = data;
end
endfunction
`endif
...
integer bitnum;
begin
  random_num = rflip.rollpli(0, 8256);
  row = random_num / 129;
