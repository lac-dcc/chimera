// This program was cloned from: https://github.com/vortexgpgpu/skybox
...
//       
//       Creation Date:  Mon Nov 11 12:01:08 2019
//       Version: 	r4p0
//
...
module datapath_latch_rf2_32x19_wm0 (CLK,Q_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_rf2_32x19_wm0
...
`endif
  ...
  datapath_latch_rf2_32x19_wm0 uDQA0 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[1]), .D(QA_int[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[0]), .XQ(XQA), .Q(QA_int[0]));
  datapath_latch_rf2_32x19_wm0 uDQA1 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[2]), .D(QA_int[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[1]), .XQ(XQA), .Q(QA_int[1]));
  datapath_latch_rf2_32x19_wm0 uDQA2 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[3]), .D(QA_int[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[2]), .XQ(XQA), .Q(QA_int[2]));
  datapath_latch_rf2_32x19_wm0 uDQA3 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[4]), .D(QA_int[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[3]), .XQ(XQA), .Q(QA_int[3]));
  datapath_latch_rf2_32x19_wm0 uDQA4 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[5]), .D(QA_int[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[4]), .XQ(XQA), .Q(QA_int[4]));
  datapath_latch_rf2_32x19_wm0 uDQA5 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[6]), .D(QA_int[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[5]), .XQ(XQA), .Q(QA_int[5]));
  datapath_latch_rf2_32x19_wm0 uDQA6 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[7]), .D(QA_int[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[6]), .XQ(XQA), .Q(QA_int[6]));
  datapath_latch_rf2_32x19_wm0 uDQA7 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[8]), .D(QA_int[8]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[7]), .XQ(XQA), .Q(QA_int[7]));
  datapath_latch_rf2_32x19_wm0 uDQA8 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(SIA_int[0]), .D(1'b0), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[8]), .XQ(XQA), .Q(QA_int[8]));
  datapath_latch_rf2_32x19_wm0 uDQA9 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(SIA_int[1]), .D(1'b0), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[9]), .XQ(XQA), .Q(QA_int[9]));
  datapath_latch_rf2_32x19_wm0 uDQA10 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[9]), .D(QA_int[9]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[10]), .XQ(XQA), .Q(QA_int[10]));
  datapath_latch_rf2_32x19_wm0 uDQA11 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[10]), .D(QA_int[10]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[11]), .XQ(XQA), .Q(QA_int[11]));
  datapath_latch_rf2_32x19_wm0 uDQA12 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[11]), .D(QA_int[11]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[12]), .XQ(XQA), .Q(QA_int[12]));
  datapath_latch_rf2_32x19_wm0 uDQA13 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[12]), .D(QA_int[12]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[13]), .XQ(XQA), .Q(QA_int[13]));
  datapath_latch_rf2_32x19_wm0 uDQA14 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[13]), .D(QA_int[13]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[14]), .XQ(XQA), .Q(QA_int[14]));
  datapath_latch_rf2_32x19_wm0 uDQA15 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[14]), .D(QA_int[14]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[15]), .XQ(XQA), .Q(QA_int[15]));
  datapath_latch_rf2_32x19_wm0 uDQA16 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[15]), .D(QA_int[15]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[16]), .XQ(XQA), .Q(QA_int[16]));
  datapath_latch_rf2_32x19_wm0 uDQA17 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[16]), .D(QA_int[16]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[17]), .XQ(XQA), .Q(QA_int[17]));
  datapath_latch_rf2_32x19_wm0 uDQA18 (.CLK(CLKA), .Q_update(QA_update), .SE(SEA_), .SI(QA_int[17]), .D(QA_int[17]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[18]), .XQ(XQA), .Q(QA_int[18]));
...
`endif
  ...
  datapath_latch_rf2_32x19_wm0 uDQB0 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[1]), .D(DB_int_bmux[0]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[0]), .XQ(XDB_sh), .Q(DB_int_sh[0]));
  datapath_latch_rf2_32x19_wm0 uDQB1 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[2]), .D(DB_int_bmux[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[1]), .XQ(XDB_sh), .Q(DB_int_sh[1]));
  datapath_latch_rf2_32x19_wm0 uDQB2 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[3]), .D(DB_int_bmux[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[2]), .XQ(XDB_sh), .Q(DB_int_sh[2]));
  datapath_latch_rf2_32x19_wm0 uDQB3 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[4]), .D(DB_int_bmux[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[3]), .XQ(XDB_sh), .Q(DB_int_sh[3]));
  datapath_latch_rf2_32x19_wm0 uDQB4 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[5]), .D(DB_int_bmux[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[4]), .XQ(XDB_sh), .Q(DB_int_sh[4]));
  datapath_latch_rf2_32x19_wm0 uDQB5 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[6]), .D(DB_int_bmux[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[5]), .XQ(XDB_sh), .Q(DB_int_sh[5]));
  datapath_latch_rf2_32x19_wm0 uDQB6 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[7]), .D(DB_int_bmux[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[6]), .XQ(XDB_sh), .Q(DB_int_sh[6]));
  datapath_latch_rf2_32x19_wm0 uDQB7 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[8]), .D(DB_int_bmux[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[7]), .XQ(XDB_sh), .Q(DB_int_sh[7]));
  datapath_latch_rf2_32x19_wm0 uDQB8 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(SIB_[0]), .D(DB_int_bmux[8]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[8]), .XQ(XDB_sh), .Q(DB_int_sh[8]));
  datapath_latch_rf2_32x19_wm0 uDQB9 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(SIB_[1]), .D(DB_int_bmux[9]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[9]), .XQ(XDB_sh), .Q(DB_int_sh[9]));
  datapath_latch_rf2_32x19_wm0 uDQB10 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[9]), .D(DB_int_bmux[10]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[10]), .XQ(XDB_sh), .Q(DB_int_sh[10]));
  datapath_latch_rf2_32x19_wm0 uDQB11 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[10]), .D(DB_int_bmux[11]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[11]), .XQ(XDB_sh), .Q(DB_int_sh[11]));
  datapath_latch_rf2_32x19_wm0 uDQB12 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[11]), .D(DB_int_bmux[12]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[12]), .XQ(XDB_sh), .Q(DB_int_sh[12]));
  datapath_latch_rf2_32x19_wm0 uDQB13 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[12]), .D(DB_int_bmux[13]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[13]), .XQ(XDB_sh), .Q(DB_int_sh[13]));
  datapath_latch_rf2_32x19_wm0 uDQB14 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[13]), .D(DB_int_bmux[14]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[14]), .XQ(XDB_sh), .Q(DB_int_sh[14]));
  datapath_latch_rf2_32x19_wm0 uDQB15 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[14]), .D(DB_int_bmux[15]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[15]), .XQ(XDB_sh), .Q(DB_int_sh[15]));
  datapath_latch_rf2_32x19_wm0 uDQB16 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[15]), .D(DB_int_bmux[16]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[16]), .XQ(XDB_sh), .Q(DB_int_sh[16]));
  datapath_latch_rf2_32x19_wm0 uDQB17 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[16]), .D(DB_int_bmux[17]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[17]), .XQ(XDB_sh), .Q(DB_int_sh[17]));
  datapath_latch_rf2_32x19_wm0 uDQB18 (.CLK(CLKB), .Q_update(DB_sh_update), .SE(SEB_), .SI(DB_int_sh[17]), .D(DB_int_bmux[18]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(DB_int_bmux[18]), .XQ(XDB_sh), .Q(DB_int_sh[18]));
...
`endif
  ...
  reg NOT_AB2, NOT_AB1, NOT_AB0, NOT_DB18, NOT_DB17, NOT_DB16, NOT_DB15, NOT_DB14;
  ...
  reg NOT_EMASA, NOT_EMAB2, NOT_EMAB1, NOT_EMAB0, NOT_TENA, NOT_TCENA, NOT_TAA4, NOT_TAA3;
  reg NOT_TAA2, NOT_TAA1, NOT_TAA0, NOT_TENB, NOT_TCENB, NOT_TAB4, NOT_TAB3, NOT_TAB2;
  reg NOT_TAB1, NOT_TAB0, NOT_TDB18, NOT_TDB17, NOT_TDB16, NOT_TDB15, NOT_TDB14, NOT_TDB13;
  reg NOT_TDB12, NOT_TDB11, NOT_TDB10, NOT_TDB9, NOT_TDB8, NOT_TDB7, NOT_TDB6, NOT_TDB5;
  reg NOT_TDB4, NOT_TDB3, NOT_TDB2, NOT_TDB1, NOT_TDB0, NOT_SIA1, NOT_SIA0, NOT_SEA;
  reg NOT_DFTRAMBYP_CLKA, NOT_DFTRAMBYP_CLKB, NOT_RET1N, NOT_SIB1, NOT_SIB0, NOT_SEB;
  reg NOT_COLLDISN;
 ...
 wire  CLKB_;
  ...
  buf B8(AYB[1], AYB_[1]);
  buf B9(AYB[2], AYB_[2]);
  buf B10(AYB[3], AYB_[3]);
  buf B11(AYB[4], AYB_[4]);
  buf B12(QA[0], QA_[0]);
  buf B13(QA[1], QA_[1]);
  buf B14(QA[2], QA_[2]);
  buf B15(QA[3], QA_[3]);
  ...
  buf B20(QA[8], QA_[8]);
  buf B21(QA[9], QA_[9]);
  buf B22(QA[10], QA_[10]);
  buf B23(QA[11], QA_[11]);
  buf B24(QA[12], QA_[12]);
  buf B25(QA[13], QA_[13]);
  buf B26(QA[14], QA_[14]);
  buf B27(QA[15], QA_[15]);
  buf B28(QA[16], QA_[16]);
  buf B29(QA[17], QA_[17]);
  buf B30(QA[18], QA_[18]);
  buf B31(SOA[0], SOA_[0]);
  buf B32(SOA[1], SOA_[1]);
  buf B33(SOB[0], SOB_[0]);
  buf B34(SOB[1], SOB_[1]);
  buf B35(CLKA_, CLKA);
  buf B36(CENA_, CENA);
  buf B37(AA_[0], AA[0]);
  buf B38(AA_[1], AA[1]);
  ...
  buf B57(DB_[8], DB[8]);
  buf B58(DB_[9], DB[9]);
  buf B59(DB_[10], DB[10]);
  buf B60(DB_[11], DB[11]);
  buf B61(DB_[12], DB[12]);
  buf B62(DB_[13], DB[13]);
  buf B63(DB_[14], DB[14]);
  buf B64(DB_[15], DB[15]);
  buf B65(DB_[16], DB[16]);
  buf B66(DB_[17], DB[17]);
  buf B67(DB_[18], DB[18]);
  buf B68(EMAA_[0], EMAA[0]);
  buf B69(EMAA_[1], EMAA[1]);
  buf B70(EMAA_[2], EMAA[2]);
  buf B71(EMASA_, EMASA);
  buf B72(EMAB_[0], EMAB[0]);
  buf B73(EMAB_[1], EMAB[1]);
  buf B74(EMAB_[2], EMAB[2]);
  buf B75(TENA_, TENA);
  buf B76(TCENA_, TCENA);
  buf B77(TAA_[0], TAA[0]);
  buf B78(TAA_[1], TAA[1]);
  buf B79(TAA_[2], TAA[2]);
  buf B80(TAA_[3], TAA[3]);
  buf B81(TAA_[4], TAA[4]);
  buf B82(TENB_, TENB);
  buf B83(TCENB_, TCENB);
  buf B84(TAB_[0], TAB[0]);
  buf B85(TAB_[1], TAB[1]);
  buf B86(TAB_[2], TAB[2]);
  buf B87(TAB_[3], TAB[3]);
  buf B88(TAB_[4], TAB[4]);
  buf B89(TDB_[0], TDB[0]);
  buf B90(TDB_[1], TDB[1]);
  buf B91(TDB_[2], TDB[2]);
  buf B92(TDB_[3], TDB[3]);
  buf B93(TDB_[4], TDB[4]);
  buf B94(TDB_[5], TDB[5]);
  buf B95(TDB_[6], TDB[6]);
  buf B96(TDB_[7], TDB[7]);
  buf B97(TDB_[8], TDB[8]);
  buf B98(TDB_[9], TDB[9]);
  buf B99(TDB_[10], TDB[10]);
  buf B100(TDB_[11], TDB[11]);
  buf B101(TDB_[12], TDB[12]);
  buf B102(TDB_[13], TDB[13]);
  buf B103(TDB_[14], TDB[14]);
  buf B104(TDB_[15], TDB[15]);
  buf B105(TDB_[16], TDB[16]);
  buf B106(TDB_[17], TDB[17]);
  buf B107(TDB_[18], TDB[18]);
  buf B108(RET1N_, RET1N);
  buf B109(SIA_[0], SIA[0]);
  buf B110(SIA_[1], SIA[1]);
  buf B111(SEA_, SEA);
  buf B112(DFTRAMBYP_, DFTRAMBYP);
  buf B113(SIB_[0], SIB[0]);
  buf B114(SIB_[1], SIB[1]);
  buf B115(SEB_, SEB);
  buf B116(COLLDISN_, COLLDISN);
...
`endif
 ...
 wire  CLKB_;
  ...
  buf B117(CENYA, CENYA_);
  buf B118(AYA[0], AYA_[0]);
  buf B119(AYA[1], AYA_[1]);
  buf B120(AYA[2], AYA_[2]);
  buf B121(AYA[3], AYA_[3]);
  buf B122(AYA[4], AYA_[4]);
  buf B123(CENYB, CENYB_);
  buf B124(AYB[0], AYB_[0]);
  buf B125(AYB[1], AYB_[1]);
  buf B126(AYB[2], AYB_[2]);
  buf B127(AYB[3], AYB_[3]);
  buf B128(AYB[4], AYB_[4]);
  buf B129(QA[0], QA_[0]);
  buf B130(QA[1], QA_[1]);
  buf B131(QA[2], QA_[2]);
  buf B132(QA[3], QA_[3]);
  ...
  buf B137(QA[8], QA_[8]);
  buf B138(QA[9], QA_[9]);
  buf B139(QA[10], QA_[10]);
  buf B140(QA[11], QA_[11]);
  buf B141(QA[12], QA_[12]);
  buf B142(QA[13], QA_[13]);
  buf B143(QA[14], QA_[14]);
  buf B144(QA[15], QA_[15]);
  buf B145(QA[16], QA_[16]);
  buf B146(QA[17], QA_[17]);
  buf B147(QA[18], QA_[18]);
  buf B148(SOA[0], SOA_[0]);
  buf B149(SOA[1], SOA_[1]);
  buf B150(SOB[0], SOB_[0]);
  buf B151(SOB[1], SOB_[1]);
  buf B152(CLKA_, CLKA);
  buf B153(CENA_, CENA);
  buf B154(AA_[0], AA[0]);
  buf B155(AA_[1], AA[1]);
  ...
  buf B174(DB_[8], DB[8]);
  buf B175(DB_[9], DB[9]);
  buf B176(DB_[10], DB[10]);
  buf B177(DB_[11], DB[11]);
  buf B178(DB_[12], DB[12]);
  buf B179(DB_[13], DB[13]);
  buf B180(DB_[14], DB[14]);
  buf B181(DB_[15], DB[15]);
  buf B182(DB_[16], DB[16]);
  buf B183(DB_[17], DB[17]);
  buf B184(DB_[18], DB[18]);
  buf B185(EMAA_[0], EMAA[0]);
  buf B186(EMAA_[1], EMAA[1]);
  buf B187(EMAA_[2], EMAA[2]);
  buf B188(EMASA_, EMASA);
  buf B189(EMAB_[0], EMAB[0]);
  buf B190(EMAB_[1], EMAB[1]);
  buf B191(EMAB_[2], EMAB[2]);
  buf B192(TENA_, TENA);
  buf B193(TCENA_, TCENA);
  buf B194(TAA_[0], TAA[0]);
  buf B195(TAA_[1], TAA[1]);
  buf B196(TAA_[2], TAA[2]);
  buf B197(TAA_[3], TAA[3]);
  buf B198(TAA_[4], TAA[4]);
  buf B199(TENB_, TENB);
  buf B200(TCENB_, TCENB);
  buf B201(TAB_[0], TAB[0]);
  buf B202(TAB_[1], TAB[1]);
  buf B203(TAB_[2], TAB[2]);
  buf B204(TAB_[3], TAB[3]);
  buf B205(TAB_[4], TAB[4]);
  buf B206(TDB_[0], TDB[0]);
  buf B207(TDB_[1], TDB[1]);
  buf B208(TDB_[2], TDB[2]);
  buf B209(TDB_[3], TDB[3]);
  buf B210(TDB_[4], TDB[4]);
  buf B211(TDB_[5], TDB[5]);
  buf B212(TDB_[6], TDB[6]);
  buf B213(TDB_[7], TDB[7]);
  buf B214(TDB_[8], TDB[8]);
  buf B215(TDB_[9], TDB[9]);
  buf B216(TDB_[10], TDB[10]);
  buf B217(TDB_[11], TDB[11]);
  buf B218(TDB_[12], TDB[12]);
  buf B219(TDB_[13], TDB[13]);
  buf B220(TDB_[14], TDB[14]);
  buf B221(TDB_[15], TDB[15]);
  buf B222(TDB_[16], TDB[16]);
  buf B223(TDB_[17], TDB[17]);
  buf B224(TDB_[18], TDB[18]);
  buf B225(RET1N_, RET1N);
  buf B226(SIA_[0], SIA[0]);
  buf B227(SIA_[1], SIA[1]);
  buf B228(SEA_, SEA);
  buf B229(DFTRAMBYP_, DFTRAMBYP);
  buf B230(SIB_[0], SIB[0]);
  buf B231(SIB_[1], SIB[1]);
  buf B232(SEB_, SEB);
  buf B233(COLLDISN_, COLLDISN);
  ...
  assign AYB_ = (RET1N_ | pre_charge_st) ? ({5{DFTRAMBYP_}} & (TENB_ ? AB_ : TAB_)) : {5{1'bx}};
   `ifdef ARM_FAULT_MODELING
     rf2_32x19_wm0_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .DFTRAMBYP(DFTRAMBYP_int), .SE(SEA_int), .Q_in(QA_int));
  `else
  assign QA_ = (RET1N_ | pre_charge_st) ? ((QA_int)) : {19{1'bx}};
  `endif
  assign SOA_ = (RET1N_ | pre_charge_st) ? ({QA_[18], QA_[0]}) : {2{1'bx}};
...
`endif
`timescale 1ns/1ps
module rf2_32x19_wm0_error_injection (Q_out, Q_in, CLK, A, CEN, DFTRAMBYP, SE);
   output [18:0] Q_out;
   input [18:0] Q_in;
   input CLK;
   input [4:0] A;
...
begin
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.SMARCHCHKBVCD_LVISION_MBISTPG_ASSEMBLY_UNDER_TEST_INST.MEM0_MEM_INST.u1.add_fault(5'd10,5'd15,2'd1,2'd0);
   `endif
end
   task add_fault;
