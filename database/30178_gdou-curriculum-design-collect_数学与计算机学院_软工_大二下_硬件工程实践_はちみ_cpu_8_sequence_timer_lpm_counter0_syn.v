...
//lpm_counter DEVICE_FAMILY="Stratix II" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_svalue=0 lpm_width=2 clock q sset
...
`endif
	...
	wire  [1:0]   wire_counter_reg_bit1a_adatasdata;
	wire  [1:0]   wire_counter_reg_bit1a_regout;
	wire  aclr_actual;
	wire clk_en;
	wire cnt_en;
	wire [1:0]  data;
	...
	assign
		wire_counter_reg_bit1a_adatasdata = (({2{sset}} & s_val) | ({2{(~ sset)}} & data));
	assign
		aclr_actual = 1'b0,
		clk_en = 1'b1,
		cnt_en = 1'b1,
