...
// jtkunio_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
wire [31:0] obj_data;
wire        obj_cs, obj_ok;
wire [10:2] dummy_addr;
wire [31:0] dummy_data;
wire        dummy_cs, dummy_ok;
wire        prom_we, header;
...
`endif
    ...
    .slot1_addr  ( { dummy_addr, 1'b0 } ),
    .slot1_dout  ( dummy_data  ),
    .slot1_cs    ( dummy_cs    ),
    .slot1_ok    ( dummy_ok    ),
...
jtframe_bram_rom #(
    .AW(11),.DW(8),
    .OFFSET((`MCU_START)>>1),.SIMFILE("mcu.bin")
) u_brom_mcu(
    .clk    ( clk       ),
    // Read port
    .addr   ( mcu_addr ),
