...
//lpm_add_sub DEVICE_FAMILY="Stratix II" LPM_DIRECTION="SUB" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=8 ONE_INPUT_IS_CONSTANT="NO" dataa datab result
...
module SUB (
	...
	SUB_add_sub	SUB_add_sub_component (
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
