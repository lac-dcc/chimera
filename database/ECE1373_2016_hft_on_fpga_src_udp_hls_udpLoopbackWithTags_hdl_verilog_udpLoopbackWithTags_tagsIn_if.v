...
module udpLoopbackWithTags_tagsIn_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
    ...
    // User signals
    output wire [63:0] tagsIn_V_V_dout,
    output wire        tagsIn_V_V_empty_n,
    input  wire        tagsIn_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [63:0] tagsIn_V_V_din;
wire [0:0]  tagsIn_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [63:0] s_data;
...
//------------------------Instantiation------------------
// rs
udpLoopbackWithTags_tagsIn_reg_slice #(
    .N       ( 64 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// tagsIn_V_V_fifo
udpLoopbackWithTags_tagsIn_fifo #(
    .DATA_BITS  ( 64 ),
    .DEPTH_BITS ( 4 )
) tagsIn_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( tagsIn_V_V_empty_n ),
    .full_n     ( tagsIn_V_V_full_n ),
    .read       ( tagsIn_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( tagsIn_V_V_dout ),
    .din        ( tagsIn_V_V_din )
);
...
assign tagsIn_V_V_din = m_data[63:0];
assign fifo_full_n    = tagsIn_V_V_full_n;
...
module udpLoopbackWithTags_tagsIn_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module udpLoopbackWithTags_tagsIn_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
