...
//////////////////////////////////////////////////////////////////////////////////
// PE_ELU_eMAXodr.v for Cosmos OpenSSD
...
// Module Name: PE_ELU_eMAXodr
// File Name: PE_ELU_eMAXodr.v
//
...
module PE_ELU_eMAXodr( // error locate update module: maximum order + 1 (extended)
	clk,
	nRESET_KES,
	...
	begin
		if (!nRESET_KES) begin // initializing
			...
			PE_ELU_OUT: begin // output update only
				...
				v_2i_X[GF_ORDER-1:0] <= v_2ip2_X[GF_ORDER-1:0]; // internal only
