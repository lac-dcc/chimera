...
module udpLoopbackWithTags_lbTxLengthOut_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [15:0] lbTxLengthOut_V_V_din,
    output wire        lbTxLengthOut_V_V_full_n,
    input  wire        lbTxLengthOut_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
...
wire [0:0]  lbTxLengthOut_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [15:0] s_data;
...
//------------------------Instantiation------------------
// rs
udpLoopbackWithTags_lbTxLengthOut_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// lbTxLengthOut_V_V_fifo
udpLoopbackWithTags_lbTxLengthOut_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) lbTxLengthOut_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( lbTxLengthOut_V_V_empty_n ),
    .full_n     ( lbTxLengthOut_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( lbTxLengthOut_V_V_write ),
    .dout       ( lbTxLengthOut_V_V_dout ),
    .din        ( lbTxLengthOut_V_V_din )
);
...
assign s_data  = {lbTxLengthOut_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = lbTxLengthOut_V_V_empty_n;
...
module udpLoopbackWithTags_lbTxLengthOut_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module udpLoopbackWithTags_lbTxLengthOut_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
