...
module echo_server_application_s_axis_rx_metadata_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
...
//------------------------Instantiation------------------
// rs
echo_server_application_s_axis_rx_metadata_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// rxMetaData_V_V_fifo
echo_server_application_s_axis_rx_metadata_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) rxMetaData_V_V_fifo (
    .clk        ( ACLK ),
...
module echo_server_application_s_axis_rx_metadata_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module echo_server_application_s_axis_rx_metadata_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
