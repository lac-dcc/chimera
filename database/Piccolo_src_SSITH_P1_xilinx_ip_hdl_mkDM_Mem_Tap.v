...
module mkDM_Mem_Tap(CLK,
  ...
  reg [1 : 0] sz__h1638;
  wire [63 : 0] stval__h1627, x__h1768;
  wire [31 : 0] x__h1702;
  ...
  // remaining internal signals
  assign stval__h1627 = x__h1768 & y__h1769 ;
  assign x__h1702 = { 30'd0, sz__h1638 } ;
  assign x__h1768 =
  ...
  begin
    case (slave_xactor_f_wr_data$D_OUT[8:1])
	  ...
	  y__h1769 = 64'h00000000000000FF;
      8'h03, 8'h0C, 8'h30, 8'hC0: y__h1769 = 64'h000000000000FFFF;
      8'h0F, 8'hF0: y__h1769 = 64'h00000000FFFFFFFF;
      8'hFF: y__h1769 = 64'hFFFFFFFFFFFFFFFF;
      default: y__h1769 = 64'd0;
    endcase
  end
