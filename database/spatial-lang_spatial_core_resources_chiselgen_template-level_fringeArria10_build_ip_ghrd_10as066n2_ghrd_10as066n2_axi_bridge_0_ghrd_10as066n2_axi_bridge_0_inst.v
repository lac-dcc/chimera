...
// License: MIT License
	...
	ghrd_10as066n2_axi_bridge_0 #(
		...
		.m0_awid     (_connected_to_m0_awid_),     //  output,    width = 3,        m0.awid
		.m0_awaddr   (_connected_to_m0_awaddr_),   //  output,   width = 32,          .awaddr
		...
		.m0_awqos    (_connected_to_m0_awqos_),    //  output,    width = 4,          .awqos
		.m0_awregion (_connected_to_m0_awregion_), //  output,    width = 4,          .awregion
		.m0_awvalid  (_connected_to_m0_awvalid_),  //  output,    width = 1,          .awvalid
		.m0_awready  (_connected_to_m0_awready_),  //   input,    width = 1,          .awready
		.m0_wdata    (_connected_to_m0_wdata_),    //  output,  width = 512,          .wdata
		.m0_wstrb    (_connected_to_m0_wstrb_),    //  output,   width = 64,          .wstrb
		...
		.m0_bid      (_connected_to_m0_bid_),      //   input,    width = 3,          .bid
		...
		.m0_arid     (_connected_to_m0_arid_),     //  output,    width = 3,          .arid
		.m0_araddr   (_connected_to_m0_araddr_),   //  output,   width = 32,          .araddr
		...
		.m0_arqos    (_connected_to_m0_arqos_),    //  output,    width = 4,          .arqos
		.m0_arregion (_connected_to_m0_arregion_), //  output,    width = 4,          .arregion
		.m0_arvalid  (_connected_to_m0_arvalid_),  //  output,    width = 1,          .arvalid
		.m0_arready  (_connected_to_m0_arready_),  //   input,    width = 1,          .arready
		.m0_rid      (_connected_to_m0_rid_),      //   input,    width = 3,          .rid
		.m0_rdata    (_connected_to_m0_rdata_),    //   input,  width = 512,          .rdata
		...
		.s0_awid     (_connected_to_s0_awid_),     //   input,    width = 6,        s0.awid
		.s0_awaddr   (_connected_to_s0_awaddr_),   //   input,   width = 32,          .awaddr
		...
		.s0_awqos    (_connected_to_s0_awqos_),    //   input,    width = 4,          .awqos
		.s0_awregion (_connected_to_s0_awregion_), //   input,    width = 4,          .awregion
		.s0_awvalid  (_connected_to_s0_awvalid_),  //   input,    width = 1,          .awvalid
		.s0_awready  (_connected_to_s0_awready_),  //  output,    width = 1,          .awready
		.s0_wdata    (_connected_to_s0_wdata_),    //   input,  width = 512,          .wdata
		.s0_wstrb    (_connected_to_s0_wstrb_),    //   input,   width = 64,          .wstrb
		...
		.s0_bid      (_connected_to_s0_bid_),      //  output,    width = 6,          .bid
		...
		.s0_arid     (_connected_to_s0_arid_),     //   input,    width = 6,          .arid
		.s0_araddr   (_connected_to_s0_araddr_),   //   input,   width = 32,          .araddr
		...
		.s0_arqos    (_connected_to_s0_arqos_),    //   input,    width = 4,          .arqos
		.s0_arregion (_connected_to_s0_arregion_), //   input,    width = 4,          .arregion
		.s0_arvalid  (_connected_to_s0_arvalid_),  //   input,    width = 1,          .arvalid
		.s0_arready  (_connected_to_s0_arready_),  //  output,    width = 1,          .arready
		.s0_rid      (_connected_to_s0_rid_),      //  output,    width = 6,          .rid
		.s0_rdata    (_connected_to_s0_rdata_),    //  output,  width = 512,          .rdata
