...
// License: MIT License
    ...
    case (address)
        ...
        37: q_reg <= 1'b0; //  -- M counter: High Count = 48 (8 bit(s))
        38: q_reg <= 1'b0; // 
        39: q_reg <= 1'b1; // 
        40: q_reg <= 1'b1; // 
        41: q_reg <= 1'b0; // 
        ...
        46: q_reg <= 1'b0; //  -- M counter: Low Count = 48 (8 bit(s))
        47: q_reg <= 1'b0; // 
        48: q_reg <= 1'b1; // 
        49: q_reg <= 1'b1; // 
        50: q_reg <= 1'b0; // 
        ...
        55: q_reg <= 1'b0; //  -- clk0 counter: High Count = 5 (8 bit(s))
        56: q_reg <= 1'b0; // 
        57: q_reg <= 1'b0; // 
        58: q_reg <= 1'b0; // 
        59: q_reg <= 1'b0; // 
        ...
        73: q_reg <= 1'b0; //  -- clk1 counter: High Count = 5 (8 bit(s))
        74: q_reg <= 1'b0; // 
        75: q_reg <= 1'b0; // 
        76: q_reg <= 1'b0; // 
        77: q_reg <= 1'b0; // 
