...
`ifndef XIL_XECLIB
  ...
  if (BANDWIDTH_REG === "LOW")
    ...
    case (clkfbout_div)
      ...
      13 :  begin pll_cp = 4'b1110 ; pll_res = 4'b0001 ; end
      14 :  begin pll_cp = 4'b1111 ; pll_res = 4'b0001 ; end
      15 :  begin pll_cp = 4'b1111 ; pll_res = 4'b0001 ; end
      16 :  begin pll_cp = 4'b1111 ; pll_res = 4'b0001 ; end
      17 :  begin pll_cp = 4'b1110 ; pll_res = 4'b0110 ; end
      18 :  begin pll_cp = 4'b1111 ; pll_res = 4'b0110 ; end
      19 :  begin pll_cp = 4'b1110 ; pll_res = 4'b1010 ; end
      20 :  begin pll_cp = 4'b1110 ; pll_res = 4'b1010 ; end
      21 :  begin pll_cp = 4'b1111 ; pll_res = 4'b1010 ; end
      22 :  begin pll_cp = 4'b1111 ; pll_res = 4'b1010 ; end
      23 :  begin pll_cp = 4'b1111 ; pll_res = 4'b1010 ; end
      24 :  begin pll_cp = 4'b1111 ; pll_res = 4'b1010 ; end
      25 :  begin pll_cp = 4'b0111 ; pll_res = 4'b0010 ; end
      26 :  begin pll_cp = 4'b0111 ; pll_res = 4'b0010 ; end
      27 :  begin pll_cp = 4'b1110 ; pll_res = 32'd10; end
      28 :  begin pll_cp = 4'b0110 ; pll_res = 4'b0010 ; end
      29 :  begin pll_cp = 4'b0110 ; pll_res = 4'b0010 ; end
      30 :  begin pll_cp = 4'b0110 ; pll_res = 4'b0010 ; end
      31 :  begin pll_cp = 4'b0100 ; pll_res = 4'b0100 ; end
      32 :  begin pll_cp = 4'b1101 ; pll_res = 4'b0110 ; end
      33 :  begin pll_cp = 4'b1101 ; pll_res = 4'b0110 ; end
      34 :  begin pll_cp = 4'b0101 ; pll_res = 4'b0010 ; end
      35 :  begin pll_cp = 4'b0101 ; pll_res = 4'b0010 ; end
      36 :  begin pll_cp = 4'b0101 ; pll_res = 4'b0010 ; end
    ...
    case (clkfbout_div)
      ...
      25 :  begin pll_cp = 4'b0111 ; pll_res = 4'b0010 ; end
      26 :  begin pll_cp = 4'b0111 ; pll_res = 4'b0010 ; end
      27 :  begin pll_cp = 4'b1110 ; pll_res = 4'b1010 ; end
      28 :  begin pll_cp = 4'b0110  ; pll_res = 4'b0010 ; end
      29 :  begin pll_cp = 4'b0110  ; pll_res = 4'b0010 ; end
      30 :  begin pll_cp = 4'b0110  ; pll_res = 4'b0010 ; end
      31 :  begin pll_cp = 4'b0100  ; pll_res = 4'b0100 ; end
...
//endsimprim_rst_h
  ...
  always @(clkout_en0_tmp) begin
    #1;
    if(clkout_en0_tmp==1'b1 && clkout_en_t==clkout_en_val && clkout_en_val>1) begin
      @(posedge clkpll or negedge clkpll);
      #1;
    end
    clkout_en0_tmp1 = clkout_en0_tmp;
  end
...
`define MMCME3_ADV_FRAC_PRECISION  10
`define MMCME3_ADV_FIXED_WIDTH     32 

// This function takes a fixed point number and rounds it to the nearest
//    fractional precision bit.
function [`MMCME3_ADV_FIXED_WIDTH:1] round_frac
   (
      // Input is (FIXED_WIDTH-FRAC_PRECISION).FRAC_PRECISION fixed point number
      input [`MMCME3_ADV_FIXED_WIDTH:1] decimal,  

      // This describes the precision of the fraction, for example a value
      //    of 1 would modify the fractional so that instead of being a .16
      //    fractional, it would be a .1 (rounded to the nearest 0.5 in turn)
      input [`MMCME3_ADV_FIXED_WIDTH:1] precision 
   );

   begin
   
      // If the fractional precision bit is high then round up
      if( decimal[(`MMCME3_ADV_FRAC_PRECISION-precision)] == 1'b1) begin
         round_frac = decimal + (1'b1 << (`MMCME3_ADV_FRAC_PRECISION-precision));
      end else begin
         round_frac = decimal;
      end
   end
...
function [13:0] mmcm_divider
   ...
   reg [`MMCME3_ADV_FIXED_WIDTH:1]    duty_cycle_fix;
   ...
   reg [`MMCME3_ADV_FIXED_WIDTH:1]    temp;
   ...
   begin
      ...
      duty_cycle_fix = (duty_cycle << `MMCME3_ADV_FRAC_PRECISION) / 100_000;
      ...
      if(divide == 7'h01) begin
         ...
         high_time   = temp[`MMCME3_ADV_FRAC_PRECISION+7:`MMCME3_ADV_FRAC_PRECISION+1]; 
         // If the duty cycle * divide rounded is .5 or greater then this bit
         //    is set.
         w_edge      = temp[`MMCME3_ADV_FRAC_PRECISION]; // comes from round_frac
...
function [10:0] mmcm_phase
   ...
   reg [`MMCME3_ADV_FIXED_WIDTH:1] phase_in_cycles;
   reg [`MMCME3_ADV_FIXED_WIDTH:1] phase_fixed;
   reg [1:0]            mx;
   reg [5:0]            delay_time;
   reg [2:0]            phase_mux;
   ...
   begin
      ...
      // Convert to (FIXED_WIDTH-FRAC_PRECISION).FRAC_PRECISION fixed point
      if(phase < 0) begin
         phase_fixed = ( (phase + 360000) << `MMCME3_ADV_FRAC_PRECISION ) / 1000;
      end else begin
         phase_fixed = ( phase << `MMCME3_ADV_FRAC_PRECISION ) / 1000;
      end
   ...
   mx          =  2'b00; 
   phase_mux      =  temp[`MMCME3_ADV_FRAC_PRECISION:`MMCME3_ADV_FRAC_PRECISION-2];
   delay_time     =  temp[`MMCME3_ADV_FRAC_PRECISION+6:`MMCME3_ADV_FRAC_PRECISION+1];
...
`endif
  ...
  specify
    ...
    (PWRDWN => CLKFBSTOPPED) = (0:0:0, 0:0:0);
    (PWRDWN => CLKINSTOPPED) = (0:0:0, 0:0:0);
