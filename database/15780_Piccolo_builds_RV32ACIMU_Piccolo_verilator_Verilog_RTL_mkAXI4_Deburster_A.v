...
module mkAXI4_Deburster_A(CLK,
  ...
  wire [63 : 0] a_out_araddr__h3071,
		...
		y__h3178,
		y__h3179;
  wire [7 : 0] x__h2368, x__h2875, x__h3362, x__h3581;
  ...
  // register m_rg_last_beat_raddr
  assign m_rg_last_beat_raddr$D_IN = a_out_araddr__h3071 ;
  assign m_rg_last_beat_raddr$EN =
	     CAN_FIRE_RL_m_rl_rd_xaction_master_to_slave ;

  // register m_rg_last_beat_waddr
  assign m_rg_last_beat_waddr$D_IN = a_out_awaddr__h1987 ;
  ...
  assign wrap_mask__h2071 =
	     (burst_len__h2070 <<
	      m_xactor_from_master_f_wr_addr$D_OUT[20:18]) -
	     64'd1 ;
  assign wrap_mask__h3155 =
	     (burst_len__h3154 <<
	      m_xactor_from_master_f_rd_addr$D_OUT[20:18]) -
	     64'd1 ;
  assign x__h2093 = m_rg_last_beat_waddr & y__h2095 ;
  assign x__h2368 = m_rg_w_beat_count + 8'd1 ;
  assign x__h2875 = m_rg_b_beat_count + 8'd1 ;
  assign x__h3177 = m_rg_last_beat_raddr & y__h3179 ;
  assign x__h3362 = m_rg_ar_beat_count + 8'd1 ;
  assign x__h3581 = m_rg_r_beat_count + 8'd1 ;
  assign y__h2094 = addr__h2069 & wrap_mask__h2071 ;
  assign y__h2095 = ~wrap_mask__h2071 ;
  assign y__h3178 = addr__h3153 & wrap_mask__h3155 ;
  assign y__h3179 = ~wrap_mask__h3155 ;
  ...
  begin
    ...
    v__h1463 = v__h1469 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (m_rg_reset) $display("%0d: %m::AXI4_Deburster.rl_reset", v__h1463);
  end
  // synopsys translate_on
