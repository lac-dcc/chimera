...
// Component : VexRiscvLitexSmpCluster_Cc1_Iw32Is4096Iy1_Dw32Ds4096Dy1_ITs4DTs4_Ldw256_Ood
...
module VexRiscvLitexSmpCluster_Cc1_Iw32Is4096Iy1_Dw32Ds4096Dy1_ITs4DTs4_Ldw256_Ood (
  ...
  output     [255:0]  iBridge_dram_wdata_payload_data,
  output     [31:0]   iBridge_dram_wdata_payload_we,
  input               iBridge_dram_rdata_valid,
  output              iBridge_dram_rdata_ready,
  input      [255:0]  iBridge_dram_rdata_payload_data,
  ...
  output     [255:0]  dBridge_dram_wdata_payload_data,
  output     [31:0]   dBridge_dram_wdata_payload_we,
  input               dBridge_dram_rdata_valid,
  output              dBridge_dram_rdata_ready,
  input      [255:0]  dBridge_dram_rdata_payload_data,
...
module BmbToLiteDram_1 (
  ...
  output     [255:0]  io_output_wdata_payload_data,
  output     [31:0]   io_output_wdata_payload_we,
  input               io_output_rdata_valid,
  output              io_output_rdata_ready,
  input      [255:0]  io_output_rdata_payload_data,
  input               debugCd_external_clk,
  input               systemCd_logic_outputReset
);
  wire                _zz_3;
  ...
  wire       [255:0]  io_input_upSizer_io_output_unburstify_io_input_rsp_payload_fragment_data;
  ...
  wire       [4:0]    io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_length;
  wire       [255:0]  io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_data;
  wire       [31:0]   io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_mask;
  ...
  wire       [4:0]    streamFork_2_io_outputs_0_payload_fragment_length;
  wire       [255:0]  streamFork_2_io_outputs_0_payload_fragment_data;
  wire       [31:0]   streamFork_2_io_outputs_0_payload_fragment_mask;
  wire       [8:0]    streamFork_2_io_outputs_0_payload_fragment_context;
  ...
  wire       [4:0]    streamFork_2_io_outputs_1_payload_fragment_length;
  wire       [255:0]  streamFork_2_io_outputs_1_payload_fragment_data;
  wire       [31:0]   streamFork_2_io_outputs_1_payload_fragment_mask;
  wire       [8:0]    streamFork_2_io_outputs_1_payload_fragment_context;
  ...
  wire       [4:0]    streamFork_2_io_outputs_1_thrown_payload_fragment_length;
  wire       [255:0]  streamFork_2_io_outputs_1_thrown_payload_fragment_data;
  wire       [31:0]   streamFork_2_io_outputs_1_thrown_payload_fragment_mask;
  wire       [8:0]    streamFork_2_io_outputs_1_thrown_payload_fragment_context;
  ...
  assign _zz_16 = (streamFork_2_io_outputs_0_payload_fragment_address >>> 5);
  ...
  BmbUpSizerBridge_1 io_input_upSizer (
    ...
    .io_output_rsp_payload_fragment_data       (io_input_upSizer_io_output_unburstify_io_input_rsp_payload_fragment_data[255:0]   ), //i
  ...
  BmbUnburstify_1 io_input_upSizer_io_output_unburstify (
    ...
    .io_input_rsp_payload_fragment_data        (io_input_upSizer_io_output_unburstify_io_input_rsp_payload_fragment_data[255:0]     ), //o
    ...
    .io_output_cmd_payload_fragment_length     (io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_length[4:0]    ), //o
    .io_output_cmd_payload_fragment_data       (io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_data[255:0]    ), //o
    .io_output_cmd_payload_fragment_mask       (io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_mask[31:0]     ), //o
  ...
  StreamFork_1 streamFork_2 (
    ...
    .io_input_payload_fragment_length         (io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_length[4:0]    ), //i
    .io_input_payload_fragment_data           (io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_data[255:0]    ), //i
    .io_input_payload_fragment_mask           (io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_mask[31:0]     ), //i
    .io_input_payload_fragment_context        (io_input_upSizer_io_output_unburstify_io_output_cmd_payload_fragment_context[8:0]   ), //i
    ...
    .io_outputs_0_payload_fragment_length     (streamFork_2_io_outputs_0_payload_fragment_length[4:0]                              ), //o
    .io_outputs_0_payload_fragment_data       (streamFork_2_io_outputs_0_payload_fragment_data[255:0]                              ), //o
    .io_outputs_0_payload_fragment_mask       (streamFork_2_io_outputs_0_payload_fragment_mask[31:0]                               ), //o
    .io_outputs_0_payload_fragment_context    (streamFork_2_io_outputs_0_payload_fragment_context[8:0]                             ), //o
    ...
    .io_outputs_1_payload_fragment_length     (streamFork_2_io_outputs_1_payload_fragment_length[4:0]                              ), //o
    .io_outputs_1_payload_fragment_data       (streamFork_2_io_outputs_1_payload_fragment_data[255:0]                              ), //o
    .io_outputs_1_payload_fragment_mask       (streamFork_2_io_outputs_1_payload_fragment_mask[31:0]                               ), //o
    .io_outputs_1_payload_fragment_context    (streamFork_2_io_outputs_1_payload_fragment_context[8:0]                             ), //o
    .debugCd_external_clk                     (debugCd_external_clk                                                                ), //i
    .systemCd_logic_outputReset               (systemCd_logic_outputReset                                                          )  //i
  );
  StreamFifoLowLatency_1 streamFifoLowLatency_3 (
    ...
    .io_push_payload_data          (streamFork_2_io_outputs_1_payload_fragment_data[255:0]  ), //i
    .io_push_payload_we            (streamFork_2_io_outputs_1_payload_fragment_mask[31:0]   ), //i
  ...
  assign outputCmd_payload_addr = {7'd0, _zz_16};
...
module BmbToLiteDram (
  ...
  assign _zz_14 = (streamFork_2_io_outputs_0_payload_fragment_address >>> 5);
  ...
  assign _zz_8 = (outputCmd_ready && _zz_2);
  assign outputCmd_valid = (streamFork_2_io_outputs_0_valid && _zz_2);
  assign outputCmd_payload_addr = {7'd0, _zz_14};
  assign outputCmd_payload_we = (streamFork_2_io_outputs_0_payload_fragment_opcode == 1'b1);
  assign outputCmd_ready = ((1'b1 && (! outputCmd_m2sPipe_valid)) || outputCmd_m2sPipe_ready);
  assign outputCmd_m2sPipe_valid = outputCmd_m2sPipe_rValid;
  assign outputCmd_m2sPipe_payload_we = outputCmd_m2sPipe_rData_we;
...
module StreamFifo_1 (
  ...
  assign _zz_3 = _zz_4;
  assign io_pop_payload_context = _zz_3[8 : 0];
  assign io_pop_payload_isWrite = _zz_3[9];
...
module StreamFifoLowLatency_1 (
  ...
  input      [31:0]   io_push_payload_we,
  output              io_pop_valid,
  input               io_pop_ready,
  output     [255:0]  io_pop_payload_data,
  output     [31:0]   io_pop_payload_we,
  input               io_flush,
  output     [5:0]    io_occupancy,
  input               debugCd_external_clk,
  input               systemCd_logic_outputReset
  ...
  assign _zz_2 = _zz_3;
  assign io_pop_payload_data = _zz_2[255 : 0];
  assign io_pop_payload_we = _zz_2[287 : 256];
...
module StreamFork_1 (
  ...
  input      [8:0]    io_input_payload_fragment_context,
  ...
  output     [8:0]    io_outputs_0_payload_fragment_context,
  ...
  output     [8:0]    io_outputs_1_payload_fragment_context,
  input               debugCd_external_clk,
  input               systemCd_logic_outputReset
);
  reg                 _zz_1;
...
module BmbUnburstify_1 (
  ...
  assign _zz_4 = (_zz_6 + 12'h020);
  assign _zz_5 = buffer_address[11 : 0];
  assign _zz_6 = _zz_5;
  assign buffer_last = (buffer_beat == 1'b1);
  assign buffer_addressIncr = {buffer_address[29 : 12],(_zz_4 & (~ 12'h01f))};
  ...
  assign rspContext_context = _zz_1[8 : 2];
  always @ (*) begin
...
module BmbUpSizerBridge_1 (
  ...
  assign _zz_3 = ((! io_input_cmd_payload_first) && (cmdArea_writeLogic_selReg != 3'b000));
  assign _zz_4 = ((! io_input_cmd_payload_first) && (cmdArea_writeLogic_selReg != 3'b001));
  assign _zz_5 = ((! io_input_cmd_payload_first) && (cmdArea_writeLogic_selReg != 3'b010));
  assign _zz_6 = ((! io_input_cmd_payload_first) && (cmdArea_writeLogic_selReg != 3'b011));
  assign _zz_7 = ((! io_input_cmd_payload_first) && (cmdArea_writeLogic_selReg != 3'b100));
  assign _zz_8 = ((! io_input_cmd_payload_first) && (cmdArea_writeLogic_selReg != 3'b101));
  assign _zz_9 = ((! io_input_cmd_payload_first) && (cmdArea_writeLogic_selReg != 3'b110));
  assign _zz_10 = (_zz_12 + io_input_cmd_payload_fragment_length[5 : 2]);
  assign _zz_11 = io_input_cmd_payload_fragment_address[4 : 2];
  ...
  always @ (*) begin
    cmdArea_context_selEnd = _zz_10[2:0];
    if((io_input_cmd_payload_fragment_opcode == 1'b1))begin
  ...
  assign _zz_1 = io_output_rsp_payload_fragment_context;
  assign rspArea_context_selStart = _zz_1[2 : 0];
  assign rspArea_context_selEnd = _zz_1[5 : 3];
  assign rspArea_context_context = _zz_1[6 : 6];
  ...
  always @ (posedge debugCd_external_clk) begin
    if(systemCd_logic_outputReset) begin
      ...
      if((io_input_cmd_valid && (cmdArea_writeLogic_sel == 3'b000)))begin
        cmdArea_writeLogic_maskRegs_0 <= io_input_cmd_payload_fragment_mask;
      end
      if((io_output_cmd_valid && io_output_cmd_ready))begin
        cmdArea_writeLogic_maskRegs_0 <= 4'b0000;
      end
      if((io_input_cmd_valid && (cmdArea_writeLogic_sel == 3'b001)))begin
        cmdArea_writeLogic_maskRegs_1 <= io_input_cmd_payload_fragment_mask;
      end
      if((io_output_cmd_valid && io_output_cmd_ready))begin
        cmdArea_writeLogic_maskRegs_1 <= 4'b0000;
      end
      if((io_input_cmd_valid && (cmdArea_writeLogic_sel == 3'b010)))begin
        cmdArea_writeLogic_maskRegs_2 <= io_input_cmd_payload_fragment_mask;
      end
      if((io_output_cmd_valid && io_output_cmd_ready))begin
        cmdArea_writeLogic_maskRegs_2 <= 4'b0000;
      end
      if((io_input_cmd_valid && (cmdArea_writeLogic_sel == 3'b011)))begin
        cmdArea_writeLogic_maskRegs_3 <= io_input_cmd_payload_fragment_mask;
      end
      if((io_output_cmd_valid && io_output_cmd_ready))begin
        cmdArea_writeLogic_maskRegs_3 <= 4'b0000;
      end
      if((io_input_cmd_valid && (cmdArea_writeLogic_sel == 3'b100)))begin
        cmdArea_writeLogic_maskRegs_4 <= io_input_cmd_payload_fragment_mask;
      end
      if((io_output_cmd_valid && io_output_cmd_ready))begin
        cmdArea_writeLogic_maskRegs_4 <= 4'b0000;
      end
      if((io_input_cmd_valid && (cmdArea_writeLogic_sel == 3'b101)))begin
        cmdArea_writeLogic_maskRegs_5 <= io_input_cmd_payload_fragment_mask;
      end
      if((io_output_cmd_valid && io_output_cmd_ready))begin
        cmdArea_writeLogic_maskRegs_5 <= 4'b0000;
      end
      if((io_input_cmd_valid && (cmdArea_writeLogic_sel == 3'b110)))begin
...
module StreamFifoLowLatency (
  ...
  wire                popping;
  wire       [4:0]    ptrDif;
  (* ram_style = "distributed" *) reg [255:0] ram [0:31];
...
module StreamFifo (
  ...
  assign io_pop_payload_isWrite = _zz_3[8];
  assign logic_ptrDif = (logic_pushPtr_value - logic_popPtr_value);
  assign io_occupancy = {(logic_risingOccupancy && logic_ptrMatch),logic_ptrDif};
  assign io_availability = {((! logic_risingOccupancy) && logic_ptrMatch),_zz_9};
  always @ (posedge debugCd_external_clk) begin
...
module BmbUpSizerBridge (
  ...
  assign _zz_3 = (_zz_5 + io_input_cmd_payload_fragment_length[5 : 2]);
  assign _zz_4 = io_input_cmd_payload_fragment_address[4 : 2];
  ...
  assign cmdArea_selStart = io_input_cmd_payload_fragment_address[4 : 2];
  assign cmdArea_context_selStart = cmdArea_selStart;
  assign cmdArea_context_selEnd = _zz_3[2:0];
  assign io_output_cmd_payload_last = io_input_cmd_payload_last;
  assign io_output_cmd_payload_fragment_opcode = io_input_cmd_payload_fragment_opcode;
  assign io_output_cmd_payload_fragment_address = io_input_cmd_payload_fragment_address;
  assign io_output_cmd_payload_fragment_length = io_input_cmd_payload_fragment_length;
