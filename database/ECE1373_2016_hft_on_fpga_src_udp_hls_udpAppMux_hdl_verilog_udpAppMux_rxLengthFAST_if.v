...
module udpAppMux_rxLengthFAST_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
    ...
    // User signals
    output wire [15:0] rxLengthFAST_V_V_dout,
    output wire        rxLengthFAST_V_V_empty_n,
    input  wire        rxLengthFAST_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [15:0] rxLengthFAST_V_V_din;
wire [0:0]  rxLengthFAST_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [15:0] s_data;
...
//------------------------Instantiation------------------
// rs
udpAppMux_rxLengthFAST_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// rxLengthFAST_V_V_fifo
udpAppMux_rxLengthFAST_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) rxLengthFAST_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( rxLengthFAST_V_V_empty_n ),
    .full_n     ( rxLengthFAST_V_V_full_n ),
    .read       ( rxLengthFAST_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( rxLengthFAST_V_V_dout ),
    .din        ( rxLengthFAST_V_V_din )
);
...
assign rxLengthFAST_V_V_din = m_data[15:0];
assign fifo_full_n          = rxLengthFAST_V_V_full_n;
...
module udpAppMux_rxLengthFAST_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module udpAppMux_rxLengthFAST_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
