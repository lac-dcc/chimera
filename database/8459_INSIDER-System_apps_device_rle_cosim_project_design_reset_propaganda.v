...
(* CORE_GENERATION_INFO="reset_propaganda,hls_ip_2017_4_op,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.458000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=5,HLS_SYN_LUT=168}" *)
...
ap_continue,
        ap_idle,
        ap_ready,
        reset_app_rle_combine_V_din,
        reset_app_rle_combine_V_full_n,
        reset_app_rle_combine_V_write,
        reset_app_rle_expand_V_din,
        reset_app_rle_expand_V_full_n,
        reset_app_rle_expand_V_write,
        reset_app_rle_prefix_sum_V_din,
        reset_app_rle_prefix_sum_V_full_n,
        reset_app_rle_prefix_sum_V_write,
        reset_sigs_V_dout,
...
output   reset_app_rle_combine_V_din;
input   reset_app_rle_combine_V_full_n;
output   reset_app_rle_combine_V_write;
output   reset_app_rle_expand_V_din;
input   reset_app_rle_expand_V_full_n;
output   reset_app_rle_expand_V_write;
output   reset_app_rle_prefix_sum_V_din;
input   reset_app_rle_prefix_sum_V_full_n;
output   reset_app_rle_prefix_sum_V_write;
...
reg ap_idle;
reg reset_app_rle_combine_V_write;
reg reset_app_rle_expand_V_write;
reg reset_app_rle_prefix_sum_V_write;
...
reg    reset_app_rle_combine_V_blk_n;
wire    ap_CS_fsm_pp0_stage0;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0;
reg   [0:0] empty_n_reg_346;
reg    reset_app_rle_expand_V_blk_n;
reg    reset_app_rle_prefix_sum_V_blk_n;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        empty_n_reg_346 <= reset_sigs_V_empty_n;
    end
end
...
always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        reset_app_rle_combine_V_blk_n = reset_app_rle_combine_V_full_n;
    end else begin
        reset_app_rle_combine_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        reset_app_rle_combine_V_write = 1'b1;
    end else begin
        reset_app_rle_combine_V_write = 1'b0;
    end
end

always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        reset_app_rle_expand_V_blk_n = reset_app_rle_expand_V_full_n;
    end else begin
        reset_app_rle_expand_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        reset_app_rle_expand_V_write = 1'b1;
    end else begin
        reset_app_rle_expand_V_write = 1'b0;
    end
end

always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        reset_app_rle_prefix_sum_V_blk_n = reset_app_rle_prefix_sum_V_full_n;
    end else begin
        reset_app_rle_prefix_sum_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((empty_n_reg_346 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        reset_app_rle_prefix_sum_V_write = 1'b1;
    end else begin
        reset_app_rle_prefix_sum_V_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (reset_sigs_V_empty_n == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((empty_n_reg_346 == 1'd1) & (reset_app_rle_prefix_sum_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_rle_expand_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_rle_combine_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_pre_merged_app_input_data_forwarder_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_input_data_merger_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_app_output_data_caching_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_input_data_mux_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_output_data_demux_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_pcie_data_splitter_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_read_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_dram_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_read_mode_dram_helper_app_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((empty_n_reg_346 == 1'd1) & (reset_app_rle_prefix_sum_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_rle_expand_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_rle_combine_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_pre_merged_app_input_data_forwarder_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_input_data_merger_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_app_output_data_caching_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_input_data_mux_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_output_data_demux_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_pcie_data_splitter_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_read_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_dram_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_read_mode_dram_helper_app_V_full_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((empty_n_reg_346 == 1'd1) & (reset_app_rle_prefix_sum_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_rle_expand_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_rle_combine_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_pre_merged_app_input_data_forwarder_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_input_data_merger_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_app_output_data_caching_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_input_data_mux_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_app_output_data_demux_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_pcie_data_splitter_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_read_mode_pcie_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_write_mode_dram_helper_app_V_full_n == 1'b0)) | ((empty_n_reg_346 == 1'd1) & (reset_read_mode_dram_helper_app_V_full_n == 1'b0)));
end
...
assign reset_app_rle_combine_V_din = 1'd0;

assign reset_app_rle_expand_V_din = 1'd0;

assign reset_app_rle_prefix_sum_V_din = 1'd0;
