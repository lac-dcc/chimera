...
// Date        : Thu Jul  7 03:06:00 2022
// Host        : boba running 64-bit Ubuntu 20.04.3 LTS
// Command     : write_verilog -force -file
//               runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke-with.futil-ultrascale-opt.v
// Design      : main
...
module lakeroad_xilinx_ultrascale_plus_add32_2
  ...
  wire ZERO;
  wire [31:0]out0;
  wire [7:0]NLW_carry_17_O_UNCONNECTED;
  wire [7:0]NLW_carry_26_O_UNCONNECTED;
  wire [7:0]NLW_carry_35_O_UNCONNECTED;
  ...
  CARRY8 #(
    ...
    carry_17
       (.CI(ZERO),
        ...
        .O({out0[15:9],NLW_carry_17_O_UNCONNECTED[0]}),
        .S({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO}));
  (* BOX_TYPE = "PRIMITIVE" *) 
  (* OPT_MODIFIED = "PROPCONST" *) 
  CARRY8 #(
    .CARRY_TYPE("SINGLE_CY8")) 
    carry_26
       (.CI(ZERO),
        .CI_TOP(\<const0> ),
        .DI({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO}),
        .O({out0[23:17],NLW_carry_26_O_UNCONNECTED[0]}),
        .S({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO}));
  (* BOX_TYPE = "PRIMITIVE" *) 
  (* OPT_MODIFIED = "PROPCONST" *) 
  CARRY8 #(
    ...
    carry_35
       (.CI(ZERO),
        .CI_TOP(\<const0> ),
        .DI({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO}),
        .O({out0[31:25],NLW_carry_35_O_UNCONNECTED[0]}),
        .S({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO}));
  (* BOX_TYPE = "PRIMITIVE" *) 
  (* OPT_MODIFIED = "PROPCONST" *) 
  CARRY8 #(
    ...
    carry_8
       (.CI(\<const0> ),
        ...
        .DI({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO}),
        .O(out0[7:0]),
        .S({ZERO,ZERO,ZERO,ZERO,ZERO,E,E,E}));
endmodule
  ...
  CARRY8 #(
    ...
    carry_8
       (.CI(\<const0> ),
        ...
        .DI({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,ZERO}),
        .O(out0[7:0]),
        .S({ZERO,ZERO,ZERO,ZERO,ZERO,ZERO,E,E}));
endmodule

(* NETLIST_CHECKSUM = "e822997e" *) 
...
module main
  ...
  wire [31:0]p_0_in;
  wire reset;
  wire [31:0]NLW_a0_out0_UNCONNECTED;
  wire [31:0]NLW_a1_out0_UNCONNECTED;
  wire [31:0]NLW_comb_reg_D_UNCONNECTED;
  wire [31:0]NLW_comb_reg_Q_UNCONNECTED;
  wire [31:0]NLW_comb_reg0_D_UNCONNECTED;
  wire [31:0]NLW_comb_reg0_Q_UNCONNECTED;
  wire [31:0]NLW_fsm_out0_UNCONNECTED;
  wire [31:0]NLW_fsm_out_tmp_reg_0_UNCONNECTED;
  ...
  std_add a0
       (.E(do_adds0_go_in),
        .out0({a0_out[31:25],NLW_a0_out0_UNCONNECTED[24],a0_out[23:17],NLW_a0_out0_UNCONNECTED[16],a0_out[15:9],NLW_a0_out0_UNCONNECTED[8],a0_out[7:0]}));
  std_add_0 a1
       (.E(do_adds0_go_in),
        .out0({a1_out[31:25],NLW_a1_out0_UNCONNECTED[24],a1_out[23:17],NLW_a1_out0_UNCONNECTED[16],a1_out[15:9],NLW_a1_out0_UNCONNECTED[8],a1_out[7:0]}));
  std_reg comb_reg
       (.D({a0_out[31:25],NLW_comb_reg_D_UNCONNECTED[24],a0_out[23:17],NLW_comb_reg_D_UNCONNECTED[16],a0_out[15:9],NLW_comb_reg_D_UNCONNECTED[8],a0_out[7:0]}),
        .E(do_adds0_go_in),
        .Q({comb_reg_n_1,comb_reg_n_2,comb_reg_n_3,comb_reg_n_4,comb_reg_n_5,comb_reg_n_6,comb_reg_n_7,NLW_comb_reg_Q_UNCONNECTED[24],comb_reg_n_9,comb_reg_n_10,comb_reg_n_11,comb_reg_n_12,comb_reg_n_13,comb_reg_n_14,comb_reg_n_15,NLW_comb_reg_Q_UNCONNECTED[16],comb_reg_n_17,comb_reg_n_18,comb_reg_n_19,comb_reg_n_20,comb_reg_n_21,comb_reg_n_22,comb_reg_n_23,NLW_comb_reg_Q_UNCONNECTED[8],comb_reg_n_25,comb_reg_n_26,comb_reg_n_27,comb_reg_n_28,comb_reg_n_29,comb_reg_n_30,comb_reg_n_31,comb_reg_n_32}),
        .clk(clk),
        .comb_reg0_done(comb_reg0_done),
        .done_reg_0(fsm_n_103),
        .reset(reset));
  std_reg_1 comb_reg0
       (.D({a1_out[31:25],NLW_comb_reg0_D_UNCONNECTED[24],a1_out[23:17],NLW_comb_reg0_D_UNCONNECTED[16],a1_out[15:9],NLW_comb_reg0_D_UNCONNECTED[8],a1_out[7:0]}),
        .E(do_adds0_go_in),
        .Q({comb_reg0_n_0,comb_reg0_n_1,comb_reg0_n_2,comb_reg0_n_3,comb_reg0_n_4,comb_reg0_n_5,comb_reg0_n_6,NLW_comb_reg0_Q_UNCONNECTED[24],comb_reg0_n_8,comb_reg0_n_9,comb_reg0_n_10,comb_reg0_n_11,comb_reg0_n_12,comb_reg0_n_13,comb_reg0_n_14,NLW_comb_reg0_Q_UNCONNECTED[16],comb_reg0_n_16,comb_reg0_n_17,comb_reg0_n_18,comb_reg0_n_19,comb_reg0_n_20,comb_reg0_n_21,comb_reg0_n_22,NLW_comb_reg0_Q_UNCONNECTED[8],comb_reg0_n_24,comb_reg0_n_25,comb_reg0_n_26,comb_reg0_n_27,comb_reg0_n_28,comb_reg0_n_29,comb_reg0_n_30,comb_reg0_n_31}),
        .clk(clk),
        .reset(reset));
  std_reg__parameterized0 fsm
       (.B({fsm_n_35,fsm_n_36,fsm_n_37,fsm_n_38,fsm_n_39,fsm_n_40,fsm_n_41,fsm_n_42,fsm_n_43,fsm_n_44,fsm_n_45,fsm_n_46,fsm_n_47,fsm_n_48,fsm_n_49,fsm_n_50,fsm_n_51}),
        ...
        .go_0(fsm_n_103),
        .m_done(m_done),
        .out0({comb_reg_n_1,comb_reg_n_2,comb_reg_n_3,comb_reg_n_4,comb_reg_n_5,comb_reg_n_6,comb_reg_n_7,NLW_fsm_out0_UNCONNECTED[24],comb_reg_n_9,comb_reg_n_10,comb_reg_n_11,comb_reg_n_12,comb_reg_n_13,comb_reg_n_14,comb_reg_n_15,NLW_fsm_out0_UNCONNECTED[16],comb_reg_n_17,comb_reg_n_18,comb_reg_n_19,comb_reg_n_20,comb_reg_n_21,comb_reg_n_22,comb_reg_n_23,NLW_fsm_out0_UNCONNECTED[8],comb_reg_n_25,comb_reg_n_26,comb_reg_n_27,comb_reg_n_28,comb_reg_n_29,comb_reg_n_30,comb_reg_n_31,comb_reg_n_32}),
        .out_done(out_done),
        ...
        .out_tmp_reg_0({comb_reg0_n_0,comb_reg0_n_1,comb_reg0_n_2,comb_reg0_n_3,comb_reg0_n_4,comb_reg0_n_5,comb_reg0_n_6,NLW_fsm_out_tmp_reg_0_UNCONNECTED[24],comb_reg0_n_8,comb_reg0_n_9,comb_reg0_n_10,comb_reg0_n_11,comb_reg0_n_12,comb_reg0_n_13,comb_reg0_n_14,NLW_fsm_out_tmp_reg_0_UNCONNECTED[16],comb_reg0_n_16,comb_reg0_n_17,comb_reg0_n_18,comb_reg0_n_19,comb_reg0_n_20,comb_reg0_n_21,comb_reg0_n_22,NLW_fsm_out_tmp_reg_0_UNCONNECTED[8],comb_reg0_n_24,comb_reg0_n_25,comb_reg0_n_26,comb_reg0_n_27,comb_reg0_n_28,comb_reg0_n_29,comb_reg0_n_30,comb_reg0_n_31}),
...
module std_add
  ...
  wire [0:0]E;
  wire [31:0]out0;
  wire [31:0]NLW__impl_out0_UNCONNECTED;

  lakeroad_xilinx_ultrascale_plus_add32_2_2 _impl
       (.E(E),
        .out0({out0[31:25],NLW__impl_out0_UNCONNECTED[24],out0[23:17],NLW__impl_out0_UNCONNECTED[16],out0[15:9],NLW__impl_out0_UNCONNECTED[8],out0[7:0]}));
endmodule
...
module std_reg__parameterized0
  ...
  assign B[16] = ZERO;
  assign B[15:9] = \^B [15:9];
  assign B[8] = ZERO;
  assign B[7:0] = \^B [7:0];
  assign \out_reg[31] [14:8] = \^out_reg[31] [14:8];
  assign \out_reg[31] [7] = ZERO;
  assign \out_reg[31] [6:0] = \^out_reg[31] [6:0];
  assign p_0_in[31:25] = \^p_0_in [31:25];
  assign p_0_in[24] = ZERO;
  assign p_0_in[23:17] = \^p_0_in [23:17];
  assign p_0_in[16] = ZERO;
  assign p_0_in[15:9] = \^p_0_in [15:9];
  assign p_0_in[8] = ZERO;
  assign p_0_in[7:0] = \^p_0_in [7:0];
