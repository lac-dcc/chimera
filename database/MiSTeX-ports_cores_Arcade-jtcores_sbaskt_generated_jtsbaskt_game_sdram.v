...
// jtsbaskt_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
// 1536057 = 24576920*1/16 Hz from clk24
`ifdef VERILATOR_KEEP_CEN /* verilator tracing_on */ `else /* verilator tracing_off */ `endif
jtframe_gated_cen #(.W(1),.NUM(1),.DEN(16),.MFREQ(24576)) u_cen0_clk24(
    .rst    ( rst          ),
    .clk    ( clk24 ),
    .busy   ( (main_cs & ~main_ok)    ),
    .cen    ( { cpu_cen } ),
    .fave   (              ),
    .fworst (              )
); /* verilator tracing_off */

// 3072115 = 24576920*1/8 Hz from clk24
`ifdef VERILATOR_KEEP_CEN /* verilator tracing_on */ `else /* verilator tracing_off */ `endif
jtframe_gated_cen #(.W(2),.NUM(1),.DEN(8),.MFREQ(24576)) u_cen1_clk24(
    .rst    ( rst          ),
    .clk    ( clk24 ),
    .busy   ( 1'b0    ),
    .cen    ( { ti2_cen, ti1_cen } ),
...
// 3579545 = 24576920*455/3124 Hz from clk24
`ifdef VERILATOR_KEEP_CEN /* verilator tracing_on */ `else /* verilator tracing_off */ `endif
jtframe_gated_cen #(.W(2),.NUM(455),.DEN(3124),.MFREQ(24576)) u_cen2_clk24(
    .rst    ( rst          ),
    .clk    ( clk24 ),
    .busy   ( 1'b0    ),
    .cen    ( { psg_cen, snd_cen } ),
...
jtframe_rcmix #(
    ...
    .ch4    ( 16'd0 ),
    .ch5    ( 16'd0 ),
    .p0     ( vlm_rcen[0]?16'hFAFD : vlm_rcen[1]?16'h00FD : 16'h0), // 339 Hz, 723 Hz 
    .p1     ( psg_rcen[0]?16'hFDFA : psg_rcen[1]?16'h00FA : 16'h0), // 714 Hz, 329 Hz 
    .p2     ( rdac_rcen?16'h00FE : 16'h0), // 219 Hz, 0 Hz 
    .p3     ( 16'h0), 
    .p4     ( 16'h0), 
    .p5     ( 16'h0), 
    .g0     ( 8'h80 ), // vlm
