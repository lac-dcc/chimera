...
// Date        : Thu Jul  7 03:29:30 2022
// Host        : boba running 64-bit Ubuntu 20.04.3 LTS
// Command     : write_verilog -force -file
//               runs/2022-07-06-1704-full/vivado-eval/xilinx-ultrascale-plus-vivado-eval//vivado-synth-opt-place-route//invoke.futil-ultrascale-opt.v
// Design      : main
...
module exponent
  ...
  std_reg__parameterized0_2 count
       (.D(pow_in[0]),
        ...
        .\out_reg[3]_0 (count_out),
        .\out_reg[3]_1 (count_in),
        .pd_out(pd_out),
        .pow_done(pow_done),
        .reset(reset));
  std_reg__parameterized2 fsm
       (.A_LUT_0(A_LUT_0),
        ...
        .cond0_go_in(cond0_go_in),
        .count_done(count_done),
        .\done_buf_reg[2] (fsm_n_20),
        .done_reg(pow_write_en),
        .done_reg_0(fsm_n_23),
        .done_reg_1(fsm_n_24),
        .incr_count_go_in(incr_count_go_in),
        .mul_done(mul_done),
        .out0(incr_out),
        .\out_reg[0]_0 (fsm_n_21),
  ...
  std_mult_pipe mul
       (.B({pow_n_48,pow_n_49,pow_n_50,pow_n_51,pow_n_52,pow_n_53,pow_n_54,pow_n_55,pow_n_56,pow_n_57,pow_n_58,pow_n_59,pow_n_60,pow_n_61,pow_n_62,pow_n_63,pow_n_64}),
        ...
        .reset(reset));
  std_reg__parameterized1_4 pd
       (.clk(clk),
        .\out_reg[0]_0 (fsm_n_23),
        .pd_out(pd_out),
        .reset(reset));
  std_reg__parameterized1_5 pd0
       (.clk(clk),
        .\out_reg[0]_0 (fsm_n_24),
        .pd0_out(pd0_out),
        .reset(reset));
  std_reg_6 pow
       (.B({pow_n_48,pow_n_49,pow_n_50,pow_n_51,pow_n_52,pow_n_53,pow_n_54,pow_n_55,pow_n_56,pow_n_57,pow_n_58,pow_n_59,pow_n_60,pow_n_61,pow_n_62,pow_n_63,pow_n_64}),
...
(* ORIG_REF_NAME = "lakeroad_xilinx_ultrascale_plus_add4_2" *) 
module lakeroad_xilinx_ultrascale_plus_add4_2_7
   (out0,
    a,
    upd2_go_in);
  output [3:0]out0;
...
module lakeroad_xilinx_ultrascale_plus_ule4_2
  ...
  CARRY8 #(
    ...
    carry_8
       (.CI(\<const1> ),
        .CI_TOP(\<const0> ),
        .CO({le0_out,NLW_carry_8_CO_UNCONNECTED[6:0]}),
...
module main
  ...
  std_reg__parameterized0 fsm
       (.D(fsm_in),
        ...
        .\out_reg[0]_1 (exp0_n_1),
        .\out_reg[1]_0 (fsm_n_1),
        .\out_reg[1]_1 (a_read0_0_write_en),
        .\out_reg[1]_2 (fsm_n_79),
        .\out_reg[1]_3 (fsm_n_90),
        .\out_reg[2]_0 (fsm_n_89),
...
module std_add
  ...
  lakeroad_xilinx_ultrascale_plus_add4_2_7 _impl
       (.a(a),
        .out0(out0),
        .upd2_go_in(upd2_go_in));
endmodule
...
(* ORIG_REF_NAME = "std_reg" *) 
module std_reg__parameterized1_5
   (pd0_out,
    reset,
    \out_reg[0]_0 ,
    clk);
