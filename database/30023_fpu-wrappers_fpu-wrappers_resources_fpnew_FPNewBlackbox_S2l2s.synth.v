...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:153$613.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:153$614.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$597.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$598.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$607.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$608.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$609.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$610.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$611.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$612.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$597.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$598.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$598.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$597.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:153$613.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:153$614.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$597.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$598.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$607.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$608.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$609.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$610.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$611.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:173$612.inp  = 3'hx;
endmodule
...
module \$paramod$4010079d27de19cda22c9f4310fd6b0490825ab8\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$8159550b11a619312fa1c2ba6266131c0e051d76\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [71:0] arbiter_output;
  ...
  \$paramod$8e4319ac9311a38f3796048fc86cc709ad7c31fd\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$8e4319ac9311a38f3796048fc86cc709ad7c31fd\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o, reg_ena_i
);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  ...
  \$paramod$974a40beaaee9241d3ebddb6fa4c05f4bc63c981\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
  ...
  \$paramod$974a40beaaee9241d3ebddb6fa4c05f4bc63c981\fpnew_fma_FC83A_5615B  \gen_num_lanes[1].active_lane.lane_instance.i_fma  (
    .aux_i(vectorial_op_i),
...
module \$paramod$974a40beaaee9241d3ebddb6fa4c05f4bc63c981\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, mask_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, mask_o, aux_o, out_valid_o, out_ready_i
, busy_o, reg_ena_i);
  wire _000_;
  wire _001_;
  wire [6:0] _002_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _075_ });
  assign _022_ = { 2'h0, exponent_a[7:0] } + info_a[6];
  assign _023_ = _022_ + { 2'h0, operand_b[30:23] };
  assign _024_ = _023_ + info_b[6];
  assign _025_ = { 26'h0000000, product, 2'h0 } + addend_shifted;
  assign sum_raw = _025_ + inject_carry_in;
  assign _027_ = 32'd26 + leading_zero_count;
  assign _026_ = $signed(_089_) + $signed(32'd1);
  assign _028_ = $signed(32'd26) + $signed(mid_pipe_exp_prod_q[9:0]);
  ...
  reg [95:0] _115_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _115_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _115_ <= operands_i;
  assign inp_pipe_operands_q[95:0] = _115_;
  ...
  reg [31:0] _119_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _119_ <= 32'd0;
    else if (\gen_inside_pipeline[0].reg_ena ) _119_ <= special_result;
  assign mid_pipe_spec_res_q[31:0] = _119_;
  ...
  reg [75:0] _123_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _123_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _123_ <= mid_pipe_sum_q[151:76];
  assign mid_pipe_sum_q[75:0] = _123_;
  ...
  assign _039_ = sum_raw[76] == tentative_sign;
  assign _040_ = ! rounded_abs[30:23];
  assign _041_ = ! pre_round_abs[30:23];
  assign _042_ = rounded_abs[30:23] == 8'h01;
  ...
  assign _048_ = $signed(exponent_difference) <= $signed(32'd4294967247);
  assign _049_ = $signed(exponent_difference) <= $signed(32'd26);
  assign _050_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd0);
  assign _051_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd2);
  ...
  assign _064_ = ! sum_sticky_bits[50];
  ...
  assign _013_ = _047_ ? sum_shifted[74:50] : { 1'h0, sum_shifted[74:51] };
  assign _017_ = _047_ ? { sum_shifted[49:0], 1'h0 } : sum_shifted[50:0];
  assign _012_ = _047_ ? _090_[9:0] : 10'h000;
  assign _003_ = sum_shifted[75] ? normalized_exponent : _012_;
  assign _011_ = sum_shifted[75] ? sum_shifted[50:0] : _017_;
  assign _004_ = sum_shifted[75] ? { 1'h1, sum_shifted[74:51] } : _013_;
  assign final_mantissa = sum_shifted[76] ? { 1'h1, sum_shifted[75:52] } : _004_;
  assign sum_sticky_bits = sum_shifted[76] ? sum_shifted[51:1] : _011_;
  assign final_exponent = sum_shifted[76] ? _029_[9:0] : _003_;
  assign _006_ = _059_ ? _026_[9:0] : 10'h000;
  assign _005_ = _059_ ? _027_[6:0] : _028_[6:0];
  assign normalized_exponent = _068_ ? _006_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _068_ ? _005_ : mid_pipe_add_shamt_q[6:0];
  assign _002_ = _049_ ? _088_[6:0] : 7'h00;
  assign addend_shamt = _048_ ? 7'h4c : _002_;
  assign _021_ = info_c[4] ? { operand_c[31], 31'h7f800000 } : 32'd2143289344;
  assign _020_ = _066_ ? { tentative_sign, 31'h7f800000 } : _021_;
  assign _019_ = _055_ ? 1'h1 : 1'h0;
  assign _018_ = _055_ ? 32'd2143289344 : _020_;
  assign _016_ = any_operand_inf ? _019_ : 1'h0;
  assign _015_ = any_operand_inf ? _018_ : 32'd2143289344;
  ...
  assign _009_ = any_operand_nan ? 32'd2143289344 : _015_;
  assign mid_pipe_spec_stat_q[9] = _065_ ? 1'h1 : _010_;
  assign result_is_special = _065_ ? 1'h1 : _008_;
  assign special_result = _065_ ? 32'd2143289344 : _009_;
  function [0:0] _225_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[31] = _225_(1'h1, { _074_, 1'h0, inp_pipe_operands_q[31] }, { _083_, _082_, _034_ });
  function [30:0] _226_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _226_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _082_, _037_ });
  assign _007_ = _038_ ? 32'd0 : 32'd2147483648;
  ...
  assign operand_c = _230_(32'd2155872257, { _097_, inp_pipe_operands_q[94:64], _007_ }, { _035_, _081_ });
  assign operand_b = _036_ ? inp_pipe_operands_q[63:32] : 32'd2155872257;
  function [7:0] _232_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign _087_ = _024_ - 32'd127;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _088_ = $signed(32'd27) - $signed(exponent_difference);
  assign _089_ = $signed(mid_pipe_exp_prod_q[9:0]) - $signed({ 1'h0, leading_zero_count });
  ...
  assign { _092_[31:10], exponent_product } = _067_ ? 32'd4294967171 : _087_;
  ...
  assign { _093_[76], mid_pipe_sum_q[151:76] } = _056_ ? _072_ : sum_raw;
  ...
  assign { _096_[31:8], pre_round_abs[30:23] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _097_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[1];
  ...
  assign _092_[9:0] = exponent_product;
  assign _093_[75:0] = mid_pipe_sum_q[151:76];
  assign _096_[7:0] = pre_round_abs[30:23];
...
module \$paramod$ba952de300f024127195db651394e21ea8d5d6a3\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:335$525.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:335$526.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:355$523.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:355$524.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:335$525.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:335$526.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:355$523.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l2s.preprocessed.v:355$524.inp  = 2'hx;
endmodule

module \$paramod$d4cb844167d29771e0cfc0fcec4b79b0d2343e01\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$de4b5432f54a8f4923fee721fb39af8ee157737a\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
);
  wire _00_;
  wire _01_;
  wire _02_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8198$213.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8198$55.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$110.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$145.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$180.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$261.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$277.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$75.$result ;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1421  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1421 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1421 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1421 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1421 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1421 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1421 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1421 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1421 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1421 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1421 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1421 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1421 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1421 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1421 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1421 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1421 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$180.$result  = \$auto$proc_rom.cc:150:do_switch$1421 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1425  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1425 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1425 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1425 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1425 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1425 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1425 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1425 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1425 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1425 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1425 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1425 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1425 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1425 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1425 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1425 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1425 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$145.$result  = \$auto$proc_rom.cc:150:do_switch$1425 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1429  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1429 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1429 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1429 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1429 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1429 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1429 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1429 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1429 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1429 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1429 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1429 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1429 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1429 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1429 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1429 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1429 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$110.$result  = \$auto$proc_rom.cc:150:do_switch$1429 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1433  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1433 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1433 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1433 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1433 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1433 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1433 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1433 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1433 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1433 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1433 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1433 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1433 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1433 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1433 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1433 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1433 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$75.$result  = \$auto$proc_rom.cc:150:do_switch$1433 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1437  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1437 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1437 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1437 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1437 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1437 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1437 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1437 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1437 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1437 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1437 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1437 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1437 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1437 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1437 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1437 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1437 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8198$55.$result  = \$auto$proc_rom.cc:150:do_switch$1437 [op_i];
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$75.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$110.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$145.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$180.$result  == 2'h3;
  assign simd_mask = simd_mask_i | 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _54_ = opgrp_in_ready;
  assign _13_ = _54_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8198$55.$result  +: 1];
  ...
  \$paramod$8159550b11a619312fa1c2ba6266131c0e051d76\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$4010079d27de19cda22c9f4310fd6b0490825ab8\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$ba952de300f024127195db651394e21ea8d5d6a3\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$d4cb844167d29771e0cfc0fcec4b79b0d2343e01\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8198$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$261.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l2s.preprocessed.v:8247$277.op  = 4'hx;
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$de4b5432f54a8f4923fee721fb39af8ee157737a\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
