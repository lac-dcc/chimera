...
// *******************************************************************************************************
// **                                                                                                   **
// **   93AA56A.v - 93AA56A 2K-BIT MICROWIRE SERIAL EEPROM WITH 8-BIT ORG (VCC = +1.8V TO +5.5V)        **
// **                                                                                                   **
// *******************************************************************************************************
// **                                                                                                   **
...
module M93AA56A (DI, DO, CLK, CS, RESET);
      ...
      if (CS == 1 & InstructionREAD) begin
         if (BitCounter >= 12) begin
            if (BitCounter[2:0] == 3'b100) begin
               ...
               DataShifterI[15:0] <= DataShifterI[15:8] + 1;
            end
            else begin
