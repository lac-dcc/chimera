...
// nv_ram_rwsthp_60x84: synthesizable model core
...
module nv_ram_rwsthp_60x84_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
output [83:0] mbist_Do_r0_int_net;
...
wire [83:0] Data_reg_r0;
// Data out bus for read port r0 for Output Mux
wire [83:0] r0_OutputMuxDataOut;
...
wire shiftDR_en;
reg [83:0] pre_muxed_Di_w0;
wire [83:0] pre_muxed_Di_w0_A, pre_muxed_Di_w0_B;
wire pre_muxed_Di_w0_S;
assign pre_muxed_Di_w0_S = !debug_mode_sync;
assign pre_muxed_Di_w0_A = Data_reg_r0[83:0];
assign pre_muxed_Di_w0_B = {{42{mbist_Di_w0}}};
always @(pre_muxed_Di_w0_S or pre_muxed_Di_w0_A or pre_muxed_Di_w0_B)
    case(pre_muxed_Di_w0_S) // synopsys infer_mux
      1'b0 : pre_muxed_Di_w0 = pre_muxed_Di_w0_A;
      1'b1 : pre_muxed_Di_w0 = pre_muxed_Di_w0_B;
      default : pre_muxed_Di_w0 = {84{`tick_x_or_0}};
    endcase
reg [83:0] muxed_Di_w0;
wire [83:0] muxed_Di_w0_A, muxed_Di_w0_B;
assign muxed_Di_w0_A = {di[83:0]};
...
always @(muxed_Di_w0_S or muxed_Di_w0_A or muxed_Di_w0_B)
    case(muxed_Di_w0_S) // synopsys infer_mux
      ...
      default : muxed_Di_w0 = {84{`tick_x_or_0}};
    endcase
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMPDP_60X84_GL_M1_D2 (RamCell)
// Covers Addresses from 0 to 59 Addressrange: [5:0]
// Data Bit range: [83:0] (84 bits)
...
// ----------------- begin Ram Cell RAMPDP_60X84_GL_M1_D2 -------------
// Write Port Stuff -----
...
wire [83:0] ramDataOut;
assign dout_0_0[83:0] = ramDataOut[83:0];
RAMPDP_60X84_GL_M1_D2 ram_Inst_60X84 (
                                        .CLK (gated_clk_core)
                                      , .WADR_5 (wa_0_0[5])
                                      , .WADR_4 (wa_0_0[4])
                                      , .WADR_3 (wa_0_0[3])
...
reg [83:0] ram_r0_OutputMuxDataOut;
//For bitEnd 83, only one piece RAMPDP_60X84_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_0[83:0] or muxed_Di_w0[83:0] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[83:0] = (ram_bypass) ? muxed_Di_w0[83:0]: dout_0_0;
end
assign r0_OutputMuxDataOut[83:0] = ram_r0_OutputMuxDataOut[83:0];
// verilint 17 on - Range (rather than full vector) in the sensitivity list
// --------------------- Output Mbist Interface logic -------------
wire [83:0] functional_byp_muxed_r0_OutputMuxDataOut = (byp_sel & !debug_mode_sync & !mbist_en_r) ? dbyp : wthru_di;
wire [83:0] muxed_r0_OutputMuxDataOut;
...
////MSB 83 LSB 0  and total rambit is 84 and  dsize is 84
wire Data_reg_SO_r0;
// verilint 110 off - Incompatible width
// verilint 630 off - Port connected to a NULL expression
// These are used for registering Ra in case of Latch arrays as well (i.e.
// used in functional path as well)
wire [83:0]data_regq;
assign Data_reg_r0[83:0] = data_regq[83:0] ;
// verilint 110 on - Incompatible width
// verilint 630 on - Port connected to a NULL expression
assign dout = Data_reg_r0;
assign mbist_Do_r0_int_net = Data_reg_r0[84-1:0];
...
ScanShareSel_JTAG_reg_ext_cg #(84, 0, 0) testInst_Data_reg_r0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            .shiftDR(shiftDR),
            .reset_(1'b1), .D(muxed_r0_OutputMuxDataOut[83:0]), .Q(data_regq[83:0]),
