...
module udpAppMux_time_2_if (
    ...
    // User signals
    output wire [63:0] time_2_V_V_dout,
    output wire        time_2_V_V_empty_n,
    input  wire        time_2_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [63:0] time_2_V_V_din;
wire [0:0]  time_2_V_V_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [63:0] s_data;
...
// time_2_V_V_fifo
udpAppMux_time_2_fifo #(
    .DATA_BITS  ( 64 ),
    .DEPTH_BITS ( 4 )
) time_2_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( time_2_V_V_empty_n ),
    .full_n     ( time_2_V_V_full_n ),
    .read       ( time_2_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( time_2_V_V_dout ),
    .din        ( time_2_V_V_din )
);
...
assign time_2_V_V_din = m_data[63:0];
assign fifo_full_n    = time_2_V_V_full_n;
...
module udpAppMux_time_2_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
