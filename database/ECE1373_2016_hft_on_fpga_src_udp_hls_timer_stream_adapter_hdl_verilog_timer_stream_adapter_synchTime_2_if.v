...
module timer_stream_adapter_synchTime_2_if (
    ...
    // User signals
    input  wire [63:0] synchTime_2_V_V_din,
    output wire        synchTime_2_V_V_full_n,
    input  wire        synchTime_2_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
wire [0:0]  fifo_empty_n;
wire [63:0] synchTime_2_V_V_dout;
wire [0:0]  synchTime_2_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [63:0] s_data;
...
//------------------------Instantiation------------------
// rs
timer_stream_adapter_synchTime_2_reg_slice #(
    .N       ( 64 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// synchTime_2_V_V_fifo
timer_stream_adapter_synchTime_2_fifo #(
    .DATA_BITS  ( 64 ),
    .DEPTH_BITS ( 4 )
) synchTime_2_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( synchTime_2_V_V_empty_n ),
    .full_n     ( synchTime_2_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( synchTime_2_V_V_write ),
    .dout       ( synchTime_2_V_V_dout ),
    .din        ( synchTime_2_V_V_din )
);
...
assign s_data  = {synchTime_2_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = synchTime_2_V_V_empty_n;
...
module timer_stream_adapter_synchTime_2_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
