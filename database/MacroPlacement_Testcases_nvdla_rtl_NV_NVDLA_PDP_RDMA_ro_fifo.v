...
module NV_NVDLA_PDP_RDMA_ro_fifo_32x64 (
      nvdla_core_clk
    , nvdla_core_rstn
    , ro_wr_prdy
    , ro_wr_pvld
...
NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 ram (
...
//
assign wr_limit_muxed = `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x64_wr_limit_override ? `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x64_wr_limit : 6'd0;
`else
...
`endif
    ...
    if ( $test$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x64_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x64_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// set_boundary_optimization find(design, "NV_NVDLA_PDP_RDMA_ro_fifo_32x64") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x64
//
// Flop-Based RAM
//
module NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 (
      clk
    , pwrbus_ram_pd
    , di
    , we
...
vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 emu_ram (
     .Wa0( Wa0_vmw )
   , .we0( we0_vmw )
   , .Di0( Di0_vmw )
   , .Ra0( ra[4:0] )
...
`endif // EMU
endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
// emulation model of flopram guts
//
`ifdef EMU
module vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64 (
   Wa0, we0, Di0,
   Ra0, Do0
   );
input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64) }
// set_attribute { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64] != {} } { set_attr preserve 1 [find / -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64] }
endmodule // vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
//vmw: Memory vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
//vmw: Address-size 5
//vmw: Data-size 64
...
//vmw:
//qt: CELL vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x64_flopram_rwsa_32x64
...
//qt:
`endif // EMU
//| &Shell ${FIFOGEN} -stdout -m NV_NVDLA_PDP_RDMA_ro_fifo_32x32
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ro_wr
//| -rd_pipebus ro_rd
...
// leda B_1405 OFF -- 2 asynchronous resets in this unit detected
 `define FORCE_CONTENTION_ASSERTION_RESET_ACTIVE 1'b1
 `include "simulate_x_tick.vh"
 module NV_NVDLA_PDP_RDMA_ro_fifo_32x32 (
       nvdla_core_clk
     , nvdla_core_rstn
     , ro_wr_prdy
     , ro_wr_pvld
...
// Adding parameter for fifogen to disable wr/rd contention assertion in ramgen.
// Fifogen handles this by ignoring the data on the ram data out for that cycle.
 NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 ram (
       .clk( nvdla_core_clk_mgated )
     , .pwrbus_ram_pd ( pwrbus_ram_pd )
     , .di ( ro_wr_pd )
     , .we ( ram_we )
...
// Emulation Global Config Override
//
 assign wr_limit_muxed = `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x32_wr_limit_override ? `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x32_wr_limit : 6'd0;
 `else
// No Global Override for Emulation
//
 assign wr_limit_muxed = 6'd0;
...
// VCS coverage off
 ...
 `endif
     wr_limit_override = 0;
     wr_limit_override_value = 0; // to keep viva happy with dangles
     if ( $test$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x32_wr_limit" ) ) begin
         wr_limit_override = 1;
         $value$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x32_wr_limit=%d", wr_limit_override_value);
     end
 end
// VCS coverage on
 `endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "NV_NVDLA_PDP_RDMA_ro_fifo_32x32") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
 endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x32
//
// Flop-Based RAM
//
 module NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 (
       clk
     , pwrbus_ram_pd
     , di
     , we
...
//
 ...
 vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 emu_ram (
      .Wa0( Wa0_vmw )
    , .we0( we0_vmw )
    , .Di0( Di0_vmw )
    , .Ra0( ra[4:0] )
...
//VCS coverage on
 ...
 `endif // EMU
 endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
// emulation model of flopram guts
//
 `ifdef EMU
 module vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32 (
    Wa0, we0, Di0,
    Ra0, Do0
    );
 input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32) }
// set_attribute { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32] != {} } { set_attr preserve 1 [find / -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32] }
 endmodule // vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
//vmw: Memory vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
//vmw: Address-size 5
//vmw: Data-size 32
//vmw: Sensitivity level 1
//vmw: Ports W R
...
//vmw:
//qt: CELL vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x32_flopram_rwsa_32x32
//qt: TERMINAL we0 TYPE=WE POLARITY=H PORT=1
//qt: TERMINAL Wa0[%d] TYPE=ADDRESS DIR=W BIT=%1 PORT=1
//qt: TERMINAL Di0[%d] TYPE=DATA DIR=I BIT=%1 PORT=1
//qt:
...
//qt:
 `endif // EMU
//| &Shell ${FIFOGEN} -stdout -m NV_NVDLA_PDP_RDMA_ro_fifo_32x16
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ro_wr
//| -rd_pipebus ro_rd
...
`define FORCE_CONTENTION_ASSERTION_RESET_ACTIVE 1'b1
`include "simulate_x_tick.vh"
module NV_NVDLA_PDP_RDMA_ro_fifo_32x16 (
      nvdla_core_clk
    , nvdla_core_rstn
    , ro_wr_prdy
    , ro_wr_pvld
...
// Adding parameter for fifogen to disable wr/rd contention assertion in ramgen.
// Fifogen handles this by ignoring the data on the ram data out for that cycle.
NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 ram (
      .clk( nvdla_core_clk_mgated )
    , .pwrbus_ram_pd ( pwrbus_ram_pd )
    , .di ( ro_wr_pd )
    , .we ( ram_we )
...
// Emulation Global Config Override
//
assign wr_limit_muxed = `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x16_wr_limit_override ? `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x16_wr_limit : 6'd0;
`else
// No Global Override for Emulation
//
assign wr_limit_muxed = 6'd0;
...
`endif
    wr_limit_override = 0;
    wr_limit_override_value = 0; // to keep viva happy with dangles
    if ( $test$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x16_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x16_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "NV_NVDLA_PDP_RDMA_ro_fifo_32x16") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x16
//
// Flop-Based RAM
//
module NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 (
      clk
    , pwrbus_ram_pd
    , di
    , we
...
vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 emu_ram (
     .Wa0( Wa0_vmw )
   , .we0( we0_vmw )
   , .Di0( Di0_vmw )
   , .Ra0( ra[4:0] )
...
`endif // EMU
endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
// emulation model of flopram guts
//
`ifdef EMU
module vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16 (
   Wa0, we0, Di0,
   Ra0, Do0
   );
input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16) }
// set_attribute { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16] != {} } { set_attr preserve 1 [find / -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16] }
endmodule // vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
//vmw: Memory vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
//vmw: Address-size 5
//vmw: Data-size 16
//vmw: Sensitivity level 1
//vmw: Ports W R
...
//vmw:
//qt: CELL vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x16_flopram_rwsa_32x16
//qt: TERMINAL we0 TYPE=WE POLARITY=H PORT=1
//qt: TERMINAL Wa0[%d] TYPE=ADDRESS DIR=W BIT=%1 PORT=1
//qt: TERMINAL Di0[%d] TYPE=DATA DIR=I BIT=%1 PORT=1
//qt:
...
//qt:
`endif // EMU
//| &Shell ${FIFOGEN} -stdout -m NV_NVDLA_PDP_RDMA_ro_fifo_32x8
//| -clk_name ::eval($VIVA_CLOCK)
//| -reset_name ::eval($VIVA_RESET)
//| -wr_pipebus ro_wr
//| -rd_pipebus ro_rd
...
// Adding parameter for fifogen to disable wr/rd contention assertion in ramgen.
// Fifogen handles this by ignoring the data on the ram data out for that cycle.
NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8 ram (
      .clk( nvdla_core_clk_mgated )
    , .pwrbus_ram_pd ( pwrbus_ram_pd )
    , .di ( ro_wr_pd )
    , .we ( ram_we )
...
// Emulation Global Config Override
//
assign wr_limit_muxed = `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x8_wr_limit_override ? `EMU_FIFO_CFG.NV_NVDLA_PDP_RDMA_ro_fifo_32x8_wr_limit : 6'd0;
`else
// No Global Override for Emulation
//
assign wr_limit_muxed = 6'd0;
...
`endif
    wr_limit_override = 0;
    wr_limit_override_value = 0; // to keep viva happy with dangles
    if ( $test$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x8_wr_limit" ) ) begin
        wr_limit_override = 1;
        $value$plusargs( "NV_NVDLA_PDP_RDMA_ro_fifo_32x8_wr_limit=%d", wr_limit_override_value);
    end
end
// VCS coverage on
`endif
...
// spyglass enable_block W401 -- clock is not input to module
// synopsys dc_script_begin
// set_boundary_optimization find(design, "NV_NVDLA_PDP_RDMA_ro_fifo_32x8") true
// synopsys dc_script_end
//| &Attachment -no_warn EndModulePrepend;
endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x8
//
// Flop-Based RAM
//
...
vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8 emu_ram (
     .Wa0( Wa0_vmw )
   , .we0( we0_vmw )
   , .Di0( Di0_vmw )
   , .Ra0( ra[4:0] )
...
`endif // EMU
endmodule // NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
// emulation model of flopram guts
//
`ifdef EMU
module vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8 (
   Wa0, we0, Di0,
   Ra0, Do0
   );
input [4:0] Wa0;
...
// synopsys translate_on
// synopsys dc_script_begin
// set_dont_touch { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8) }
// set_attribute { find (design, vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8) } require_dont_touch true -type boolean
// synopsys dc_script_end
// g2c if { [find / -null_ok -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8] != {} } { set_attr preserve 1 [find / -subdesign vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8] }
endmodule // vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
//vmw: Memory vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
//vmw: Address-size 5
//vmw: Data-size 8
//vmw: Sensitivity level 1
//vmw: Ports W R
...
//vmw:
//qt: CELL vmw_NV_NVDLA_PDP_RDMA_ro_fifo_32x8_flopram_rwsa_32x8
//qt: TERMINAL we0 TYPE=WE POLARITY=H PORT=1
//qt: TERMINAL Wa0[%d] TYPE=ADDRESS DIR=W BIT=%1 PORT=1
//qt: TERMINAL Di0[%d] TYPE=DATA DIR=I BIT=%1 PORT=1
//qt:
