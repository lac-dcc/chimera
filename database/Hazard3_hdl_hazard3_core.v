...
// Skip reg bypass for csr_wdata for core -> DM path as DM does not execute
// instruction sequences which require bypass (minor timing consideration)
assign dbg_data0_wdata = x_rdata1;
