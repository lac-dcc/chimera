...
// License: MIT License
    ...
    case (address)
        ...
        7: q_reg <= 1'b0; // 
        8: q_reg <= 1'b0; // 
        9: q_reg <= 1'b1; //  -- VCO Post Scale = 1 (1 bit(s)) (VCO post-scale divider counter value = 1)
        ...
        37: q_reg <= 1'b0; //  -- M counter: High Count = 104 (8 bit(s))
        38: q_reg <= 1'b1; // 
        39: q_reg <= 1'b1; // 
        40: q_reg <= 1'b0; // 
        41: q_reg <= 1'b1; // 
        ...
        46: q_reg <= 1'b0; //  -- M counter: Low Count = 104 (8 bit(s))
        47: q_reg <= 1'b1; // 
        48: q_reg <= 1'b1; // 
        49: q_reg <= 1'b0; // 
        50: q_reg <= 1'b1; // 
