...
module nv_ram_rws_128x128_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
assign pre_muxed_Di_w0_B = {{64{mbist_Di_w0}}};
...
// ------------------ START PIECE ----------------------------------
// Suffix : Piece RAMPDP_128X128_GL_M1_D2 (RamCell)
...
// Write Data in bus
wire [127:0] Wdata;
assign Wdata = muxed_Di_w0[127:0];
assign we_0_0 = we;
// Read Address bus
wire [6:0] ra_0_0;
...
// ----------------- begin Ram Cell RAMPDP_128X128_GL_M1_D2 -------------
// Write Port Stuff -----
...
wire [127:0] ramDataOut;
assign dout_0_0[127:0] = ramDataOut[127:0];
RAMPDP_128X128_GL_M1_D2 ram_Inst_128X128 (
                                            .CLK (gated_clk_core)
                                          , .WADR_6 (wa_0_0[6])
                                          , .WADR_5 (wa_0_0[5])
                                          , .WADR_4 (wa_0_0[4])
...
//For bitEnd 127, only one piece RAMPDP_128X128_GL_M1_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_0[127:0] or Data_reg_r0[127:0] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[127:0] = (ram_bypass) ? Data_reg_r0[127:0]: dout_0_0;
end
