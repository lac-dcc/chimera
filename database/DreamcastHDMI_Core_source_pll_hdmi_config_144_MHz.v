...
// License: MIT License
    ...
    case (address)
        ...
        3: q_reg <= 1'b0; // 
        4: q_reg <= 1'b1; //  -- Loop Filter Resistance = 16 (5 bit(s)) (Setting 16)
        5: q_reg <= 1'b0; // 
        6: q_reg <= 1'b0; // 
        7: q_reg <= 1'b0; // 
        8: q_reg <= 1'b0; // 
        ...
        19: q_reg <= 1'b0; //  -- N counter: High Count = 6 (8 bit(s))
        20: q_reg <= 1'b0; // 
        21: q_reg <= 1'b0; // 
        22: q_reg <= 1'b0; // 
        23: q_reg <= 1'b0; // 
        ...
        28: q_reg <= 1'b0; //  -- N counter: Low Count = 5 (8 bit(s))
        29: q_reg <= 1'b0; // 
        30: q_reg <= 1'b0; // 
        31: q_reg <= 1'b0; // 
        32: q_reg <= 1'b0; // 
        ...
        37: q_reg <= 1'b0; //  -- M counter: High Count = 32 (8 bit(s))
        38: q_reg <= 1'b0; // 
        39: q_reg <= 1'b1; // 
        40: q_reg <= 1'b0; // 
        41: q_reg <= 1'b0; // 
        ...
        46: q_reg <= 1'b0; //  -- M counter: Low Count = 32 (8 bit(s))
        47: q_reg <= 1'b0; // 
        48: q_reg <= 1'b1; // 
        49: q_reg <= 1'b0; // 
        50: q_reg <= 1'b0; // 
        ...
        64: q_reg <= 1'b0; //  -- clk0 counter: Low Count = 1 (8 bit(s))
        65: q_reg <= 1'b0; // 
        66: q_reg <= 1'b0; // 
        67: q_reg <= 1'b0; // 
        68: q_reg <= 1'b0; // 
        ...
        82: q_reg <= 1'b0; //  -- clk1 counter: Low Count = 1 (8 bit(s))
        83: q_reg <= 1'b0; // 
        84: q_reg <= 1'b0; // 
        85: q_reg <= 1'b0; // 
        86: q_reg <= 1'b0; // 
