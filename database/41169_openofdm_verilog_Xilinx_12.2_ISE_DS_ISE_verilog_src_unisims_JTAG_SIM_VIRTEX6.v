...
//-----------------  Virtex4 Specific Constants ---------
  ...
  reg [IRLengthMax-1:0] IR_CAPTURE_VAL	= 10'b1111010001,
                      BYPASS_INSTR      = 10'b1111111111,
                      IDCODE_INSTR      = 10'b1111001001,
                      USER1_INSTR       = 10'b1111000010,
                      USER2_INSTR       = 10'b1111000011,
                      USER3_INSTR       = 10'b1111100010,
...
//####################################################################
   initial begin
      case (PART_NAME)
          "CX75T",        "cx75t"                 : IDCODEval_sig <= 32'h042c4093;
          "LX75T",        "lx75t"                 : IDCODEval_sig <= 32'h04244093;
          "CX130T",       "cx130t"                : IDCODEval_sig <= 32'h042ca093;
          "LX130T",       "lx130t"                : IDCODEval_sig <= 32'h0424a093;
          "CX195T",       "cx195t"                : IDCODEval_sig <= 32'h042cc093;
          "LX195T",       "lx195t"                : IDCODEval_sig <= 32'h0424c093;
          "CX240T",       "cx240t"                : IDCODEval_sig <= 32'h042d0093;
          "LX240T",       "lx240t"                : IDCODEval_sig <= 32'h04250093;
          "HX250T",       "hx250t"                : IDCODEval_sig <= 32'h042a2093;
          "HX255T",       "hx255t"                : IDCODEval_sig <= 32'h042a4093;
          "SX315T",       "sx315t"                : IDCODEval_sig <= 32'h04286093;
          "LX365T",       "lx365t"                : IDCODEval_sig <= 32'h04252093;
          "HX380T",       "hx380t"                : IDCODEval_sig <= 32'h042a8093;
          "SX475T",       "sx475t"                : IDCODEval_sig <= 32'h04288093;
          "LX550T",       "lx550t"                : IDCODEval_sig <= 32'h04256093;
          "HX565T",       "hx565t"                : IDCODEval_sig <= 32'h042ac093;
          "LX760",        "lx760"                 : IDCODEval_sig <= 32'h0423a093;

         default : begin

                        $display("Attribute Syntax Error : The attribute PART_NAME on JTAG_SIM_VIRTEX6 instance %m is set to %s. The legal values for this attributes are CX75T or LX75T or CX130T or LX130T or CX195T or LX195T or CX240T or LX240T or HX250T or HX255T or SX315T or LX365T or HX380T or SX475T or LX550T or HX565T or LX760", PART_NAME);
         end
