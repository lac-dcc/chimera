...
// ******************************************************************************************************************************
// File Name          :  ocx_tlx_framer_cmd_fifo.v
// Project            :  TLX 0.7x Reference Design (External Transaction Layer logic for attaching to the IBM P9 OpenCAPI Interface)
// Module Name        :  ocx_tlx_framer_cmd_fifo
//
// Module Description : This logic implements a very small (4 entry) FIFO for cmds coming from the AFU.
//
...
//                                         | --------- |     | -------- | ----------- | ---------------------
   `define OCX_TLX_FRAMER_CMD_FIFO_VERSION  05_Sep_2017   // |          | Sep.05,2017 | Double the FIFO depth to 8 entries.
//
// ******************************************************************************************************************************
