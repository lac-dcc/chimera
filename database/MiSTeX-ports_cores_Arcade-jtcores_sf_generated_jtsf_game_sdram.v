...
// jtsf_game_sdram.v is automatically generated by JTFRAME
// Do not modify it
...
parameter RAM_OFFSET = 22'h4_0000;
parameter SND2_OFFSET = (`SND2_START-`JTFRAME_BA1_START)>>1;
parameter MAP2_OFFSET = (`MAP2_START-`JTFRAME_BA2_START)>>1;
parameter CHAR_OFFSET = (`CHAR_START-`JTFRAME_BA2_START)>>1;
parameter SCR2_OFFSET = (`SCR2_START-`JTFRAME_BA3_START)>>1;
...
wire signed [11:0] pcm0;
wire signed [11:0] pcm1;
wire mute;
// Additional ports
wire  vrom_cs;
...
jtframe_rom_3slots #(
    ...
    .SLOT0_DW(32), 
    // map2
    .SLOT1_OFFSET(MAP2_OFFSET[21:0]),
    .SLOT1_AW(16),
    .SLOT1_DW(32), 
    // char
    .SLOT2_OFFSET(CHAR_OFFSET[21:0]),
    .SLOT2_AW(13),
    .SLOT2_DW(16)
`ifdef JTFRAME_BA2_LEN
    ,.SLOT0_DOUBLE(1)
...
`endif
    ...
    .slot0_addr  ( { map1_addr, 1'b0 } ),
    .slot0_dout  ( map1_data  ),
    .slot0_cs    ( vrom_cs    ),
    .slot0_ok    ( map1_ok    ),
    
    .slot1_addr  ( { map2_addr, 1'b0 } ),
...
jtframe_rom_3slots #(
    ...
    .SLOT0_DW(16), 
    // scr2
    .SLOT1_OFFSET(SCR2_OFFSET[21:0]),
    .SLOT1_AW(18),
    .SLOT1_DW(16), 
    // obj
    .SLOT2_OFFSET(OBJ_OFFSET[21:0]),
    .SLOT2_AW(21),
    .SLOT2_DW(16)
`ifdef JTFRAME_BA2_LEN
    ,.SLOT0_DOUBLE(1)
...
jtframe_rcmix #(
    ...
    .p1     ( 16'hFCFA), // 723 Hz, 482 Hz 
    .p2     ( 16'hFCFA), // 723 Hz, 482 Hz 
    .p3     ( 16'h0), 
    .p4     ( 16'h0), 
    .p5     ( 16'h0), 
    .g0     ( 8'h13 ), // fm
