...
// nv_ram_rws_256x256: synthesizable model core
...
module nv_ram_rws_256x256_logic (
               SI,
               SO_int_net,
               ary_atpg_ctl,
               ary_read_inh,
...
assign pre_muxed_Di_w0_B = {{56{mbist_Di_w0}}, {72{mbist_Di_w0}}};
...
assign muxed_Di_w0_A = {di[255:144], di[143:0]};
...
assign re_0_0 = re;
// ------------------ START PIECE ----------------------------------
// Suffix _0_144 : Piece RAMPDP_256X112_GL_M2_D2 (RamCell)
// Covers Addresses from 0 to 255 Addressrange: [7:0]
// Data Bit range: [255:144] (112 bits)
// Enables: 1 Enable range:
// Declare some wires for doing chip select logic
// verilint 498 off - Incompatible width
...
// Write Data in bus
wire [255:144] Wdata_0_144;
assign Wdata_0_144 = muxed_Di_w0[255:144];
assign we_0_144 = we;
// Read Address bus
wire [7:0] ra_0_144;
assign ra_0_144 = muxed_Ra_r0[7:0];
// Read DataOut bus
wire [255:144] dout_0_144;
assign re_0_144 = re;
...
// Turn the verilint warnings on
// verilint 110 on - Incompatible width
// ----------------- begin Ram Cell RAMPDP_256X112_GL_M2_D2_0_144 -------------
// Write Port Stuff -----
// Declare the Write address bus
...
// Declare the ramOutData which connects to the ram directly
wire [255:144] ramDataOut_0_144;
assign dout_0_144[255:144] = ramDataOut_0_144[255:144];
RAMPDP_256X112_GL_M2_D2 ram_Inst_256X112_0_144 (
...
//For bitEnd 255, only one piece RAMPDP_256X112_GL_M2_D2 in the column.
// verilint 17 off - Range (rather than full vector) in the sensitivity list
always @(dout_0_144[255:144] or Data_reg_r0[255:144] or ram_bypass)
begin
    ram_r0_OutputMuxDataOut[255:144] = (ram_bypass) ? Data_reg_r0[255:144]: dout_0_144;
end
assign r0_OutputMuxDataOut[255:144] = ram_r0_OutputMuxDataOut[255:144];
// verilint 17 on - Range (rather than full vector) in the sensitivity list
...
wire muxed_Data_S;
assign muxed_Data_S = debug_mode_sync ? (re_reg_r0_0_0 | re_reg_r0_0_144) : mbist_en_r;
...
wire captureDR_r0 = dft_capdr_r | (( debug_mode_sync ? (1'b1& (access_en_r_1p_0_0 | access_en_r_1p_0_144)) : ((mbist_en_r & (mbist_ce_r0_0_0_1p | mbist_ce_r0_0_144_1p) & !1'b0))));
...
ScanShareSel_JTAG_reg_ext_cg #(256, 0, 0) testInst_Data_reg_r0 (
     .clk(gated_clk_jtag_Data_reg_r0), .sel(debug_mode),
            ...
            .scanin(re_reg_SO_r0_0_144), .scanout(Data_reg_SO_r0) );
`ifdef ASSERT_ON
`ifndef SYNTHESIS
reg sim_reset_;
