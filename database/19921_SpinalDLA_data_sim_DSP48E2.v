...
// `ifdef XIL_XECLIB
  reg glblGSR = 1'b0;
// `else
//   tri0 glblGSR = glbl.GSR;    // @Victor: Modified
// `endif
  ...
  // ! @ Victor: Modified
  assign ALUMODE_in[0] = (ALUMODE[0] ^ IS_ALUMODE_INVERTED_REG[0]);    // @ Victor
  assign ALUMODE_in[1] = (ALUMODE[1] ^ IS_ALUMODE_INVERTED_REG[1]);    // @ Victor
  assign ALUMODE_in[2] = (ALUMODE[2] ^ IS_ALUMODE_INVERTED_REG[2]);    // @ Victor
  assign ALUMODE_in[3] = (ALUMODE[3] ^ IS_ALUMODE_INVERTED_REG[3]);    // @ Victor
  ...
  // ! @ Victor: Modified
  assign CARRYINSEL_in = CARRYINSEL;   // @ Victor
  ...
  // ! @ Victor: Modified
  assign CEA1_in = CEA1;    // @ Victor
  assign CEA2_in = CEA2;    // @ Victor
  assign CEAD_in = CEAD;    // @ Victor
  assign CEALUMODE_in = CEALUMODE;    // @ Victor
  assign CEB1_in = CEB1;    // @ Victor
  assign CEB2_in = CEB2;    // @ Victor
  assign CECARRYIN_in = CECARRYIN;    // @ Victor
  assign CECTRL_in = CECTRL;    // @ Victor
  assign CEC_in = CEC;    // @ Victor
  assign CED_in = CED;    // @ Victor
  assign CEINMODE_in = CEINMODE;
  assign CEM_in = CEM;    // @ Victor
  assign CEP_in = CEP;    // @ Victor
  assign CLK_in = (CLK ^ IS_CLK_INVERTED_REG);    // @ Victor
  ...
  // ! @ Victor: Modified
  assign INMODE_in[0] = (INMODE[0] ^ IS_INMODE_INVERTED_REG[0]);    // @ Victor
  assign INMODE_in[1] = (INMODE[1] ^ IS_INMODE_INVERTED_REG[1]);    // @ Victor
  assign INMODE_in[2] = (INMODE[2] ^ IS_INMODE_INVERTED_REG[2]);    // @ Victor
  assign INMODE_in[3] = (INMODE[3] ^ IS_INMODE_INVERTED_REG[3]);    // @ Victor
  assign INMODE_in[4] = (INMODE[4] ^ IS_INMODE_INVERTED_REG[4]);    // @ Victor
  ...
  // ! @ Victor: Modified
  assign OPMODE_in[0] = (OPMODE[0] ^ IS_OPMODE_INVERTED_REG[0]);    // @ Victor
  assign OPMODE_in[1] = (OPMODE[1] ^ IS_OPMODE_INVERTED_REG[1]);    // @ Victor
  assign OPMODE_in[2] = (OPMODE[2] ^ IS_OPMODE_INVERTED_REG[2]);    // @ Victor
  assign OPMODE_in[3] = (OPMODE[3] ^ IS_OPMODE_INVERTED_REG[3]);    // @ Victor
  assign OPMODE_in[4] = (OPMODE[4] ^ IS_OPMODE_INVERTED_REG[4]);    // @ Victor
  assign OPMODE_in[5] = (OPMODE[5] ^ IS_OPMODE_INVERTED_REG[5]);    // @ Victor
  assign OPMODE_in[6] = (OPMODE[6] ^ IS_OPMODE_INVERTED_REG[6]);    // @ Victor
  assign OPMODE_in[7] = (OPMODE[7] ^ IS_OPMODE_INVERTED_REG[7]);    // @ Victor
  assign OPMODE_in[8] = (OPMODE[8] ^ IS_OPMODE_INVERTED_REG[8]);    // @ Victor
...
`else
  attr_test = 1'b0;
`endif
  attr_err = 1'b0;            /* verilator lint_off STMTDLY */
  #1;
  trig_attr = ~trig_attr;     /* verilator lint_on STMTDLY */
end
`endif
...
`else
always @(trig_attr) begin              /* verilator lint_off STMTDLY */
#1;
  ACASCREG_BIN = ACASCREG_REG[1:0];    /* verilator lint_on STMTDLY */
