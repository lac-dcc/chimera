...
// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/stan/IODRP2.v,v 1.16 2009/11/05 16:59:02 robh Exp $
///////////////////////////////////////////////////////
...
// /__/   /\      Filename    : IODRP2.v
// \  \  /  \   
//  \__\/\__ \
//
//  Revision:      Date:  Comment
//       1.0:  04/16/08:  Initial version.
//       1.1:  08/15/08:  Change BSKT to BKST per yml
//                        Remove parameters and checking per yml
//       1.2:  08/21/08:  CR479980 fix T polarity.
//                        Add SIM_TAP_DELAY attribute
//       1.3:  09/05/08:  CR480001 fix calibration.
//       1.4   09/30/08:  Add DATA_RATA attribute
//                        Add clock doubler
...
//       1.8   02/04/2009 CR506027 IODRP state machine, sync_to_data off
...
//-----------------------------------------------------------------------------
   ...
   if (sim_tap_delay_err_flag) begin
      attr_err_flag = 1; 
      #1;
...
// output delay paths
   ...
   assign cs_sig = CS_INDELAY;
   assign SDO_OUT   = cs_sig ? shift_out[0] : 1'b0 ;
