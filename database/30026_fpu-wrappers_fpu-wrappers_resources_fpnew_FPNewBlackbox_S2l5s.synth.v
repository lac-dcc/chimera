...
module \$paramod$0adf94592eb6a1684096a028d3c99c62d8322df7\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, mask_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, mask_o, aux_o, out_valid_o, out_ready_i
, busy_o, reg_ena_i);
  wire _000_;
  wire _001_;
  wire _002_;
  ...
  wire [287:0] inp_pipe_operands_q;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _085_ });
  assign _025_ = { 2'h0, exponent_a[7:0] } + info_a[6];
  assign _026_ = _025_ + { 2'h0, operand_b[30:23] };
  assign _027_ = _026_ + info_b[6];
  assign _028_ = { 26'h0000000, product, 2'h0 } + addend_shifted;
  assign sum_raw = _028_ + inject_carry_in;
  assign _030_ = 32'd26 + leading_zero_count;
  assign _029_ = $signed(_101_) + $signed(32'd1);
  assign _031_ = $signed(32'd26) + $signed(mid_pipe_exp_prod_q[9:0]);
  assign _032_ = $signed(normalized_exponent) + $signed(32'd1);
  assign _033_ = in_ready_o & in_valid_i;
  assign _034_ = inp_pipe_ready[1] & inp_pipe_valid_q[1];
  ...
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _130_ <= 7'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _130_ <= addend_shamt;
  assign mid_pipe_add_shamt_q[13:7] = _130_;
  reg [9:0] _131_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _131_ <= 10'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _131_ <= sv2v_tmp_B4C85;
  assign mid_pipe_tent_exp_q[19:10] = _131_;
  ...
  reg [9:0] _138_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _138_ <= 10'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _138_ <= exponent_product;
  assign mid_pipe_exp_prod_q[19:10] = _138_;
  ...
  reg [95:0] _148_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _148_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _148_ <= inp_pipe_operands_q[191:96];
  assign inp_pipe_operands_q[95:0] = _148_;
  ...
  assign out_pipe_result_q[31:0] = _159_;
  ...
  reg [31:0] _164_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _164_ <= 32'd0;
    else if (\gen_inside_pipeline[1].reg_ena ) _164_ <= mid_pipe_spec_res_q[63:32];
  assign mid_pipe_spec_res_q[31:0] = _164_;
  ...
  reg [75:0] _168_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _168_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[1].reg_ena ) _168_ <= mid_pipe_sum_q[151:76];
  assign mid_pipe_sum_q[75:0] = _168_;
  ...
  reg [6:0] _170_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _170_ <= 7'h00;
    else if (\gen_inside_pipeline[1].reg_ena ) _170_ <= mid_pipe_add_shamt_q[13:7];
  assign mid_pipe_add_shamt_q[6:0] = _170_;
  reg [9:0] _171_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _171_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _171_ <= mid_pipe_tent_exp_q[19:10];
  assign mid_pipe_tent_exp_q[9:0] = _171_;
  reg [9:0] _172_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _172_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _172_ <= mid_pipe_exp_diff_q[19:10];
  assign mid_pipe_exp_diff_q[9:0] = _172_;
  reg [9:0] _173_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _173_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _173_ <= mid_pipe_exp_prod_q[19:10];
  assign mid_pipe_exp_prod_q[9:0] = _173_;
  ...
  reg [31:0] _179_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _179_ <= 32'd0;
    else if (\gen_inside_pipeline[0].reg_ena ) _179_ <= special_result;
  assign mid_pipe_spec_res_q[63:32] = _179_;
  ...
  reg [75:0] _183_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _183_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _183_ <= mid_pipe_sum_q[227:152];
  assign mid_pipe_sum_q[151:76] = _183_;
  ...
  assign _048_ = sum_raw[76] == tentative_sign;
  assign _049_ = ! rounded_abs[30:23];
  assign _050_ = ! pre_round_abs[30:23];
  assign _051_ = rounded_abs[30:23] == 8'h01;
  ...
  assign _057_ = $signed(exponent_difference) <= $signed(32'd4294967247);
  assign _058_ = $signed(exponent_difference) <= $signed(32'd26);
  assign _059_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd0);
  assign _060_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd2);
  ...
  assign _073_ = ! sum_sticky_bits[50];
  ...
  assign _082_ = ~ inp_pipe_valid_q[1];
  assign _083_ = ~ inp_pipe_valid_q[2];
  assign _084_ = ~ inp_pipe_operands_q[31];
  assign _085_ = ~ info_c[7];
  assign _086_ = ~ addend_after_shift;
  assign _087_ = ~ sticky_before_add;
  assign _088_ = ~ sum_raw[76];
  assign _089_ = ~ mid_pipe_valid_q[1];
  assign _090_ = ~ mid_pipe_valid_q[2];
  assign _091_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = inp_pipe_ready[1] | _082_;
  assign inp_pipe_ready[1] = inp_pipe_ready[2] | _083_;
  assign \gen_input_pipeline[0].reg_ena  = _033_ | reg_ena_i[0];
  assign \gen_input_pipeline[1].reg_ena  = _034_ | reg_ena_i[1];
  ...
  assign _016_ = _056_ ? sum_shifted[74:50] : { 1'h0, sum_shifted[74:51] };
  assign _020_ = _056_ ? { sum_shifted[49:0], 1'h0 } : sum_shifted[50:0];
  assign _015_ = _056_ ? _102_[9:0] : 10'h000;
  assign _006_ = sum_shifted[75] ? normalized_exponent : _015_;
  assign _014_ = sum_shifted[75] ? sum_shifted[50:0] : _020_;
  assign _007_ = sum_shifted[75] ? { 1'h1, sum_shifted[74:51] } : _016_;
  assign final_mantissa = sum_shifted[76] ? { 1'h1, sum_shifted[75:52] } : _007_;
  assign sum_sticky_bits = sum_shifted[76] ? sum_shifted[51:1] : _014_;
  assign final_exponent = sum_shifted[76] ? _032_[9:0] : _006_;
  assign _009_ = _068_ ? _029_[9:0] : 10'h000;
  assign _008_ = _068_ ? _030_[6:0] : _031_[6:0];
  assign normalized_exponent = _077_ ? _009_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _077_ ? _008_ : mid_pipe_add_shamt_q[6:0];
  assign _005_ = _058_ ? _100_[6:0] : 7'h00;
  assign addend_shamt = _057_ ? 7'h4c : _005_;
  assign _024_ = info_c[4] ? { operand_c[31], 31'h7f800000 } : 32'd2143289344;
  assign _023_ = _075_ ? { tentative_sign, 31'h7f800000 } : _024_;
  assign _022_ = _064_ ? 1'h1 : 1'h0;
  assign _021_ = _064_ ? 32'd2143289344 : _023_;
  assign _019_ = any_operand_inf ? _022_ : 1'h0;
  assign _018_ = any_operand_inf ? _021_ : 32'd2143289344;
  ...
  assign _012_ = any_operand_nan ? 32'd2143289344 : _018_;
  assign mid_pipe_spec_stat_q[14] = _074_ ? 1'h1 : _013_;
  assign result_is_special = _074_ ? 1'h1 : _011_;
  assign special_result = _074_ ? 32'd2143289344 : _012_;
  function [0:0] _286_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[31] = _286_(1'h1, { _084_, 1'h0, inp_pipe_operands_q[31] }, { _095_, _094_, _043_ });
  function [30:0] _287_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _287_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _094_, _046_ });
  assign _010_ = _047_ ? 32'd0 : 32'd2147483648;
  ...
  assign operand_c = _291_(32'd2155872257, { _112_, inp_pipe_operands_q[94:64], _010_ }, { _044_, _093_ });
  assign operand_b = _045_ ? inp_pipe_operands_q[63:32] : 32'd2155872257;
  function [7:0] _293_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign _099_ = _027_ - 32'd127;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _100_ = $signed(32'd27) - $signed(exponent_difference);
  assign _101_ = $signed(mid_pipe_exp_prod_q[9:0]) - $signed({ 1'h0, leading_zero_count });
  assign _102_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _103_ = in_ready_o ? in_valid_i : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _103_;
  assign _104_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _104_;
  assign { _105_[31:10], exponent_product } = _076_ ? 32'd4294967171 : _099_;
  ...
  assign { _106_[76], mid_pipe_sum_q[227:152] } = _065_ ? _081_ : sum_raw;
  ...
  assign { _110_[31:8], pre_round_abs[30:23] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign result_d = mid_pipe_res_is_spec_q[2] ? mid_pipe_spec_res_q[31:0] : { rounded_sign, rounded_abs };
  ...
  assign _112_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[2];
  ...
  assign _105_[9:0] = exponent_product;
  assign _106_[75:0] = mid_pipe_sum_q[227:152];
  assign _110_[7:0] = pre_round_abs[30:23];
  ...
  assign inp_pipe_operands_q[287:192] = operands_i;
  ...
  assign mid_pipe_add_shamt_q[20:14] = addend_shamt;
  assign mid_pipe_aux_q[0] = inp_pipe_aux_q[2];
  assign mid_pipe_eff_sub_q[0] = effective_subtraction;
  assign mid_pipe_exp_diff_q[29:20] = exponent_difference;
  assign mid_pipe_exp_prod_q[29:20] = exponent_product;
  ...
  assign mid_pipe_spec_res_q[95:64] = special_result;
  ...
  assign mid_pipe_tent_exp_q[29:20] = sv2v_tmp_B4C85;
  ...
  assign sum = mid_pipe_sum_q[227:152];
  ...
  assign sv2v_tmp_CEAB3 = mid_pipe_sum_q[227:152];
...
module \$paramod$1c5d8fccff52bb648c8e09277210b8e2b472f60a\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
...
module \$paramod$2d98b2ed91e87ed1e332161bf5d593baf43453be\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:153$613.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:153$614.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$597.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$598.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$607.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$608.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$609.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$610.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$611.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$612.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$597.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$598.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$598.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$597.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:153$613.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:153$614.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$597.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$598.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$607.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$608.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$609.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$610.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$611.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:173$612.inp  = 3'hx;
endmodule
...
module \$paramod$646bd60b8cfd6878a624143be9d0bb9f04c84404\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$6ee62e513065c9e4d9bf255729ee1cc6ddd5a3c6\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire [71:0] arbiter_output;
  output busy_o;
...
module \$paramod$a9a79c484765ae85ccf4c83862b39466c389cf68\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o
, out_ready_i, busy_o);
  wire _0_;
  wire _1_;
  wire [71:0] arbiter_output;
  ...
  \$paramod$e308f221f121699b77c199cfc7b13dbf3a9f0d99\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$ab1efca8a0cbeafc5bf81c45c518064b6d31017e\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o
);
  wire _00_;
  wire _01_;
  wire _02_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8198$213.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8198$55.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$110.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$145.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$180.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$261.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$277.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$75.$result ;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1533  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1533 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1533 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1533 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1533 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1533 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1533 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1533 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1533 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1533 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1533 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1533 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1533 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1533 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1533 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1533 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1533 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$180.$result  = \$auto$proc_rom.cc:150:do_switch$1533 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1537  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1537 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1537 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1537 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1537 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1537 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1537 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1537 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1537 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1537 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1537 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1537 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1537 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1537 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1537 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1537 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1537 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$145.$result  = \$auto$proc_rom.cc:150:do_switch$1537 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1541  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1541 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1541 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1541 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1541 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1541 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1541 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1541 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1541 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1541 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1541 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1541 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1541 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1541 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1541 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1541 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1541 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$110.$result  = \$auto$proc_rom.cc:150:do_switch$1541 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1545  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1545 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1545 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1545 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1545 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1545 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1545 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1545 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1545 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1545 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1545 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1545 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1545 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1545 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1545 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1545 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1545 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$75.$result  = \$auto$proc_rom.cc:150:do_switch$1545 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1549  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1549 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1549 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1549 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1549 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1549 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1549 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1549 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1549 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1549 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1549 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1549 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1549 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1549 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1549 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1549 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1549 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8198$55.$result  = \$auto$proc_rom.cc:150:do_switch$1549 [op_i];
  ...
  assign _09_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$75.$result ;
  assign _10_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$110.$result  == 2'h1;
  assign _11_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$145.$result  == 2'h2;
  assign _12_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$180.$result  == 2'h3;
  assign simd_mask = simd_mask_i | 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _54_ = opgrp_in_ready;
  assign _13_ = _54_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8198$55.$result  +: 1];
  ...
  \$paramod$a9a79c484765ae85ccf4c83862b39466c389cf68\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$1c5d8fccff52bb648c8e09277210b8e2b472f60a\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$6ee62e513065c9e4d9bf255729ee1cc6ddd5a3c6\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$646bd60b8cfd6878a624143be9d0bb9f04c84404\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8198$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$261.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S2l5s.preprocessed.v:8247$277.op  = 4'hx;
...
module \$paramod$c2409bf6d6fec6245b3dea150ba71180ba9a6bc5\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:335$525.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:335$526.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:355$523.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:355$524.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:335$525.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:335$526.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:355$523.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_S2l5s.preprocessed.v:355$524.inp  = 2'hx;
endmodule

module \$paramod$e308f221f121699b77c199cfc7b13dbf3a9f0d99\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, simd_mask_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o, reg_ena_i
);
  wire [4:0] _00_;
  wire [4:0] _01_;
  output busy_o;
  ...
  \$paramod$0adf94592eb6a1684096a028d3c99c62d8322df7\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
  ...
  \$paramod$0adf94592eb6a1684096a028d3c99c62d8322df7\fpnew_fma_FC83A_5615B  \gen_num_lanes[1].active_lane.lane_instance.i_fma  (
    .aux_i(vectorial_op_i),
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$ab1efca8a0cbeafc5bf81c45c518064b6d31017e\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
