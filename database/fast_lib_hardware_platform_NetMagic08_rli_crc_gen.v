...
// megafunction wizard: %CRC Compiler v10.0%
// GENERATION: XML
...
// 			crc_gen_altcrc
// ============================================================
// Generated by CRC Compiler 10.0 [Altera, IP Toolbench 1.3.0 Build 218]
// ************************************************************
...
module crc_gen (
	...
	crc_gen_altcrc	crc_gen_altcrc_inst(
		.clk(clk),
		.data(data),
		.datavalid(datavalid),
		.empty(empty),
...
// Retrieval info: <MEGACORE title="CRC Compiler"  version="10.0"  build="218"  iptb_version="1.3.0 Build 218"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="crc_gen_altcrc" >
...
// Retrieval info:      <PRIVATE name = "filename" value="crc_gen_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "filename" value="crc_gen.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
