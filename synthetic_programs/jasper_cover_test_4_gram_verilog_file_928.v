...
module module_0 (
    ...
    input id_18,
    output [id_12[id_18] : id_2] id_19,
    output [id_10 : 1] id_20,
    input logic [id_9 : id_12] id_21,
    input [1 : id_9] id_22
);
  logic id_23;
  always @(posedge id_20 or posedge id_22)
    if (id_7) begin
    end
  id_24 id_25 (
      .id_26(id_27),
